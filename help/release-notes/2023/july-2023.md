...
**Versionsdatum: Donnerstag, 26. Juli 2023**
...
| Funktion | Beschreibung |
| ------- | ----------- |
| Zielgruppenportal | Audience Portal bietet ein neues Browsing-Erlebnis für den Zugriff auf, die Erstellung und die Verwaltung von Zielgruppen in Adobe Experience Platform. Im Zielgruppenportal können Sie Experience Platform-generierte und extern generierte Zielgruppen anzeigen, Ihre Arbeitseffizienz durch Filtern, Ordner und Tags verbessern, Experience Platform-generierte Zielgruppen erstellen und extern generierte Zielgruppen über CSV-Dateien importieren. Weitere Informationen zum Zielgruppenportal finden Sie im [Überblick über das Zielgruppenportal](../../segmentation/ui/audience-portal.md). |
...
| Feldergruppe | [[!UICONTROL Enriched Event Segment Details]](https://github.com/adobe/xdm/pull/1754/files) | Eine Liste von Zielgruppen, für die das Profil zum Zeitpunkt der Ereigniserfassung qualifiziert ist. |
...
| --- | --- | --- |
| Feldgruppe | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von experimentell auf `stable` aktualisiert. |
| Feldergruppe | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `stable` auf `deprecated` aktualisiert. |
| Datentyp | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Player state data information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Media event information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `stable` auf `deprecated` aktualisiert. |
| Datentyp | [[!UICONTROL Custom metadata details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Chapter details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Advertising Pod details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Datentyp | [[!UICONTROL Advertising details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` wurde von `experimental` auf `stable` aktualisiert. |
| Erweiterung (Customer Journey-Management) | [[!UICONTROL Domain]](https://github.com/adobe/xdm/pull/1756/files) | `Domain` Feld wurde [!UICONTROL Adobe CJM ExperienceEvent - Message Profile Details] hinzugefügt, um die Domain der E-Mail-Adresse des Empfängers aufzuzeichnen. |
| Erweiterung (Customer Journey-Management) | [[!UICONTROL Channel's variant Name]](https://github.com/adobe/xdm/pull/1753/files) | Dieses Feld wurde [!UICONTROL AJO Entity Fields] hinzugefügt, um den Namen der Kanalvariante darzustellen. |
| Erweiterung (Adobe Analytics) | [[!UICONTROL Context value]](https://github.com/adobe/xdm/pull/1761/files) | `Context value` wurde zu [!UICONTROL `Adobe Analytics ExperienceEvent Full Extension`] hinzugefügt . |
