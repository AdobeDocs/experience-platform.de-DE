...
| Funktion | Beschreibung |
| --- | --- |
| [!BADGE Beta]{type=Informative}[!DNL SAP Commerce] | Sie können jetzt die [[!DNL SAP Commerce] source](../../sources/connectors/ecommerce/sap-commerce.md) , um Abrechnungsdaten für Abonnements von Ihrem [!DNL SAP Commerce] -Konto auf Experience Platform. |
