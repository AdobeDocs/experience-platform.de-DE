...
Weitere Informationen finden Sie in der Übersicht über den [Privacy Service ](../../privacy-service/home.md).
...
| Funktion | Beschreibung |
|---|---|
| Verbessertes Symbolsystem | Die [!DNL Schema Editor] Benutzeroberfläche verfügt über aktualisierte Symbole, die besser an das allgemeine [!DNL Platform]-Design angepasst sind. |
