...
| Adobe Audience Manager | Datenerfassungsprotokolle, integrierte Daten sowie Merkmale und Segmentdaten aus Adobe Audience Manager sind in [!DNL Platform] verfügbar. |
...
[!DNL Catalog] ist ein Aufzeichnungssystem für Speicherort und Herkunft von Daten in Adobe Experience Platform. [!DNL Catalog] speichert die Metadaten und Beschreibungen von Dateien und Verzeichnissen in [!DNL Experience Platform]. Dies dient als Metadatenspeicher, in dem Informationen zu allen in [!DNL Platform] gespeicherten Daten abgerufen werden können.
...
Adobe Experience Platform unterstützt die Integration mit Datenverarbeitungs-Tools, die Daten aus zahlreichen Quellen extrahieren, transformieren und in [!DNL Experience Platform] laden können. So wird sichergestellt, dass die Daten den richtigen Spezifikationen für die Verwendung durch [!DNL Platform]-Services entsprechen. Einige Partner bieten vorkonfigurierte Connectoren für [!DNL Experience Platform] an. Eine Dokumentation für die Entwicklung von ETL-Connectoren steht ebenfalls zur Verfügung.
...
| ETL-Integration | [!DNL Experience Platform] bietet Dokumentation zur ETL-Integration für Benutzer, die einen sicheren Connector zum Extrahieren, Transformieren und Laden von Daten in [!DNL Platform] erstellen möchten. |
...
| [!DNL Schema Library] | Die [!DNL Schema Library] enthält alle [!DNL Schema Registry] Ressourcen, einschließlich der von einem einzelnen Unternehmen definierten und der Ressourcen, die von Adobe, [!DNL Experience Platform] und Anbietern, deren Anwendungen in [!DNL Experience Platform] integriert sind, für alle Benutzer zur Verfügung gestellt werden. |
...
| Überprüfung auf Richtlinienverletzungen | Prüfen Sie, ob definierte Nutzungsrichtlinien verletzt werden, wenn Marketing-Aktionen für [!DNL Platform] Daten durchgeführt werden. |
