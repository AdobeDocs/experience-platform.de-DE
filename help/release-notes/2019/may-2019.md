...
| Echtzeit-Datenübermittlung via [!DNL Launch] | Verwendet die Adobe Experience Platform-Erweiterung in [!DNL Launch], um XDM-formatierte Daten von Client-Geräten einfach in Echtzeit zu senden. |
