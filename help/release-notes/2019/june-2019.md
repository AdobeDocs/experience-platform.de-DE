...
**Releasedatum: Samstag, 28. Juni 2019**
...
| Funktion | Beschreibung |
| -----------| ---------- |
| Abfrage-Editor | Verwenden Sie ein Web-basiertes Tool, um Abfragen zu schreiben, zu validieren, zu testen und auszuführen. Es enthält eine Konsole für detaillierte Informationen über die Durchführung von Abfragen sowie die Möglichkeit, die Abfrageergebnisse als Vorschau anzuzeigen. |
...
* Es wurde ein Fehler behoben, durch den Identitätsdeskriptoren gelegentlich nicht mit gültigen Namespaces erstellt werden konnten.
...
* Es kann kein Aufzählungsfeld ohne Labels erstellt werden.
