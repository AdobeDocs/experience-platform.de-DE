...
>[!TIP]
>
>[KI-Assistent in Experience Platform](https://platform.adobe.com) ist jetzt verfügbar. Verwenden Sie den KI-Assistenten, um Ihre Workflows in Adobe-Anwendungen zu beschleunigen. [Weitere Informationen](#ai-assistant) über die neue Funktion.
...
| Support bei Fragen zum Produktwissen | [Produktkenntnisse](../../ai-assistant/home.md#product-knowledge) sind Konzepte und Themen, die auf der Experience League-Dokumentation basieren und für zielgerichtetes Lernen, offene Erkennung und Fehlerbehebung verwendet werden können. Sie können Fragen zum Produktwissen des KI-Assistenten stellen wie: <ul><li>Was sind Lookalike-Zielgruppen?</li><li>Wie wird die Profilreichhaltigkeit berechnet?</li><li> Kann ich ein Profil-aktiviertes Schema nach der Datenaufnahme löschen?</li></ul> |
...
| Zugriff auf KI-Assistenten | Um auf den KI-Assistenten für Experience Platform, Real-Time CDP und Journey Optimizer zugreifen zu können, müssen Sie einer Rolle hinzugefügt werden, die die Berechtigungen **KI-Assistenten aktivieren** und **Betriebseinblicke anzeigen** umfasst. Weitere Informationen finden Sie im [Handbuch zum Zugriff auf Funktionen](../../ai-assistant/access.md). Sie müssen die Admin Console für ([ in Customer Journey Analytics) ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/ai-assistant#feature-access). |
...
| Funktion | Beschreibung |
|--- | ---|
| Privacy Service-Unterstützung für Adobe Journey Optimizer | Die Privacy Service-Funktionen sind jetzt mit den Adobe Journey Optimizer-Protokollen für die Verarbeitung von Löschanfragen kompatibel. Weitere Informationen finden Sie in der Dokumentation zu [Adobe Journey Optimizer](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/privacy/requests)Datenschutzanfragen oder in der Experience Platform-Dokumentation für eine Liste von [Experience Cloud-Anwendungen, die mit Privacy Service integriert sind](../../privacy-service/experience-cloud-apps.md). |
...
[!DNL Use Case Playbooks] sind für alle Adobe Experience Platform-Kunden kostenlos verfügbar. Um auf eine umfangreiche Sammlung von Anwendungsfall-Playbooks in der Experience Platform-Benutzeroberfläche zuzugreifen, können Sie jetzt **[!UICONTROL Playbooks]** in der linken Navigationsleiste auswählen.
