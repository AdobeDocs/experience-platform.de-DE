...
| --- | --- | --- |
| Web SDK | Vorschlagsinteraktionen automatisch verfolgen | Sie können jetzt die `autoTrackPropositionInteractionsEnabled`-Eigenschaft in Web SDK verwenden, um zu bestimmen, ob Web SDK automatisch Vorschlagsinteraktionen erfassen soll. Detaillierte Informationen finden Sie in der [`autoTrackPropositionInteractionsEnabled`](../../web-sdk/commands/configure/autotrackpropositioninteractionsenabled.md). |
