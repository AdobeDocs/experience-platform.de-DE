...
| [Google Data Layer-Tag-Erweiterung](../../tags/extensions/web/google-data-layer/overview.md) | Mit der Google Data Layer-Erweiterung können Sie eine Google-Datenschicht in Ihrer Tag-Implementierung verwenden. |
...
| [Mailchimp-Ereignisweiterleitungs-Erweiterung](../../tags/extensions/web/mailchimp/overview.md) | Die Ereignisweiterleitungs-Erweiterung für Mailchimp sendet Ereignisse an die Mailchimp Marketing-API, die E-Mails für Marketing-Kampagnen, Journeys oder Transaktionen über Mailchimp auslösen kann. |
...
| Globales Schema | (Mehrere) | Für Zielmetriken für Real-Time CDP Insights stehen neue globale Schemata zur Verfügung. Siehe die folgende [Pull-Anfrage](https://github.com/adobe/xdm/pull/1560) für weitere Details. |
