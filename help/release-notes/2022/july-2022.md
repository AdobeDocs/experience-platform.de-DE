...
**Versionsdatum: Donnerstag, 27. Juli 2022**
...
Adobe investiert nicht mehr in die Unterstützung von [Internet Explorer 10 (IE10)](https://docs.microsoft.com/de-de/lifecycle/announcements/internet-explorer-10-end-of-support) und [Internet Explorer 11 (IE11)](https://docs.microsoft.com/de-de/lifecycle/announcements/internet-explorer-11-end-of-support) für Tags in Adobe Experience Platform. Microsoft hat die Unterstützung für diese Browser eingestellt, moderne Web-Technologien sind zunehmend mit ihnen inkompatibel, und die Branche hat sich von ihnen entfernt. Diese Faktoren machen es schwierig und kostspielig, die Abwärtskompatibilität aufrechtzuerhalten. Obwohl Adobe die IE10- und IE11-Unterstützung nicht aktiv entfernt, werden neue Tag-Funktionen für diese Browser nicht mehr getestet oder optimiert. Durch diese Änderung kann Adobe moderne Funktionen schneller bereitstellen.
...
| --- | --- | --- |
| Klasse | [[!UICONTROL Weather]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | Eine auf Aufzeichnungen basierende Klasse, die zur Erfassung von Wetterdaten verwendet wird. |
| Feldergruppe | [[!UICONTROL Current Weather]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | Eine Feldergruppe für die Klassen [!UICONTROL XDM ExperienceEvent] und [!UICONTROL Weather] , die zur Erfassung der aktuellen Wetterbedingungen für eine Postleitzahl verwendet werden. |
| Feldergruppe | [[!UICONTROL Forecasted Weather]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/forecasted-weather.schema.json) | Eine Feldergruppe für die Klassen [!UICONTROL XDM ExperienceEvent] und [!UICONTROL Weather] , die zur Erfassung der vorhergesagten Wetterbedingungen für eine Postleitzahl verwendet werden. |
| Feldergruppe | [[!UICONTROL Product Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/product-triggers.schema.json) | Eine Feldergruppe für die Klassen [!UICONTROL XDM ExperienceEvent] und [!UICONTROL Weather] , die zur Erfassung produktspezifischer Trigger verwendet werden, welche die Wetterbedingungen nutzen, die erfahrungsgemäß das Verbraucherverhalten beeinflussen. |
| Feldergruppe | [[!UICONTROL Relative Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/relative-triggers.schema.json) | Eine Feldergruppe für die Klassen [!UICONTROL XDM ExperienceEvent] und [!UICONTROL Weather] , die zur Erfassung relativer Trigger verwendet werden, welche die Wetterbedingungen nutzen, die erfahrungsgemäß das Verbraucherverhalten beeinflussen. |
| Feldergruppe | [[!UICONTROL Severe Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/severe-triggers.schema.json) | Eine Feldergruppe für die Klassen [!UICONTROL XDM ExperienceEvent] und [!UICONTROL Weather] , die zur Erfassung von Triggern verwendet werden, welche extreme Wetterbedingungen nutzen, die erfahrungsgemäß das Verbraucherverhalten beeinflussen. |
| Feldergruppe | [[!UICONTROL Weather Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/weather-triggers.schema.json) | Eine Feldergruppe für die Klassen [!UICONTROL XDM ExperienceEvent] und [!UICONTROL Weather] , die zur Erfassung allgemeiner Trigger verwendet werden, welche die Wetterbedingungen nutzen, die erfahrungsgemäß das Verbraucherverhalten beeinflussen. |
| Feldergruppe | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/blob/master/docs/reference/fieldgroups/experience-event/experienceevent-media.schema.json) | Eine Feldergruppe für die Klasse [!UICONTROL XDM ExperienceEvent] , die Details zu einer Medieninteraktion erfasst. |
| Feldergruppe | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media-analytics.schema.json) | Eine Feldergruppe für die Klasse [!UICONTROL XDM ExperienceEvent] , die Details zu einer Interaktion mit Medienberichten erfasst. |
| Datentyp | [[!UICONTROL Advertising details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/advertisingdetails.schema.json) | Erfasst Details zu einem Werbe-Asset. |
| Datentyp | [[!UICONTROL Advertising Pod details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/advertisingpoddetails.schema.json) | Erfasst Details über einen Werbeblock. Hierbei handelt es sich um eine Sequenz von mehreren Werbespots, die innerhalb eines einzigen Werbeblocks hintereinander abgespielt werden. |
| Datentyp | [[!UICONTROL Chapter details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/chapterdetails.schema.json) | Erfasst Details zu einem Kapitel oder Segment im Inhalt eines Videos. |
| Datentyp | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/errordetails.schema.json) | Erfasst Details zu einem Fehler bei der Videowiedergabe. |
| Datentyp | [[!UICONTROL Player state data information]](https://github.com/adobe/xdm/blob/master/components/datatypes/playerstatedata.schema.json) | Erfasst statusbezogene Details zu einem Video-Player. |
| Datentyp | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/qoedatadetails.schema.json) | Erfasst Details zur Erlebnisqualität (QoE) für ein Videowiedergabeereignis. |
| Datentyp | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/sessiondetails.schema.json) | Erfasst Sitzungsdetails für ein Videowiedergabeereignis. |
