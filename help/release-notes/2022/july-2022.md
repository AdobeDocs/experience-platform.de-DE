...
| Feldergruppe | [[!UICONTROL Medieninteraktionsdetails]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media.schema.json) | Eine Feldergruppe für die Klasse [!UICONTROL XDM ExperienceEvent], die Details zu einer Medieninteraktion erfasst. |
