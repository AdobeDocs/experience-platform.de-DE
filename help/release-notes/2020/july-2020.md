...
| Funktion | Beschreibung |
| ------- | ----------- |
| Durchsetzung von Datennutzungsrichtlinien | [!DNL Real-Time Customer Data Platform] werden Verstöße gegen Datennutzungsrichtlinien automatisch angezeigt, wenn versucht wird, eine Aktion zu verletzen, die im Arbeitsbereich [!UICONTROL Profile] stattfindet. Weitere Informationen [&#x200B; automatischen Durchsetzung von Richtlinien finden Sie &#x200B;](#governance) den Versionshinweisen für Data Governance . |
...
| Durchsetzung von Datennutzungsrichtlinien | [!DNL Real-Time Customer Data Platform] werden Verstöße gegen Datennutzungsrichtlinien automatisch angezeigt, wenn versucht wird, eine Aktion zu verletzen, die im Arbeitsbereich [!UICONTROL Segments] stattfindet. Weitere Informationen [&#x200B; automatischen Durchsetzung von Richtlinien finden Sie &#x200B;](#governance) den Versionshinweisen für Data Governance . |
