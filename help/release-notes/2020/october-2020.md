...
| Funktion | Beschreibung |
| ------- | ----------- |
| SSH-Authentifizierungsunterstützung für SFTP | Sie können Ihr SFTP-Konto mit [!DNL Platform] RSA/DSA Open SSH-Schlüsseln verbinden. See the [SFTP overview](../../sources/connectors/cloud-storage/sftp.md) for more information. |
