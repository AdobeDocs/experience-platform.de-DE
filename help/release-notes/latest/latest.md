...
| Funktion | Beschreibung |
| --- | --- |
| Einführung in [!DNL Identity Graph Linking Rules] | [!DNL Identity Graph Linking Rules] soll Ihnen dabei helfen, genaue Kundenprofile für personalisiertes Marketing zu pflegen, indem das Reduzieren von Diagrammen verhindert wird.<ul><li>Testen und validieren Sie [ Konfigurationen mit ](../../identity-service/identity-graph-linking-rules/graph-simulation.md) Tool „Diagrammsimulation“.</li><li>Unter [Identitäts-Dashboard](../../identity-service/identity-graph-linking-rules/implementation-guide.md#validate-your-graphs) können Sie alle Instanzen des Diagrammausfalls in Ihrer Organisation überwachen.</li><li>Um zu beginnen, lesen Sie das [[!DNL Identity Graph Linking Rules] Implementierungshandbuch](../../identity-service/identity-graph-linking-rules/implementation-guide.md).</li></ul> **Hinweis**: Ihre Daten werden geändert, bis Sie Ihre Identitätseinstellungen manuell konfigurieren. |
