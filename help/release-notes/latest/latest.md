...
| Feldgruppe | [[!UICONTROL Angereicherte Segmentdetails für Ereignisse]](https://github.com/adobe/xdm/pull/1754/files) | Eine Liste von Zielgruppen, für die das Profil zum Zeitpunkt der Ereigniserfassung qualifiziert ist. |
...
| --- | --- | --- |
| Feldgruppe | [[!UICONTROL Details zur MediaAnalytics-Interaktion]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde von der experimentellen auf `stable`. |
| Feldgruppe | [[!UICONTROL Medieninteraktionsdetails]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `stable` nach `deprecated`. |
| Datentyp | [[!UICONTROL Informationen zu Sitzungsdetails]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Informationen zu QoE-Daten]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Player-Statusdateninformationen]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental`nach `stable`. |
| Datentyp | [[!UICONTROL Informationen zu Medienereignissen]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Informationen zu Mediendetails]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Informationen zu Fehlerdetails]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Informationen zu Fehlerdetails]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `stable` nach `deprecated`. |
| Datentyp | [[!UICONTROL Informationen zu benutzerdefinierten Metadaten]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Informationen zu Kapiteldetails]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Detailinformationen zu Werbeblöcken]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Datentyp | [[!UICONTROL Informationen zu Werbedetails]](https://github.com/adobe/xdm/pull/1756/files) | Die `meta:status` wurde aktualisiert von `experimental` nach `stable`. |
| Erweiterung (Customer Journey Management) | [[!UICONTROL Domain]](https://github.com/adobe/xdm/pull/1756/files) | `Domain` Feld hinzugefügt zu [!UICONTROL Adobe CJM ExperienceEvent - Details des Nachrichtenprofils] , um die Domain der E-Mail-Adresse des Empfängers aufzuzeichnen. |
| Erweiterung (Customer Journey Management) | [[!UICONTROL Variantenname des Kanals]](https://github.com/adobe/xdm/pull/1753/files) | Dieses Feld wurde zu [!UICONTROL AJO-Entitätsfelder] , um den Namen der Kanalvariante anzugeben. |
| Erweiterung (Adobe Analytics) | [[!UICONTROL Kontextwert]](https://github.com/adobe/xdm/pull/1761/files) | `Context value` wurde hinzugefügt [!UICONTROL `Adobe Analytics ExperienceEvent Full Extension`]. |
