...
Wählen Sie in der [Experience Platform](https://platform.adobe.com)Benutzeroberfläche zunächst **[!UICONTROL Monitoring]** im linken Navigationsmenü und dann **[!UICONTROL Streaming end-to-end]** aus.

Die **[!UICONTROL Streaming end-to-end]** Monitoring-Seite wird angezeigt. Dieser Arbeitsbereich bietet ein Diagramm, das die Rate der von [!DNL Experience Platform] empfangenen Streaming-Ereignisse, ein Diagramm, das die Rate der von [[!DNL Real-Time Customer Profile]](../../profile/home.md) erfolgreich verarbeiteten Streaming-Ereignisse sowie eine detaillierte Liste der eingehenden Daten anzeigt.
...
Unter den Diagrammen befindet sich eine Liste aller Streaming-Aufnahme-Datensätze, die dem oben angezeigten Datumsbereich entsprechen. Jeder aufgelistete Batch zeigt die ID, den Namen des Datensatzes, wann dieser zuletzt aktualisiert wurde, die Anzahl der Einträge im Batch sowie die Anzahl der Fehler (sofern vorhanden) an. Sie können einen beliebigen Datensatz auswählen, um genauere Informationen zu diesem Datensatz zu erhalten.

![](../images/quality/monitor-data-flows/streams.png)

### Anzeigen von Streaming-Einträgen

Beim Anzeigen der Details eines erfolgreich gestreamten Eintrags werden Informationen wie die Anzahl der aufgenommenen Einträge, die Dateigröße sowie die Beginn- und Endzeiten der Aufnahme angezeigt.

![](../images/quality/monitor-data-flows/successful-streaming.png)

Die Details eines fehlgeschlagenen Streaming-Eintrags zeigen dieselben Informationen wie ein erfolgreicher Eintrag.
...
Wählen Sie in der [[!DNL Experience Platform UI]](https://platform.adobe.com) im linken Navigationsmenü **[!UICONTROL Monitoring]** aus.

Die Seite zur **[!UICONTROL Batch end-to-end]**-Überwachung wird mit einer Liste der zuvor aufgenommenen Batches angezeigt. Sie können einen beliebigen Stapel auswählen, um detailliertere Informationen zu diesem Datensatz zu erhalten.

![](../images/quality/monitor-data-flows/batch-monitoring.png)

### Anzeigen von Batches

Beim Anzeigen der Details eines erfolgreichen Batches werden Informationen wie die Anzahl der aufgenommenen Einträge, die Dateigröße sowie der Beginn- und Endzeitpunkt der Aufnahme angezeigt.

![](../images/quality/monitor-data-flows/successful-batch.png)

Die Details eines fehlgeschlagenen Batches zeigen dieselben Informationen wie ein erfolgreicher Batch an, mit dem Zusatz, wie viele Einträge fehlgeschlagen sind.
