...
- Streaming-Aufnahme {#streaming}
   ...
   - [AUF DIE ZULASSUNGSLISTE SETZEN IP-Adresseneinstellung](streaming-ingestion/allowlisting.md)
...
- Tutorials {#tutorials}
   ...
   - [Streaming von Eintragsdaten](tutorials/streaming-record-data.md)
...
- Qualität und Überwachung der Daten{#quality}
   ...
   - [Validieren der Streaming-Aufnahme](quality/streaming-validation.md)
