...
Informationen zum Erstellen einer authentifizierten Streaming-Verbindung finden Sie im Handbuch [HTTP-API-Quelle-API](../../sources/tutorials/api/create/streaming/http.md).
