...
Vertrauliche &quot;S&quot;-Beschriftungen werden verwendet, um Daten zu kategorisieren, die Sie und Ihre Organisation für vertraulich halten.
...
Anzeigen sind Nachrichten oder Benachrichtigungen, einschließlich Text und Bildern, die auf einer Website oder in einem Programm erscheinen und in erster Linie dazu dienen, den Verkauf von Waren oder Dienstleistungen zu fördern. Es liegt an Ihnen, den Zweck solcher Nachrichten oder Benachrichtigungen zu bestimmen. Anzeigen sind von Inhalten auf der Site getrennt, welche durch die Kennzeichnung [C7](#c7) abgedeckt werden. Daten mit einem C6-Titel können nicht für das Targeting von Onsite-Anzeigen verwendet werden, einschließlich der Auswahl und Bereitstellung von Werbung auf den Websites oder Apps Ihres Unternehmens oder zur Messung von Bereitstellung und Effektivität solcher Werbung. Dazu gehört die Verwendung zuvor erfasster Onsite-Daten über die Interessen der Benutzer bei der Auswahl von Anzeigen, die Verarbeitung von Daten darüber, welche Anzeigen angezeigt wurden, wann und wo sie angezeigt wurden und ob die Benutzer im Zusammenhang mit der Anzeige irgendwelche Maßnahmen ergriffen haben, z. B. die Auswahl einer Anzeige oder den Kauf. In der Regel würden die auf den Aktivitäten dieser Benutzer vor Ort beruhenden Rückschlüsse auf die Voreinstellungen eines Benutzers und die anschließende Verwendung dieser Voreinstellungen in der On-site-Anzeigensuche nicht als interessenbasiertes Targeting (auch Personalisierung genannt) gelten, da nicht alle drei Anforderungen für das zielbasierte Targeting erfüllt würden. *[Diese Anforderungen finden Sie unter der Kennzeichnung C5.](#c5)*
...
DAA: Die Online-Verhaltenswerbung umfasst nicht die Aktivitäten von Erstanbietern, die Bereitstellung von Anzeigen oder die Berichterstellung für Anzeigen oder die kontextbezogene Werbung (d. h. Werbung, die auf dem Inhalt der besuchten Webseite, dem aktuellen Besuch eines Verbrauchers auf einer Webseite oder einer Suchanfrage basiert).

#### C7 {#c7}

Onsite-Inhalte sind Texte und Bilder, die zur Information, Ausbildung oder Unterhaltung konzipiert sind und nicht zur Förderung des Verkaufs von Waren oder Dienstleistungen erstellt wurden. Es liegt an Ihnen, den Zweck der Inhalte zu bestimmen, einschließlich der Frage, ob ein Inhalt als native Werbung gelten könnte. Die Kennzeichnung C7 ist nicht für Onsite-Anzeigen vorgesehen, da diese mit der Kennzeichnung [C6](#c6) versehen sind. Daten mit einem C7-Titel können nicht für das Targeting von Inhalten auf der Site verwendet werden, einschließlich der Auswahl und Bereitstellung von Inhalten auf den Websites oder Apps Ihres Unternehmens oder zur Messung der Bereitstellung und Effektivität solcher Inhalte. Dazu gehören zuvor erfasste Informationen über die Interessen der Benutzer an ausgewählten Inhalten, die Verarbeitung von Daten darüber, welcher Inhalt angezeigt wurde, wie oft er angezeigt wurde, wann er angezeigt wurde und wo er angezeigt wurde und ob die Verwendungszwecke Aktionen im Zusammenhang mit dem Inhalt durchgeführt haben, darunter etwa die Auswahl von Inhalten. In der Regel würden die auf den Aktivitäten dieser Benutzer basierenden Rückschlüsse auf die Voreinstellungen eines Benutzers und die anschließende Verwendung dieser Voreinstellungen beim Inhalts-Targeting auf der Site nicht als interessensbasiertes Targeting (auch Personalisierung genannt) gelten, da nicht alle drei Anforderungen für zielbasiertes Targeting erfüllt würden. *[Diese Anforderungen finden Sie unter der Kennzeichnung C5.](#c5)*
