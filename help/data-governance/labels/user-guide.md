...
Um ein neues Schema zu erstellen, wählen Sie oben rechts im Arbeitsbereich **[!UICONTROL Create schema]** die Option **[!UICONTROL Schemas]** aus. Vollständige Anweisungen finden Sie im Handbuch zum [Erstellen eines Schemas mit dem Schema-Editor](../../xdm/tutorials/create-schema-ui.md#create). Sie können auch ein [Schema mithilfe der Schema Registry-API erstellen](../../xdm/tutorials/create-schema-api.md), falls erforderlich.

### Hinzufügen von Datennutzungs-Labels zu einem Schema {#add-labels-to-schema}

Nachdem Sie ein neues Schema erstellt oder ein vorhandenes Schema aus der Liste auf der Registerkarte [!UICONTROL Browse] des Arbeitsbereichs [!UICONTROL Schemas] ausgewählt haben, wählen Sie im Schema-Editor ein Feld aus Ihrem Schema aus. Wählen Sie in der [!UICONTROL Field properties] Seitenleiste **[!UICONTROL Apply Access and Data Governance Labels]** aus.
...
Kennzeichnungen können über die Registerkarte **[!UICONTROL Data Governance]** des Arbeitsbereichs **[!UICONTROL Datasets]** auf den gesamten Datensatz angewendet werden. Der Arbeitsbereich ermöglicht Ihnen das Verwalten von Datennutzungs-Labels auf Datensatzebene.

![Die Registerkarte &quot;[!UICONTROL Data Governance]&quot; des Arbeitsbereichs &quot;[!UICONTROL Datasets]&quot; mit hervorgehobener Option „Data Governance“.](../images/labels/dataset-governance.png)
...
![Die Registerkarte &quot;[!UICONTROL Data Governance]&quot; des Arbeitsbereichs &quot;[!UICONTROL Datasets]&quot; mit hervorgehobenem Stiftsymbol „Bearbeiten“.](../images/labels/dataset-level-edit.png)

Das Dialogfeld **[!UICONTROL Edit Governance Labels]** wird geöffnet. Aktivieren Sie im Dialogfeld die Kontrollkästchen neben den Labels, die Sie auf den Datensatz anwenden möchten. Denken Sie daran, dass diese Labels von allen Feldern im Datensatz übernommen werden. Während Sie die einzelnen Kontrollkästchen aktivieren, wird die **[!UICONTROL Applied Labels]**-Kopfzeile aktualisiert, sodass sie die ausgewählten Beschriftungen anzeigt. Nachdem Sie die gewünschten Beschriftungen ausgewählt haben, klicken Sie auf **[!UICONTROL Save Changes]**.
...
Der Arbeitsbereich **[!UICONTROL Data Governance]** wird erneut angezeigt und zeigt die Beschriftungen an, die Sie auf Datensatzebene in der ersten Zeile der Tabelle angewendet haben. Es sind auch die durch einzelne Karten angezeigten Labels zu sehen, die von jedem Feld im Datensatz übernommen werden.

![Die Registerkarte &quot;[!UICONTROL Data Governance]&quot; des Arbeitsbereichs &quot;[!UICONTROL Datasets]&quot; mit hervorgehobenen Kennzeichnungen auf Datensatzebene und übernommenen Kennzeichnungen für Datensatzfelder.](../images/labels/applied-dataset-labels.png)
...
Der Umschalter **[!UICONTROL Show Inherited Labels]** ist standardmäßig aktiviert. Dadurch können Sie alle Beschriftungen sehen, die vom Schema auf seine Felder übertragen wurden. Wenn Sie den Umschalter deaktivieren, werden alle übernommenen Labels im Datensatz ausgeblendet.
...
Sie können Ihre eigenen benutzerspezifischen Nutzungskennzeichnungen im **[!UICONTROL Policies]** Arbeitsbereich in der [!DNL Experience Platform]-Benutzeroberfläche erstellen. Klicken Sie im linken Navigationsbereich auf **[!UICONTROL Policies]** und dann auf **[!UICONTROL Labels]** , um eine Liste der vorhandenen Kennzeichnungen anzuzeigen. Klicken Sie von hier aus auf **[!UICONTROL Create label]**.

![Der Arbeitsbereich „Richtlinien“ mit hervorgehobener Option „Kennzeichnung erstellen“.](../images/labels/create-label-btn.png)

Das Dialogfeld **[!UICONTROL Create label]** wird angezeigt. Geben Sie nun die folgenden Informationen für das neue Label ein:
...
* **[!UICONTROL Friendly name]**: Ein Anzeigename für die Kennzeichnung.
* **[!UICONTROL Description]**: (Optional) Eine Beschreibung für die Kennzeichnung, um mehr Kontext bereitzustellen.
...
Die Kennzeichnung kann jetzt unter **[!UICONTROL Custom Labels]** ausgewählt werden, wenn Nutzungskennzeichnungen für Datensätze und Felder bearbeitet oder Datennutzungsrichtlinien erstellt werden.
