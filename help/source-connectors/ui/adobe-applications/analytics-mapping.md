...
| m_browser_height | Umgebung.browserDetails.viewportHeight | Ganzzahl | Die Höhe des Browsers in Pixel. |
| m_browser_width | Umgebung.browserDetails.viewportWidth | Ganzzahl | Die Breite des Browsers in Pixel. |
...
| m_domain | Umgebung.domain | Zeichenfolge | Die in der Dimension &quot;Domäne&quot;verwendete Variable. Dies erfolgt auf der Grundlage des Internet-Dienstleisters (ISP) des Benutzers. |
...
| accept_language | Umgebung.browserDetails.acceptLanguage | Zeichenfolge | Liste aller zulässigen Sprachen, wie im Accept-Language HTTP-Header angegeben. |
...
| j_jscript | Umgebung.browserDetails.javaScriptVersion | Zeichenfolge | Die vom Browser unterstützte JavaScript-Version. |
| user_agent | Umgebung.browserDetails.userAgent | Zeichenfolge | Die Benutzeragenten-Zeichenfolge, die im HTTP-Header gesendet wird. |
...
| pointofinterestdistance | placeContext.POIinteraction.POIDetail.geoInteractionDetails.awayToCenter | number | Wird von Mobildiensten verwendet. Stellt den Zielpunkt-Abstand dar. |
...
| mobileplacecategory | placeContext.POIinteraction.POIDetail.Kategorie | Zeichenfolge | Wird mit der Kontextdatenvariablen a.loc.category erfasst. Beschreibt die Kategorie eines bestimmten Orts. |
...
| videocontenttype | media.mediaTimed.primaryAssetViewDetails.castContentType | Zeichenfolge | Der Videoinhalt-Typ. Für alle Video-Ansichten ist dies automatisch auf &quot;Video&quot;eingestellt. |
...
| videochannel | media.mediaTimed.primaryAssetViewDetails.castChannel | Zeichenfolge | Der Video-Kanal. |
...
| videonetwork | media.mediaTimed.primaryAssetViewDetails.castNetwork | Zeichenfolge | Videonetzwerk. |
...
| mobilebeaconuuid | placeContext.POIinteraction.POIDetail.beaconInteractionDetails.ximityUUID | Zeichenfolge | Mobile Services-Beacon UUID. |
...
| videoplay | media.mediaTimed.Beginns | Objekt | <!-- MISSING --> | {id (Zeichenfolge), Wert (Zahl)} |
...
| videoqoebuffercount | media.mediaTimed.primaryAssetViewDetails.qoe.buffer | Objekt | Anzahl der Videopuffer | {id (Zeichenfolge), Wert (Zahl)} |
...
| m_cookies | Umgebung.browserDetails.cookiesEnabled | Boolescher Wert | Eine Variable, die in der Dimension &quot;Cookie-Unterstützung&quot;verwendet wird. |
...
| m_java_enabled | Umgebung.browserDetails.javaEnabled | Boolescher Wert | Eine Flag, die angibt, ob Java aktiviert ist. |
...
| j_jscript | Umgebung.browserDetails.javaScriptEnabled | Boolescher Wert | Die verwendete JavaScript-Version. |
...
| mobilebeaconproximity | placeContext.POIinteraction.POIDetail.beaconInteractionDetails.ximity | Zeichenfolge | Mobile Services – Beacon-Nähe. |
...
| post_browser_height | Umgebung.browserDetails.viewportHeight | Ganzzahl | Die Höhe des Browsers in Pixel. |
| post_browser_width | Umgebung.browserDetails.viewportWidth | Ganzzahl | Die Breite des Browsers in Pixel. |
...
| domain | Umgebung.domain | Zeichenfolge | Die in der Dimension &quot;Domäne&quot;verwendete Variable. Dies erfolgt auf der Grundlage des Internet-Dienstleisters (ISP) des Benutzers. |
...
| post_cookies | Umgebung.browserDetails.cookiesEnabled | Boolescher Wert | Die Variable, die in der Dimension „Cookie-Unterstützung“ verwendet wurde. |
...
| post_java_enabled | Umgebung.browserDetails.javaEnabled | Boolescher Wert | Eine Flag, die angibt, ob Java aktiviert ist. |
