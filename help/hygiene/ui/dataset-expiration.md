...
Um eine Anfrage zu erstellen, wählen Sie auf der Hauptseite im Arbeitsbereich **[!UICONTROL Create request]** aus.
...
![Der [!UICONTROL Data Lifecycle] Arbeitsbereich mit hervorgehobenem [!UICONTROL Create request].](../images/ui/ttl/create-request-button.png)

Der Workflow zur Anfrageerstellung wird angezeigt. Wählen Sie im Abschnitt [!UICONTROL Requested Action] die Option **[!UICONTROL Delete Dataset]** aus, um die Steuerelemente für die Planung der Datensatzgültigkeit zu aktualisieren.

![Der Workflow für die Anfrageerstellung mit hervorgehobener Option &quot;[!UICONTROL Delete dataset]&quot;.](../images/ui/ttl/dataset-selected.png)
...
Wählen Sie anschließend unter **[!UICONTROL Dataset Details]** das Datenbanksymbol (![Das Datenbanksymbol.](/help/images/icons/database.png)), um ein Dialogfeld zur Datensatzauswahl zu öffnen. Wählen Sie aus der Liste einen Datensatz aus, auf den die Gültigkeit angewendet werden soll, und klicken Sie dann auf **[!UICONTROL Done]**.

![Das Dialogfeld &quot;[!UICONTROL Select dataset]&quot; mit ausgewähltem Datensatz und hervorgehobener [!UICONTROL Done].](../images/ui/ttl/select-dataset.png)
...
Der Abschnitt [!UICONTROL Dataset Details] wird ausgefüllt und enthält die primäre Identität und das Schema für den ausgewählten Datensatz. Geben Sie unter **[!UICONTROL Request settings]** einen Namen und eine optionale Beschreibung für die Anfrage ein, gefolgt von **[!UICONTROL Submit]**.

![Eine abgeschlossene Datensatz-Gültigkeitsanfrage mit hervorgehobener Schaltfläche [!UICONTROL Request settings] und [!UICONTROL Submit].](../images/ui/ttl/submit.png)

Ein [!UICONTROL Confirm request] Dialogfeld wird angezeigt. Sie werden aufgefordert, den Datensatznamen und das Datum zu bestätigen, an dem der Datensatz gelöscht werden soll. Wählen Sie **[!UICONTROL Submit]** aus, um fortzufahren.

Nachdem die Anfrage gesendet wurde, wird ein Arbeitsauftrag erstellt und auf der Hauptregisterkarte des Arbeitsbereichs [!UICONTROL Data Lifecycle] angezeigt. Hier können Sie den Fortschritt des Arbeitsauftrags überwachen.
...
Um eine Datensatzgültigkeit zu bearbeiten oder abzubrechen, klicken Sie auf der Hauptseite des Arbeitsbereichs auf **[!UICONTROL Dataset]** und wählen Sie die Datensatzgültigkeit aus der Liste aus.
