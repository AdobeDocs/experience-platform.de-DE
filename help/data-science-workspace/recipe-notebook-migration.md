...
>[!IMPORTANT]
>
>[!DNL Spark] ([!DNL Spark] 2.3) nicht mehr unterstützt und in einer folgenden Version entfernt werden soll. Alle vorhandenen Beispiele werden durch Scala-Beispiele ([!DNL Spark] 2.4) ersetzt.
