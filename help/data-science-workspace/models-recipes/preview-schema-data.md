...
Wählen Sie im linken Navigationsbereich **[!UICONTROL Registerkarte]** Schemata“ aus und suchen Sie das vom Bootstrap-Skript erstellte Eingabeschema. Der Name des Schemas entspricht dem, der im vorherigen Schritt unter `config.yaml` definiert wurde. Zeigen Sie die Schemadetails und deren Komposition an, indem Sie darauf klicken.

![](../images/models-recipes/access-data/schema.PNG)

Wählen Sie **[!UICONTROL Registerkarte]** Datensätze“ im linken Navigationsbereich aus und öffnen Sie den erstellten Eingabedatensatz, indem Sie den Namen des Datensatzes auswählen. Der Name des Datensatzes entspricht dem, was im vorherigen Schritt in `config.yaml` definiert wurde.

![](../images/models-recipes/access-data/dataset.PNG)

Wählen Sie **[!UICONTROL Vorschau des Datensatzes]** oben rechts aus, um eine Teilmenge des Datensatzes in der Vorschau anzuzeigen.
