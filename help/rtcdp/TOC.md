...
* Schemata {#schemas}
   * [Überblick über Schemata](schemas/overview.md)
...
* Anwendungsfälle {#use-cases}
   ...
   * [Anwendungsfälle für Kundenerlebnisse nutzen, um Geschäftsziele zu erreichen](/help/rtcdp/use-case-guides/business-use-case-framework.md)
