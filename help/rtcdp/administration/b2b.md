...
Die Zugriffskontrolle für Real-Time CDP B2B Edition wird über den [Adobe Admin Console](https://adminconsole.adobe.com) verwaltet. Diese Funktion nutzt Produktprofile in [!DNL Admin Console], sodass Sie Benutzer mit Berechtigungen und Sandboxes verknüpfen können. Mithilfe dieser Funktion können Administratoren bestimmten Benutzergruppen Zugriff auf bestimmte Real-Time CDP-Funktionen (z. B. die B2B-Benutzeroberfläche) gewähren oder vorenthalten.
...
In den folgenden Dokumenten finden Sie ausführliche Anweisungen zur Verwendung von [Adobe Admin Console](https://adminconsole.adobe.com) zum Aktivieren des Zugriffs auf die B2B-Benutzeroberfläche für ein Produktprofil:
