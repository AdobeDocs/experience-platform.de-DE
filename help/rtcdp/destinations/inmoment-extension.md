...
description: Die InMoment-Erweiterung ist ein Zielort für Umfragen in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# InMoment-Erweiterung {#inmoment-extension}

## Übersicht {#overview}

Mit der InMoment Launch Integration können Sie Online-Feedback schnell und einfach über das Digital Intercept Produkt aktivieren. In der App können Abfangen über den CXI Cloud-Admin konfiguriert und verwaltet werden, sodass CX-Manager ihre Programme besser steuern können.

InMoment ist eine Erweiterung der Umfrage in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100847.html).
...
So installieren Sie die InMoment-Erweiterung:
...
Informationen zu den Erweiterungskonfigurationsoptionen finden Sie auf der [Google Universal Analytics-Erweiterungsseite](https://exchange.adobe.com/experiencecloud.details.100847.html) in Adobe Exchange.
