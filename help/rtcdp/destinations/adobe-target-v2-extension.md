...
description: Die Adobe Target v2-Erweiterung ist ein Personalisierungsziel in Adobe Real-time Customer Data Platform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
Adobe Target v2 ist eine Personalisierungserweiterung in Adobe Real-time Customer Data Platform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html).
...
1. Gehen Sie in der [Adobe Real-time CDP-Benutzeroberfläche](http://platform.adobe.com/) zu **[!UICONTROL Ziele > Katalog]**.
