...
description: Die Analytics-Erweiterung Parse.ly ist ein Analytics-Ziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Analytics-Erweiterung Parse.ly ist ein Analytics-Ziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# Parse.ly Analytics-Erweiterung {#parsely-analytics-extension}

## Übersicht {#overview}

Mit Parse.ly Analytics können mehr als 2.500 Firmen Daten verwenden, um ihre Online-Audience zu verstehen. Mit dieser Erweiterung wird ein JavaScript-Snippet installiert, das verfolgt, wie Besucher mit Inhalten auf Ihrer Site interagieren.

Parse.ly ist eine Analytics-Erweiterung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktion finden Sie unter [Parse.ly Analytics](https://www.parse.ly/).
...
So installieren Sie die Erweiterung Parse.ly:
