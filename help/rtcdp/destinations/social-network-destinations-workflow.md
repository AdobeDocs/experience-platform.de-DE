...
1. In **[!UICONTROL Destinations > Catalog]**, scroll to the **[!UICONTROL Social]** category. Wählen Sie Ihr bevorzugtes Ziel in einem sozialen Netzwerk und dann **[!UICONTROL Ziel verbinden]** aus.
