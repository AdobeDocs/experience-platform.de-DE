...
description: Die Marketo-Munchkin-Erweiterung ist ein Ziel der Personalisierung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Marketo-Munchkin-Erweiterung ist ein Ziel der Personalisierung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# Marketo Munchkin-Erweiterung {#marketo-munchkin-extension}

## Übersicht {#overview}

Vom Lead-Management bis zum kontenbasierten Marketing vereinfacht die Marketing-Plattform die Planung, Orchestrierung und Messung der Interaktion mit Kunden und Potenzieller Kunden in jeder Phase ihrer Erfahrung.

Marketo’s Munchkin JavaScript ermöglicht die Verfolgung von Seitenbesuchen und Klicks von Endbenutzern zu Ihren Marketo-Landingpages und externen Webseiten.

Marketo Munchkin ist eine E-Mail-Erweiterung der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
...
![Marketo Munchkin-Erweiterung](assets/marketo-munchkin-extension.png)
...
So installieren Sie die Marketo-Munchkin-Erweiterung:
...
Weitere Informationen zu den Erweiterungskonfigurationsoptionen und zur Installationsunterstützung finden Sie auf der [Seite &quot;Marketo Munchkin&quot;in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
