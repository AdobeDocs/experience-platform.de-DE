...
# DoubleClick Floodlight (Beta)-Erweiterung

## Übersicht {#overview}

Diese Erweiterung ermöglicht eine schnelle und einfache Bereitstellung von DoubleClick Floodlight-Tags im herkömmlichen Floodlight-Format (nicht im globalen Site-Tag). Hinweis: Diese Erweiterung befindet sich in der Betaphase.
