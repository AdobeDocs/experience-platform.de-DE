...
description: Die Feedback-Erweiterung zur Website von Qualtrics ist ein Ziel von Umfragen in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Qualtrics Website Feedback Extension ist ein Ziel von Umfragen in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
Qualtrics Website Feedback ermöglicht es Ihnen, Ihre Website-Besucher zur richtigen Zeit mit der richtigen Nachricht zu verbinden. Ob Sie die Erfahrung Ihrer Besucher mit Website-Feedback-Umfragen verbessern oder die Umrechnung steigern möchten, Qualtrics Website Feedback hat Sie darauf aufmerksam gemacht.

Mit einer intuitiven Point-and-Click-Oberfläche können Sie innerhalb weniger Minuten gezielt Web-Nachrichten mit Markenbezeichnungen erstellen und bereitstellen. Die Daten und Einblicke, die Sie von Ihrer Website erfassen, werden zusammen mit den Kundenrückmeldungsdaten aller Kanal angezeigt und bieten eine umfassende Ansicht Ihrer Kundenerfahrung - alles auf einer Plattform.

Qualtrics Website Feedback ist eine Erweiterung der Umfrage in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
So installieren Sie die Feedback-Erweiterung der Qualtrics-Website:
...
Informationen zu den Erweiterungskonfigurationsoptionen und zur Installationsunterstützung finden Sie auf der Seite Feedback zur [Qualtrics-Website in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
