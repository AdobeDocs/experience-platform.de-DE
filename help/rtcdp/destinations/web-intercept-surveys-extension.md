---
title: Erweiterung der Umfragen für FragenPro Intercept
seo-title: Erweiterung der Umfragen für FragenPro Intercept
description: Die Erweiterung "FragePro Intercept Umfragen"ist ein Zielort für Umfragen in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Umfragen-Erweiterung "QuestionPro Intercept"ist ein Zielort der Umfrage in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# Erweiterung zu Umfragen von Fragenpro {#questionpro-extension}

## Übersicht {#overview}

FragePro Intercept Umfragen ist eine Plattform zur Bereitstellung von Umfragen und zur Erfassung von Verhaltensdaten am Transaktionsort oder beim Einstieg bzw. Ausstieg von Benutzern in Ihre Website.

Die Umfragen von QuestionPro Intercept sind eine Erweiterung der Umfrage in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
![Erweiterung zu Umfragen von Fragenpro](assets/web-intercept-surveys-extension.png)
...
So installieren Sie die Erweiterung der Umfragen für die FragenPro-Konstante:
...
Informationen zu den Erweiterungskonfigurationsoptionen und zur Installationsunterstützung finden Sie auf der Seite [FragePro-Umfragen abfangen in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
