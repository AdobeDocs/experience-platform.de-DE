...
seo-title: Beemray-Erweiterung
description: Die Beemray-Erweiterung ist ein Ziel der Personalisierung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Beemray-Erweiterung ist ein Ziel der Personalisierung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# Beemray-Erweiterung {#beemray-extension}

## Übersicht {#overview}

Beemray hilft Ihnen bei der Beschleunigung Ihres Produkts in einem situativen Kontext. Ermöglicht es Ihnen, Einblicke zu gewinnen, neue Erlebnisse zu entwickeln, Interaktionen zu fördern und Momente einzugehen, die wirklich wichtig sind. Beemray automatisiert kontextbezogene Intelligenz mithilfe von maschinellem Lernen. Beemray stellt eine Verbindung mit der Adobe Experience Cloud und den anderen technischen Partnern her. Alles findet in Echtzeit statt. Mit dieser Erweiterung wird das Beemray SDK auf Ihrer Site installiert.

Beemray ist eine Erweiterung der Adobe Echtzeit-Kundendatenplattform zur Personalisierung. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html).
...
![Beemray-Erweiterung](assets/beemray-extension.png)
...
So installieren Sie die Beemray-Erweiterung:
...
Weitere Informationen zu den Erweiterungskonfigurationsoptionen und zur Installationsunterstützung finden Sie auf der [Beemray-Seite von Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html).
