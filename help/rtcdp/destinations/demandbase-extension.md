...
description: Die Demandbase-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Demandbase-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# Demandbase-Erweiterung {#demandbase-extension}

## Übersicht {#overview}

Erhalten Sie Einblicke in das B2B-Konto von Demandbase in Adobe Analytics, mit denen Sie Traffic und Verhalten nach Branche, Umsatz und Zielgruppen segmentieren können. Diese kontobasierte Ansicht bietet einzigartige Einblicke in Interaktion, Konversion und die Quelle für Ihre wertvollsten Besucher.

Demandbase ist eine Analytics-Erweiterung der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
So installieren Sie die Demandbase-Erweiterung:
...
Informationen zu den Optionen für die Erweiterungskonfiguration finden Sie auf der Seite [zur](https://exchange.adobe.com/experiencecloud.details.101605.html) Demandbase-Erweiterung in Adobe Exchange.
