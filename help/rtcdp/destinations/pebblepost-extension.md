...
seo-title: PebblePost-Erweiterung
description: Die PebblePost-Erweiterung ist ein E-Mail-Ziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die PebblePost-Erweiterung ist ein E-Mail-Ziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# PebblePost-Erweiterung {#pebblepost-extension}

## Übersicht {#overview}

Die Programmatic Briefpost® von PebblePost unterstützt E-Marketingexperten bei der Verbindung von Online-Interesse und -Intention mit Offline-, materiellen Medien, die konvertiert werden. Marketingexperten können die von ihnen in Adobe erstellten benutzerspezifischen Datensegmente nutzen, um den Verbrauchern nun eine relevante, längerfristige, in-Home-Medien-Impression Zielgruppe. Analysieren Sie die Performance in Echtzeit basierend auf der Aktivität des Antwortpfads und den Konversionen vor Ort.

PebblePost ist eine E-Mail-Erweiterung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
...
![PebblePost-Erweiterung](assets/pebblepost-extension.png)
...
So installieren Sie die PebblePost-Erweiterung:
...
Informationen zu den Erweiterungskonfigurationsoptionen und zur Installationsunterstützung finden Sie auf der Seite [PebblePost in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
