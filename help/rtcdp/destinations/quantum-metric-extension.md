...
description: Die Erweiterung "Quantum-Metrik"ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weiterführende Informationen zur Erweiterungsfunktion finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Erweiterung "Quantum-Metrik"ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weiterführende Informationen zur Erweiterungsfunktion finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
[!DNL Quantum Metric's] Die Integration mit Adobe Launch erleichtert die codellose Bereitstellung von [!DNL Quantum Metric's] Datenerfassungs-Tags. Darüber hinaus Angebot diese Erweiterung die Möglichkeit, Startdatenelemente zu erfassen, die nützliche Informationen aus der [!DNL Quantum Metric] API enthalten.
