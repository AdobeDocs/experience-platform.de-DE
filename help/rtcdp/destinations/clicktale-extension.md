...
description: Die Clicktale-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Funktionalität der Erweiterung finden Sie auf der Seite der Erweiterung auf Adobe Exchange.
seo-description: Die Clicktale-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Funktionalität der Erweiterung finden Sie auf der Seite der Erweiterung auf Adobe Exchange.
...
[!DNL Clicktale's] Die Integration mit Experience Platform Launch ermöglicht die Bereitstellung von [!DNL Clicktale] Code und die Möglichkeit, Datenelemente in Launch mithilfe von [!DNL Clicktale's] Visual Editor zuzuordnen.

[!DNL Clicktale] ist eine Analyseerweiterung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Funktionalität der Erweiterung finden Sie auf der Seite der Erweiterung auf [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100082.html).
