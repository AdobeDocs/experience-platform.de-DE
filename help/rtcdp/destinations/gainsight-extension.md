...
description: Die Gainsight-Erweiterung ist ein Ziel der Personalisierung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die Gainsight-Erweiterung ist ein Ziel der Personalisierung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
# Gainsight-Erweiterung {#gainsight-extension}

## Übersicht {#overview}

Mit den Tools von Gainsight können Produkteigentümer das Benutzerverhalten verstehen, die Produktakzeptanz steigern und Feedback von Benutzern erfassen.

Gainsight ist eine Erweiterung der Personalisierung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
So installieren Sie die Gainsight-Erweiterung:
...
Informationen zu den Erweiterungskonfigurationsoptionen und zur Installationsunterstützung finden Sie auf der Seite [Gainsight in Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
