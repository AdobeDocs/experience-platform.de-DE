...
description: Die TMMData-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weiterführende Informationen zur Erweiterungsfunktion finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die TMMData-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weiterführende Informationen zur Erweiterungsfunktion finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
[!DNL TMMData's] Die Foundation-Plattform für Adobe Marketing Cloud bietet Marketingteams die Werkzeuge, mit denen sie auf alle wichtigen Datenquellen zugreifen und diese miteinander verbinden können - einschließlich interner/externer und Online-/Offline-Daten - für eine sichere, umfassende Analyse über Kanal hinweg mit automatisierter Kampagne-Einrichtung und direktem Import zu Adobe- und anderen Analytics- und BI-Tools.

[!DNL TMMData] ist eine Analyseerweiterung in der Adobe Echtzeit-Kundendatenplattform. Weiterführende Informationen zur Erweiterungsfunktion finden Sie auf der Erweiterungsseite in [Adobe Exchange](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
