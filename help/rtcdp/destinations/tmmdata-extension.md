...
description: Die TMMData-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
seo-description: Die TMMData-Erweiterung ist ein Analyseziel in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Erweiterungsseite in Adobe Exchange.
...
Die TMMData Foundation-Plattform für die Adobe Marketing Cloud bietet Marketingteams die Tools, mit denen sie auf alle wichtigen Datenquellen zugreifen und diese miteinander verbinden können - einschließlich interner/externer und Online-/Offline-Daten -, um eine sichere, umfassende Kanal-übergreifende Analyse zu gewährleisten, die automatisierte Einrichtung von Kampagnen und direkte Importe zu Adobe- und anderen Analyse- und BI-Tools.

TMMData ist eine Analytics-Erweiterung in der Adobe Echtzeit-Kundendatenplattform. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der Seite mit den Erweiterungen in [Adobe Exchange](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
...
Installieren der TMMData-Erweiterung
...
Informationen zu den Erweiterungskonfigurationsoptionen und zur Installationsunterstützung finden Sie auf der Seite [TMMData in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
