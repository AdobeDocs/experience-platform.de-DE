...
1. Als **customer**, können Sie Profile von einem oder mehreren **Datenpartner** , um die Trichterkundenakquise zu optimieren.
...
3. Wählen Sie die **[!UICONTROL Partnerökosystem]** Titel aus den Kategorien auf der linken Seite.
4. Wählen Sie die Bezeichnung **[!UICONTROL Drittanbieter]** und wählen Sie **[!UICONTROL Speichern]**.
...
Nachdem Sie Ihr Datenmodell für die Verwaltung von potenziellen Profilen vorbereitet haben, ist es Zeit, Daten zu erfassen.
...
1. Navigieren Sie zu **[!UICONTROL Data Management]** > **[!UICONTROL Datensätze]** und wählen Sie **[!UICONTROL Datensatz erstellen]**.
...
Beachten Sie, dass es bis zu zwei Stunden dauern kann, bis die Prospektivprofile, die Sie gerade in Real-Time CDP geladen haben, im **[!UICONTROL Durchsuchen]** Ansicht des Bildschirms &quot;Prospect Profile&quot;. Wenn auf der Seite die Meldung &quot;Es gibt derzeit keine potenziellen Profile zum Durchsuchen&quot; angezeigt wird, versuchen Sie es nach einiger Zeit erneut. Nach einiger Wartezeit sollten Interessenten-Profile im **[!UICONTROL Durchsuchen]** anzeigen.

>[!TIP]
>
>Beachten Sie, dass die **[!UICONTROL Identitäts-Namespace]** Spalte. Wenn Sie mit mehreren Datenanbietern arbeiten, verwenden Sie diese Spalte, um die Herkunft von potenziellen Profilen zu ermitteln.
...
* [!BADGE Beta]{type=Informative}[Hinzufügen von Erstanbieterprofilen mit Attributen von vertrauenswürdigen Datenpartnern](/help/rtcdp/partner-data/supplement-first-party-profiles.md) , um Ihre Datenbasis zu verbessern und neue Einblicke in Ihre Kundenbasis zu gewinnen und eine bessere Zielgruppenoptimierung zu erzielen.
