...
topic: queries
type: Tutorial
description: Dieses Dokument umfasst Adoben-definierte Funktionen (ADFs) zur Unterstützung von drei wichtigen Analytics-Aktivitäten für die Segmentierung, Zuordnung und Pathing.
