---
title: Anonymer Block im Abfrage-Service
description: Der anonyme Block ist eine SQL-Syntax, die vom Abfrage-Service von Adobe Experience Platform unterstützt wird und mit der Abfragen effizient ausgeführt werden können.
...
# Anonymer Block im Abfrage-Service

Der Abfrage-Service von Adobe Experience Platform unterstützt anonyme Blöcke. Mit der Funktion für anonyme Blöcke können Sie eine oder mehrere SQL-Anweisungen verketten, die nacheinander ausgeführt werden. Sie beinhalten auch die Möglichkeit der Ausnahmebehandlung.
...
Die folgende Abfrage zeigt ein Beispiel für die Verkettung von SQL-Anweisungen. Weitere Informationen zur verwendeten SQL-Syntax finden Sie unter [SQL-Syntax im Abfrage-Service](../sql/syntax.md).
