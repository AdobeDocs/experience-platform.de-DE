...
Data Distiller ist ein Package, das eine Untergruppe der Funktionen von Adobe Experience Platform enthält. Dieses Paket ist für die Vorbereitung von Daten nach der Erfassung für Echtzeit-Kundenprofile oder Anwendungsfälle für analytische Daten durch Batch-Abfragen vorgesehen, die in Query Service ausgeführt werden. Weitere Informationen zum Data Distiller-Package finden Sie unter [Data Distiller - Übersicht](../data-distiller/overview.md) .
