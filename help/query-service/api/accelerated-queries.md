...
Die Data Distiller SKU ist erforderlich, um den abfragebeschleunigten Speicher zu verwenden. Weitere Informationen finden Sie in der Dokumentation zu [packaging](../packaging.md) und [guardrails](../guardrails.md#query-accelerated-store) sowie zur [licensing](../data-distiller/license-usage.md) -Dokumentation, die sich auf die Data Distiller SKU bezieht. Wenn Sie nicht über die Data Distiller SKU verfügen, wenden Sie sich bitte an den Adobe-Support, um weitere Informationen zu erhalten.
