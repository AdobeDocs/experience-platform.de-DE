...
- Mit den leistungsstarken Abfragefunktionen von Data Distiller können Sie aussagekräftige Funktionen aus den umfangreichen Verhaltensdaten extrahieren, die in Experience Platform verfügbar sind. Sie können die destillierten Funktionsdaten dann in Ihre maschinelle Lernumgebung bringen, ohne große Mengen von Ereignisdaten außerhalb von Experience Platform kopieren zu müssen.
...
- Generieren Sie Bewertungen, Prognosen oder Empfehlungen aus Ihren Modellen und geben Sie die Ausgabe an Experience Platform zurück, um die Kundenerlebnisse über Real-Time Customer Data Platform und Adobe Journey Optimizer zu optimieren.
...
Die in dieser Reihe von Handbüchern enthaltenen Dokumente beschreiben die grundlegenden Schritte zum Erstellen von Funktions-Pipelines aus Experience Platform, um benutzerdefinierte Modelle in Ihre maschinelle Lernumgebung einzuspeisen. Sie können jetzt eine Verbindung zwischen Data Distiller und Ihrem [!DNL Jupyter Notebook] herstellen.
