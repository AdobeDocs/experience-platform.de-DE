...
description: Erfahren Sie, wie die Auditor-Funktion im Adobe Experience Platform Debugger auf Konfigurationen prüft.
...
| Experience Cloud-ID-Dienst - neueste Version | 2 | Auf Ihren Seiten wird nicht die neueste Version der Visitor ID Service-Code-Bibliothek, visitorAPI.js, ausgeführt. Code-Bibliotheken, die Experience Cloud-Technologien nutzen, werden ständig aktualisiert und optimiert, um Performance-Verbesserungen und neueste Funktionen bereitzustellen. | Installieren Sie die neueste Version der Besucher-ID-Service-Bibliothek.<br><br>[Weitere Informationen](https://experienceleague.adobe.com/docs/id-service/using/id-service-api/library.html) |
