...
Mithilfe der Funktion &quot;Datenvorgabe&quot;können Werte anhand der in die Quellfelder eingegebenen Daten berechnet und berechnet werden.
...
| nullify | Legt den Wert des Attributs auf `null`. Dies sollte verwendet werden, wenn Sie das Feld nicht in das Schema Zielgruppe kopieren möchten. |  | nullify() | nullify() | `null` |
