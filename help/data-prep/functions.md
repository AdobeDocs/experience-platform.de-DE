...
| Funktion | Beschreibung | Parameter | Syntax | Ausdruck | Beispielausgabe |
| -------- | ----------- | ---------- | -------| ---------- | ------------- |
| get_url_protocol | Gibt das Protokoll der angegebenen URL aus. Wenn die Eingabe ungültig ist, wird null zurückgegeben. | <ul><li>URL: **Erforderlich** Die URL, aus der das Protokoll extrahiert werden muss.</li></ul> | get_url_protocol&#x200B;(URL) | get_url_protocol(“&#x200B;.adobe.com/home„) | https |
...
| Datum | Konvertiert eine Datumszeichenfolge in ein ZonedDateTime-Objekt (ISO 8601-Format). | <ul><li>DATE: **Required** Die Zeichenfolge, die das Datum darstellt.</li></ul> | date(DATE) | Datum(„2019-10-23 11:24„) | „2019-10-23T11:24:00Z“ |
