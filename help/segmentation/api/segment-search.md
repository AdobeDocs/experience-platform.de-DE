...
topic-legacy: guide
description: In der Adobe Experience Platform Segmentation Service-API wird die Segmentsuche verwendet, um Felder zu durchsuchen, die in verschiedenen Datenquellen enthalten sind, und sie nahezu in Echtzeit zurückzugeben. Dieses Handbuch enthält Informationen zum besseren Verständnis der Segmentsuche sowie Beispiel-API-Aufrufe zum Ausführen grundlegender Aktionen mithilfe der API.
...
Weitere Informationen zur Abfragesyntax finden Sie in der [Dokumentation zur Lucene-Abfragesyntax](https://docs.microsoft.com/en-us/azure/search/query-lucene-syntax).
