...
Sie können das Löschen des angegebenen Exportvorgangs anfordern, indem Sie eine DELETE-Anfrage an den `/export/jobs`-Endpunkt senden und im Anfragepfad die ID des zu löschenden Exportvorgangs angeben.
