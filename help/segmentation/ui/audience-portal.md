...
>title="Abwanderung"
>abstract="Die Fluktuation stellt den Prozentsatz der Profile dar, die sich innerhalb einer Zielgruppendefinition ändern, verglichen mit der letzten Ausführung des Zielgruppenauftrags."
...
Wenn Ihre Zielgruppe innerhalb von sieben Tagen abläuft, können Sie **[!UICONTROL Refresh data expiration]** auswählen, um den letzten erfolgreichen Batch für die Zielgruppe erneut aufzunehmen.

![Die Schaltfläche &quot;[!UICONTROL Refresh data expiration]&quot; ist auf der Seite mit den Zielgruppendetails hervorgehoben.](../images/ui/audience-portal/refresh-data-expiration.png)

Dadurch wird die Datengültigkeit um die beim ersten Hochladen definierte Anzahl von Tagen erweitert und es werden dieselben Zielgruppen-Metadaten verwendet. Wenn die Datengültigkeit nicht zuvor definiert war, wird die Datengültigkeit um 30 Tage verlängert. Nach dem Drücken der Taste kann diese nicht mehr für weitere 20 Minuten ausgewählt werden.

Diese Schaltfläche kann **nicht** in den folgenden Situationen ausgewählt werden:

- Es gibt keine erfolgreichen Batches für die Zielgruppe
- Die erste Aktualisierung ist fehlgeschlagen
- Die Datengültigkeit ist länger als sieben Tage
- Die Zielgruppe ist bereits abgelaufen
