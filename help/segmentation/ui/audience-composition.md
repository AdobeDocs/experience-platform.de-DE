...
Das **[!UICONTROL Composition properties]**-Popover wird angezeigt. Sie können hier Details zu Ihrer Komposition einfügen, einschließlich Titel und Beschreibung.
...
Nachdem Sie die Details Ihrer Komposition aktualisiert haben, wählen Sie **[!UICONTROL Save]** aus, um diese Aktualisierungen zu bestätigen. Die Arbeitsfläche für die Zielgruppenkomposition wird erneut angezeigt.

Die Arbeitsfläche für die Zielgruppenkomposition besteht aus vier verschiedenen Blocktypen: **[[!UICONTROL Audience]](#audience-block)**, **[[!UICONTROL Exclude]](#exclude-block)**, **[[!UICONTROL Rank]](#rank-block)** und **[[!UICONTROL Split]](#split-block)**.
...
Mit dem Blocktyp **[!UICONTROL Audience]** können Sie die Unterzielgruppen hinzufügen, die Sie zum Erstellen Ihrer neuen größeren Zielgruppe verwenden möchten. Standardmäßig ist ein **[!UICONTROL Audience]** oben auf der Arbeitsfläche für die Komposition enthalten.

Bei der Auswahl des **[!UICONTROL Audience]** Blocks zeigt die rechte Leiste Steuerelemente zum Kennzeichnen der Zielgruppe, Hinzufügen von Zielgruppen zum Block sowie Erstellen benutzerdefinierter Regeln für den Zielgruppen-Block an.
...
So fügen Sie Zielgruppen zum Zielgruppenblock hinzu. Wählen Sie **[!UICONTROL Add Audience]** aus.
...
Eine Liste von Zielgruppen wird angezeigt. Wählen Sie die Zielgruppen aus, die Sie einbeziehen möchten, und dann **[!UICONTROL Add]** , um sie an Ihren Zielgruppen-Block anzuhängen.
...
Ihre ausgewählten Zielgruppen werden jetzt in der rechten Leiste angezeigt, wenn der **[!UICONTROL Audience]** ausgewählt ist. Von hier aus können Sie den Zusammenführungstyp der kombinierten Zielgruppen ändern.
...
| ---------- | ----------- |
| [!UICONTROL Union] | Die Zielgruppen werden zu einer Zielgruppe zusammengefasst. Dies entspricht einem OR-Vorgang. |
| [!UICONTROL Intersection] | Die Zielgruppen werden nur mit den Zielgruppen kombiniert, die in **allen** freigegeben sind und hinzugefügt werden. Dies entspricht einem AND-Vorgang. |
| [!UICONTROL Exclude overlap] | Die Zielgruppen werden kombiniert, wobei nur die Zielgruppen hinzugefügt werden, die zu genau **einer, aber nicht zu allen** gehören. Dies entspricht einem XOR-Vorgang. |
...
Um eine benutzerdefinierte Regel zum Zielgruppen -Block hinzuzufügen, wählen Sie **[!UICONTROL Build rule]** aus.
...
Nachdem Sie eine benutzerdefinierte Regel hinzugefügt haben, wählen Sie **[!UICONTROL Save]** aus, um die Regel zu Ihrer Audience hinzuzufügen.
...
Mit dem Blocktyp **[!UICONTROL Exclude]** können Sie eine bestimmte Unterzielgruppe oder Attribute aus Ihrer neuen größeren Zielgruppe ausschließen.

Um einen **[!UICONTROL Exclude]** Block hinzuzufügen, wählen Sie das Symbol **+** und dann **[!UICONTROL Exclude]** aus.

![Die Option „Ausschließen“ ist ausgewählt.](../images/ui/audience-composition/add-exclude-block.png)

Der **[!UICONTROL Exclude]** wird hinzugefügt. Wenn dieser Block ausgewählt ist, werden Details zum Ausschluss in der rechten Leiste angezeigt. Dazu gehören das Label und der Ausschlusstyp des Blocks. Sie können [nach Zielgruppe](#exclude-audience) oder [nach Attribut](#exclude-attribute) ausschließen.
...
Wenn Sie nach Zielgruppe ausschließen, können Sie durch Auswahl von **[!UICONTROL Add Audience]** auswählen, welche Zielgruppe ausgeschlossen werden soll.

![Die Schaltfläche [!UICONTROL Add audience] ist ausgewählt, über die Sie auswählen können, welche Zielgruppe Sie ausschließen möchten.](../images/ui/audience-composition/add-excluded-audience.png)
...
Eine Liste von Zielgruppen wird angezeigt. Wählen Sie **[!UICONTROL Add]** aus, um die Zielgruppe, die ausgeschlossen werden soll, Ihrem Ausschlussblock hinzuzufügen.
...
Eine Liste der Profilattribute wird angezeigt. Wählen Sie den Attributtyp aus, den Sie ausschließen möchten, und dann **[!UICONTROL Select]**, um diese Attribute zu Ihrem Ausschlussblock hinzuzufügen.
...
Mit dem Blocktyp **[!UICONTROL Enrich]** können Sie Ihre Zielgruppe mit zusätzlichen Attributen aus einem Datensatz anreichern. Sie können diese Attribute in Anwendungsfällen der Personalisierung verwenden.

Um einen **[!UICONTROL Enrich]** Block hinzuzufügen, wählen Sie das Symbol **+** und dann **[!UICONTROL Enrich]** aus.

![Die Option &quot;[!UICONTROL Enrich]&quot; ist ausgewählt.](../images/ui/audience-composition/add-enrich-block.png)

Der **[!UICONTROL Enrich]** wird hinzugefügt. Wenn dieser Block ausgewählt ist, werden Details zur Anreicherung in der rechten Leiste angezeigt. Dazu gehören das Label des Blocks und der Anreicherungsdatensatz.
...
![Die Schaltfläche „Filter“ ist hervorgehoben. Wenn Sie dies auswählen, gelangen Sie zum [!UICONTROL Select dataset] Pop-up.](../images/ui/audience-composition/enrich-select-dataset.png)

Das **[!UICONTROL Select dataset]**-Popover wird angezeigt. Wählen Sie den Datensatz aus, den Sie zur Anreicherung hinzufügen möchten, und dann **[!UICONTROL Select]**, den Datensatz zur Anreicherung hinzuzufügen.
...
Der Abschnitt **[!UICONTROL Enrichment criteria]** wird jetzt in der rechten Leiste angezeigt. In diesem Abschnitt können Sie die **[!UICONTROL Source join key]** und die **[!UICONTROL Enrichment dataset join key]** auswählen, mit denen Sie den Anreicherungsdatensatz mit der Audience verknüpfen können, die Sie erstellen möchten.

![Der [!UICONTROL Enrichment criteria] ist hervorgehoben.](../images/ui/audience-composition/enrichment-criteria.png)

Um die **[!UICONTROL Source join key]** auszuwählen, klicken Sie auf das Symbol ![Filter](/help/images/icons/project-edit.png).

Das **[!UICONTROL Select a profile attribute]**-Popover wird angezeigt. Wählen Sie das Profilattribut aus, das Sie als Quell-Zusammenführungsschlüssel verwenden möchten, und dann **[!UICONTROL Select]**, um dieses Attribut als Quell-Zusammenführungsschlüssel auszuwählen.
...
Um die **[!UICONTROL Enrichment dataset join key]** auszuwählen, klicken Sie auf das Symbol ![Filter](/help/images/icons/project-edit.png).

Das **[!UICONTROL Enrichment attributes]**-Popover wird angezeigt. Wählen Sie das Attribut aus, das Sie als Join-Schlüssel des Anreicherungsdatensatzes verwenden möchten, gefolgt von **[!UICONTROL Select]** , um dieses Attribut als Join-Schlüssel Ihres Anreicherungsdatensatzes auszuwählen.
...
Nachdem Sie nun beide Join-Schlüssel hinzugefügt haben, wird der Abschnitt **[!UICONTROL Enrichment attributes]** angezeigt. Jetzt können Sie das Attribut hinzufügen, mit dem Sie Ihre Zielgruppe erweitern möchten. Um diese Attribute hinzuzufügen, wählen Sie **[!UICONTROL Add attribute]** aus.

Das **[!UICONTROL Enrichment attributes]**-Popover wird angezeigt. Sie können die Attribute aus dem Datensatz auswählen, um Ihre Audience anzureichern, gefolgt von **[!UICONTROL Select]**, um die Attribute zu Ihrer Audience hinzuzufügen.
...
Mit dem Blocktyp **[!UICONTROL Rank]** können Sie Profile nach einem bestimmten Attribut ordnen und sortieren und diese Rangprofile in Ihre Komposition einschließen.

Um einen **[!UICONTROL Rank]** hinzuzufügen, wählen Sie das Symbol **+** und dann **[!UICONTROL Rank]** aus.
...
Eine Liste der Profilattribute wird angezeigt. In diesem Popup können Sie den Attributtyp auswählen, nach dem Sie Ihre Zielgruppe ordnen möchten. Wählen Sie **[!UICONTROL Select]** aus, um ihn Ihrem Block „Rang“ hinzuzufügen. Bitte beachten Sie, dass die ausgewählten Attribute **nur** Zahlen sein können.
...
Darüber hinaus können Sie die Anzahl der zurückgegebenen Profile einschränken, indem Sie den Umschalter **[!UICONTROL Add profile limit]** aktivieren. Wenn dieser Umschalter aktiviert ist, können Sie die maximale Anzahl von Profilen festlegen, die innerhalb des Felds **[!UICONTROL Included profiles]** zurückgegeben wird.
...
>[!NOTE]
>
>Um den **[!UICONTROL Split]** Block verwenden zu können **müssen** mindestens 10 Profile in Ihrer Zielgruppe vorhanden sein.

Mit dem Blocktyp **[!UICONTROL Split]** können Sie Ihre neue Zielgruppe in verschiedene Unterzielgruppen unterteilen. Sie können diese Zielgruppe entweder nach Prozentsatz oder nach einem Attribut aufteilen.

Um einen **[!UICONTROL Split]** hinzuzufügen, wählen Sie das Symbol **+** und dann **[!UICONTROL Split]** aus.
...
Bei der Aufteilung nach Attribut werden die Zielgruppen anhand der bereitgestellten Attribute aufgeteilt. Um das Attribut auszuwählen, nach dem aufgeteilt werden soll, wählen Sie den **[!UICONTROL Split]** Block und dann das Symbol ![Filtern](/help/images/icons/project-edit.png) aus.
...
Eine Liste der Profilattribute wird angezeigt. Wählen Sie den Attributtyp und dann **[!UICONTROL Select]** aus, um ihn zu Ihrem Block hinzuzufügen.

![Eine Liste mit Attributen wird angezeigt.](../images/ui/audience-composition/select-attribute.png)

Nach Auswahl des Attributs können Sie festlegen, welche Profile zu welcher Unterzielgruppe gehören werden, indem Sie die Werte im Feld **[!UICONTROL Values]** hinzufügen.
...
Darüber hinaus können Sie den Umschalter **[!UICONTROL Other profiles]** aktivieren, um eine Unterzielgruppe, die aus allen nicht ausgewählten Profilen besteht, zu erstellen.
