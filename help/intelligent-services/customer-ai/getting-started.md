...
- [Übersicht über das Echtzeit-Kundenprofil](../../rtcdp/overview.md): Basierend auf  [!DNL Adobe Experience Platform]Real-time Customer Data Platform (Echtzeit-Kundendatenplattform) können Unternehmen bekannte und unbekannte Daten zusammenführen, um Kundenprofile durch intelligente Entscheidungen auf der gesamten Journey zu aktivieren. Die Echtzeit-Kundendatenplattform fasst unterschiedliche Unternehmensdatenquellen zusammen, um in Echtzeit einheitliche Profile zu erstellen, die über alle Kanäle und Geräte hinweg ein personalisiertes Kundenerlebnis möglich machen.
