...
Die Handbücher für Kunden-KI erfordern ein grundlegendes Verständnis der verschiedenen Experience Platform-Services, die bei der Verwendung von Kunden-KI zum Einsatz kommen. Bevor Sie beginnen, lesen Sie bitte folgende Dokumente:
...
- [Segment Builder-Benutzerhandbuch](../../segmentation/tutorials/create-a-segment.md): Experience Platform ermöglicht Ihnen das einfache Erstellen und Aufrufen von Segmenten sowie die Verwendung verschiedener Bausteine zur weiteren Charakterisierung Ihrer Segmente.
