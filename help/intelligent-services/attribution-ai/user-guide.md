...
In the Adobe Experience Platform UI, click **Services** in the left navigation. Der *Dienste* -Browser wird angezeigt und zeigt verfügbare intelligente Adobe-Dienste an. In the container for Attribution AI, click **Open**.
