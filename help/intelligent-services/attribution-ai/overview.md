...
## Grundlagen von Attributions-KI
...
Attribution AI-Ausgaben können auf verschiedene Dimensionen verteilt und über verschiedene Stadien der Kunden-Journey hinweg verwendet werden. Dies wird erreicht, ohne dass Geschäftsanforderungen an Probleme des maschinellen Lernens übersetzt werden müssen, Algorithmen ausgewählt, trainiert oder Modelle bereitgestellt werden müssen.

Attributions-KI-Daten können aus Adobe (z. B. [!DNL Analytics]) oder Nicht-Adobe-Datenquellen stammen.
...
Attribution AI kann für die folgenden Beispielanwendungsfälle verwendet werden:
...
- **Vollständige funnel-Attribution**: Die Auswirkungen von Marketing auf die gesamte Kunden-Journey verstehen. Beispielsweise die kostenlose Kontoanmeldung für die gebührenpflichtige Konversion und darüber hinaus.
...
Beginnen Sie mit den [Ersten Schritten](./getting-started.md). Dieses Handbuch führt Sie durch die Einrichtung aller erforderlichen Voranfragen für Attributions-KI. Wenn Sie bereits über Ihre Anmeldeinformationen und Daten verfügen, lesen Sie das [Attribution AI-Benutzerhandbuch](./user-guide.md). Dieses Handbuch führt Sie durch das Erstellen einer Instanz sowie das Übermitteln der Instanz zum Trainieren und Bewerten.
