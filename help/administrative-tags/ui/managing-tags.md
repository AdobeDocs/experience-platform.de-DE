...
![Tag-Kategorie auswählen](./images/tag-selection.png)

Auswählen **[!UICONTROL Tag erstellen]** , um ein neues Tag zu erstellen.

![Neues Tag erstellen](./images/new-tag.png)
...
![Tag-Dialogfeld mit neuem Tag-Namen erstellen](./images/create-tag-dialog.png)
...
![Aktion bearbeiten, die im Dropdown-Menü angezeigt wird](./images/edit-action.png)
...
![Tag-Dialogfeld mit aktualisiertem Tag-Namen bearbeiten](./images/edit-dialog.png)
...
![Aktion &quot;Verschieben&quot;im Dropdown-Menü](./images/move-action.png)
...
![Tag-Dialogfeld mit Suchkriterien verschieben, um Tag-Kategorie zu finden](./images/move-dialog.png)
...
![Tag-Liste für die ausgewählte Tag-Kategorie zum Verschieben des Tags](./images/moved-to-tag-category.png)
...
![In der Dropdown-Liste angezeigte Archivaktion](./images/archive-action.png)
...
![Dialogfeld &quot;Tag archivieren&quot;mit Bestätigung](./images/archive-dialog.png)
...
![Aktualisierte Tag-Liste für die aktuelle Tag-Kategorie, in der Tag als archiviert angezeigt wird](./images/archive-status.png)
...
![Wiederherstellen der im Dropdown-Menü angezeigten Aktion](./images/restore-action.png)
...
![Dialogfeld &quot;Tag wiederherstellen&quot;mit Bestätigung](./images/restore-dialog.png)
...
![Aktualisierte Tag-Liste für die aktuelle Tag-Kategorie, in der Tag als aktiv angezeigt wird](./images/restored-active-status.png)
...
![Löschaktion im Dropdown-Menü](./images/delete-action.png)
...
![Tag-Dialogfeld löschen mit Bestätigung](./images/delete-dialog.png)
...
![Aktualisierte Tag-Liste für die aktuelle Tag-Kategorie, in der Tag nicht mehr in der Liste angezeigt wird](./images/deleted-updated-list.png)
...
![Verzeichnis der getaggten Objekte](./images/tagged-objects.png)
