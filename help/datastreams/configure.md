...
Wenn Sie einen Datenstrom für die Verwendung im Experience Platform konfigurieren und auch die Web-SDK verwenden, müssen Sie auch ein [ereignisbasiertes Experience-Datenmodell-Schema (XDM) ](../xdm/classes/experienceevent.md), das die Daten darstellt, die aufgenommen werden sollen.
...
![Adobe-Einstellungen für Audience Manager-Datenstrom.](assets/configure/audience-manager-config.png)
