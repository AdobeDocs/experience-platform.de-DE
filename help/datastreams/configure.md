...
| --- | --- |
| [!UICONTROL Geo-Suche] | Aktiviert die Geolocation-Suche für die ausgewählten Optionen, basierend auf der Besucher-IP-Adresse. Verfügbare Optionen: <ul><li>Country</li><li>Postleitzahl</li><li>Bundesland/Provinz</li><li>DMA</li><li>Stadt</li><li>Breitengrad </li><li>Längengrad</li></ul>Auswählen **[!UICONTROL Ort]**, **[!UICONTROL Breiten]** oder **[!UICONTROL Länge]** bietet Koordinaten von bis zu zwei Dezimalstellen, unabhängig davon, welche anderen Optionen ausgewählt sind. Dies gilt als Granularität auf Stadtebene. <br> <br>Wenn Sie keine Option auswählen, werden die Geolocation-Suchen deaktiviert. Geolocation tritt vor auf [!UICONTROL IP-Verschleierung] und nicht von der  [!UICONTROL IP-Verschleierung] -Einstellung. |
| [!UICONTROL Netzwerksuche] | Aktiviert die Netzwerksuche für die ausgewählten Optionen basierend auf der IP-Adresse des Besuchers. Verfügbare Optionen: <ul><li>Netzbetreiber</li><li>Domain</li><li>ISP</li></ul>Verwenden Sie diese Optionen, um anderen Diensten weitere Informationen über das spezifische Netzwerk bereitzustellen, in dem die Anfragen ihren Ursprung haben. |
