...
* Es wurde ein Problem behoben, bei dem das Web SDK die ID aus dem Experience Cloud-ID-Dienst nicht berücksichtigte.

Enthält Version 2.13.1 der Adobe Experience Platform Web SDK Library.
...
Enthält Version 2.10.1 der Adobe Experience Platform Web SDK Library.

## Version 2.11.1 - 22. April 2022

* Fehlerkorrektur - Konfigurationsbefehl in Version 2.11.0 funktioniert jetzt einwandfrei.
