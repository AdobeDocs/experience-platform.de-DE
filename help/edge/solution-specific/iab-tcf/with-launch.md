---
title: Verwenden von IAB TCF 2.0 mit Start
seo-title: Einrichten der IAB TCF 2.0-Zustimmung mit Adobe Launch und dem Adobe Experience Platform Web SDK
description: Erfahren Sie, wie Sie die IAB TCF 2.0-Zustimmung mit Adobe Launch und Adobe Experience Platform Web SDK einrichten
seo-description: Erfahren Sie, wie Sie die IAB TCF 2.0-Zustimmung mit Adobe Launch und Adobe Experience Platform Web SDK einrichten
...
Um IAB TCF 2.0 mit Experience Platform Launch und der AEP Web SDK Extension zu verwenden, benötigen Sie ein XDM-Schema und einen Dataset. Wenn Sie keines dieser beiden Optionen eingestellt haben, lesen Sie den Beginn im Handbuch zum Starten des [](../../getting-started/quick-start-with-launch.md) Adobe Experience Platform Web SDK-Beginns, bevor Sie fortfahren.
