...
Damit diese Berichtsmethode ordnungsgemäß funktioniert, müssen Sie die [!DNL A4T] verwandte Daten, die von der [`sendEvent`](/help/web-sdk/commands/sendevent/overview.md) im Analytics-Treffer.
