---
title: Protokollierung von Adobe Analytics for Target (A4T) in der Platform Web SDK
...
# Protokollierung von Adobe Analytics for Target (A4T) in der Platform Web SDK
...
| --- | --- |
| Server-seitige Analytics-Protokollierung | Alle über das Edge Network gesendeten Analytics-Treffer werden Server-seitig um Target-Details erweitert, ohne dass der Trefferzusammenfügungsprozess durchlaufen werden muss. |
...
* [Server-seitige Protokollierung für A4T-Daten in Platform Web SDK](./server-side.md)
* [Client-seitige Protokollierung für A4T-Daten in Platform Web SDK](./client-side.md)
