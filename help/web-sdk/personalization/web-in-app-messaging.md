...
Weitere Informationen zum Konfigurieren einer CSP finden Sie unter [dedizierte Dokumentation](../use-cases/configuring-a-csp.md).
...
Im [Web SDK-Konfiguration](../commands/configure/overview.md) legen Sie die `personalizationStorageEnabled` -Option entsprechend Ihren Anforderungen:
