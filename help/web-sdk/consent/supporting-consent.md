...
keywords: consent; defaultConsent; Standardzustimmung; setConsent; Profildatenschutzfeldgruppe; Experience Event Privacy-Feldergruppe; Datenschutzfeldgruppe;
...
## Übermitteln von Zustimmungsvoreinstellungen über den Adobe Experience Platform-Standard
...
### Verwenden des Adobe-Standards Version 2.0

Wenn Sie Adobe Experience Platform verwenden, müssen Sie eine Datenschutzschema-Feldergruppe in Ihr Profilschema aufnehmen. Siehe [Governance, Datenschutz und Sicherheit in Adobe Experience Platform](../../landing/governance-privacy-security/overview.md) für weitere Informationen zur Adobe-Standardversion 2.0. Sie können Daten innerhalb des Wertobjekts hinzufügen, die dem Schema des `consents` des [!UICONTROL Einverständnis und Voreinstellungen] Profilfeldgruppe.

Wenn sich der Benutzer anmeldet, führen Sie die `setConsent` -Befehl mit der Auswahl-Voreinstellung auf `y` wie folgt:
...
Im Zeitfeld sollte angegeben werden, wann der Benutzer seine Zustimmungseinstellungen zuletzt aktualisiert hat. Wenn der Benutzer sich entscheidet, sich abzumelden, führen Sie die `setConsent` -Befehl mit der Auswahl-Voreinstellung auf `n` wie folgt:
...
### Verwenden des Adobe-Standards Version 1.0
