...
user-guide-description: Visualisieren Sie Experience Platformen auf anpassbaren Dashboards.
...
* [Übersicht über Dashboard](home.md)
* Verfügbare Dashboard {#guides}
   * [Profile](guides/profiles.md)
   * [Segmente](guides/segments.md)
   * [Ziele](guides/destinations.md)
   * [Lizenzverwendung](guides/license-usage.md)
