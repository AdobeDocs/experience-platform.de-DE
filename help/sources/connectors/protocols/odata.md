...
Die nachstehende Dokumentation enthält Informationen dazu, wie [!DNL Generic OData] mithilfe von APIs oder der Benutzeroberfläche mit [!DNL Platform] verbunden wird:
