...
### IP-Adresse für die Verbindung mit Azure

Sie müssen Ihrer Zulassungsliste regionsspezifische IP-Adressen hinzufügen, bevor Sie Ihre Quellen mit Experience Platform in Azure verbinden. Wenn Sie Ihre regionsspezifischen IP-Adressen nicht zu Ihrer Zulassungsliste hinzufügen, kann dies bei der Verwendung von Quellen zu Fehlern oder Leistungseinbußen führen. Weitere Informationen finden [&#x200B; auf der Seite &#x200B;](../../ip-address-allow-list.md)IP-Adresse“.
...
| `PRIVATE_KEY` | Eine Berechtigung, die zum Authentifizieren Ihrer [!DNL Postman] bei Experience Platform-APIs verwendet wird. Anweisungen zum Abrufen Ihrer [&#x200B; finden Sie im Tutorial zum Einrichten  [!DNL Postman]](../../../landing/postman.md) Entwicklerkonsole und {PRIVATE_KEY}Einrichten der Entwicklerkonsole und . | `{PRIVATE_KEY}` |
...
| `munchkinId` | Die eindeutige ID für Ihr [!DNL Marketo]. Informationen zum Abrufen Ihrer [&#x200B; finden  [!DNL Marketo]  im Tutorial &#x200B;](../adobe-applications/marketo/marketo-auth.md)Authentifizieren `munchkinId`Instanz) . | `123-ABC-456` |
| `sfdc_org_id` | Die Organisations-ID für Ihr [!DNL Salesforce]. Weiterführende Informationen dazu, [[!DNL Salesforce]  Sie Ihre &#x200B;](https://help.salesforce.com/articleView?id=000325251&type=1&mode=1)-Organisations-ID erhalten, finden Sie im folgenden Handbuch[!DNL Salesforce] . | `00D4W000000FgYJUA0` |
...
### IP-Adresse für die Verbindung mit AWS
