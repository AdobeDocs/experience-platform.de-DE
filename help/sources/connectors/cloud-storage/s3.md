...
## Verwenden Sie temporäre Sicherheitsberechtigungen, um [!DNL Amazon S3] zu verbinden

Sie können [!DNL Amazon S3] mit temporären Sicherheitsberechtigungen über die `s3SessionToken` verbinden. Dadurch können Sie [!DNL Amazon S3] mit Platform verbinden, ohne dauerhafte IAM-Anmeldeinformationen mit [!DNL Amazon Web Services] erstellen zu müssen, oder Benutzern in nicht vertrauenswürdigen Umgebungen Zugriff auf Ihren [!DNL Amazon S3]-Behälter gewähren.
