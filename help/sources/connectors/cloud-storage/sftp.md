...
title: SFTP-Anschluss
topic: overview
description: Die nachstehende Dokumentation enthält Informationen dazu, wie ein SFTP-Server mit APIs oder der Benutzeroberfläche mit der Plattform verbunden werden kann.
...
## Verbinden von SFTP mit [!DNL Platform]

>[!IMPORTANT]
>
>Benutzer müssen die interaktive Keyboard-Authentifizierung in der SFTP-Serverkonfiguration deaktivieren, bevor eine Verbindung hergestellt werden kann. Wenn Sie die Einstellung deaktivieren, können Kennwörter manuell eingegeben werden, anstatt über einen Dienst oder ein Programm einzugeben. Weitere Informationen zur interaktiven Authentifizierung mit [Tastatur finden Sie im Dokument](https://doc.componentpro.com/ComponentPro-Sftp/authenticating-with-a-keyboard-interactive-authentication) Component Pro.

In der folgenden Dokumentation finden Sie Informationen dazu, wie ein SFTP-Server mit APIs oder der [!DNL Platform] Benutzeroberfläche verbunden werden kann:

### Verwenden der APIs

- [Erstellen eines SFTP-Connectors mit der Flow Service API](../../tutorials/api/create/cloud-storage/sftp.md)
...
- [Erstellen eines SFTP-Quellconnectors in der Benutzeroberfläche](../../tutorials/ui/create/cloud-storage/sftp.md)
