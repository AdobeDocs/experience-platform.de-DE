...
| Parameter | Beschreibung |
| --- | --- | 
| `webhook.address` | Der HTTP-Endpunkt, an den Streaming-Nachrichten gesendet werden. Die Vorlage für den Webhook lautet: `https://dcs.adobedc.net/collection/{INLET_ID}?x-adobe-flow-id={FLOW_ID}.` |
