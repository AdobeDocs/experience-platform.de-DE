...
## Verbinden von [!DNL Salesforce Service Cloud]mit [!DNL Experience Platform] mithilfe von APIs
...
## Verbinden von [!DNL Salesforce Service Cloud] mit [!DNL Experience Platform] über die Benutzeroberfläche
