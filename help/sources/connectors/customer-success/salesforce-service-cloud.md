...
Die folgende Dokumentation enthält Informationen zum Verbinden von [!DNL Salesforce Service Cloud] mit [!DNL Platform] mithilfe von APIs oder der Benutzeroberfläche:
