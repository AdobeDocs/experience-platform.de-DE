...
Die folgenden Tabellen enthalten die Zuordnungen zwischen [!DNL Salesforce] Quellfeldern und den entsprechenden XDM-Feldern (Experience-Datenmodell).
...
| `Email` | `workEmail.address` | Dies ist die sekundäre Identität. |
| `Email` | `personComponents.workEmail.address` |
| `Fax` | `faxPhone.number` |
| `FirstName` | `person.name.firstName` |
| `HomePhone` | `homePhone.number` |
| `Id` | `personID` | Dies ist die primäre Identität |
...
| `BillingCity` | Adresse | `accountBillingAddress.city` |
...
| `Id` | `accountID` | Dies ist die primäre Identität |
...
| `Id` | `opportunityID` | Dies ist die primäre Identität |
| `IsClosed` | `isClosed` |
| `IsWon` | `isWon` |
| `LastActivityDate` | `extSourceSystemAudit.lastActivityDate` |
| `LastModifiedDate` | `extSourceSystemAudit.lastUpdatedDate` |
...
| Quellfeld | Target XDM-Feldpfad | Anmerkungen |
| --- | --- | --- |
| `ContactId` | `personID` | Beziehung |
| `CreatedDate` | `extSourceSystemAudit.createdDate` |
| `Id` | `opportunityPersonID` | Dies ist die primäre Identität |
| `IsPrimary` | `isPrimary` |
| `LastModifiedDate` | `extSourceSystemAudit.lastUpdatedDate` |
| `OpportunityId` | `opportunityID` | Beziehung |
| `Role` | `personRole` |
...
| Quellfeld | Target XDM-Feldpfad | Anmerkungen |
| --- | --- | --- |
| `Id` | `xdm: campaignID` | Dies ist die primäre Identität |
...
| Quellfeld | Target XDM-Feldpfad | Anmerkungen |
| --- | --- | --- |
| `Id` | `campaignMemberID` | Dies ist die primäre Identität |
| `CampaignId` | `campaignID` | Beziehung |
| `LeadOrContactId` | `personID` | Beziehung |
| `Status` | `memberStatus` |
...
Durch Lesen dieses Dokuments haben Sie Einblicke in die Zuordnungsbeziehung zwischen [!DNL Salesforce] Quellfeldern und den zugehörigen XDM-Feldern erhalten. Informationen zum Starten Ihres [!DNL Salesforce]-Datenflusses finden Sie im Tutorial zum Erstellen einer [!DNL Salesforce] Quellverbindung](../../../tutorials/ui/create/crm/salesforce.md) .[
