...
Diese Felder sind nicht als Identitäten markiert. Stattdessen werden dieselben Identitäten (sofern im Ereignis vorhanden) in die `identityMap` als Schlüssel-Wert-Paare:
