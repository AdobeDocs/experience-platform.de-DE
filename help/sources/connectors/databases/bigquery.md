...
# (Beta) [!DNL Google BigQuery] -Anschluss

>[!NOTE]
>
>Das [!DNL Google BigQuery] ist in Beta. Weitere Informationen zur Verwendung von Beta-gekennzeichneten Connectors finden Sie in der Übersicht [zu den](../../home.md#terms-and-conditions) Quellen.
...
Die nachstehende Dokumentation enthält Informationen zum Herstellen einer Verbindung [!DNL Google BigQuery] mit [!DNL Platform] APIs oder der Benutzeroberfläche:

## Verbindung [!DNL Google BigQuery] mit [!DNL Platform] APIs
...
## Verbindung [!DNL Google BigQuery] mit der [!DNL Platform] Benutzeroberfläche

- [Erstellen eines Quell-Connectors für Google BigQuery über die Benutzeroberfläche](../../tutorials/ui/create/databases/bigquery.md)
