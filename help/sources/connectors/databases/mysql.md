...
Die nachstehende Dokumentation enthält Informationen dazu, wie MySQL mit APIs oder der Benutzeroberfläche [!DNL Platform] verbunden werden kann:

## Verbindung von MySQL mit [!DNL Platform] APIs
...
## Verbindung von MySQL mit der [!DNL Platform] Benutzeroberfläche
