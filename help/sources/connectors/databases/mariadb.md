...
Die folgende Dokumentation enthält Informationen zum Verbinden von [!DNL MariaDB] mit [!DNL Experience Platform] mithilfe von APIs oder der Benutzeroberfläche:

## Verbinden von [!DNL MariaDB] mit [!DNL Experience Platform] mithilfe von APIs
...
## Verbinden von [!DNL MariaDB] mit [!DNL Experience Platform] über die Benutzeroberfläche
