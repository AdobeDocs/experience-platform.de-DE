...
Die folgende Dokumentation enthält Informationen zur Verbindung von [!DNL Azure Synapse Analytics] mit mithilfe von APIs oder der Benutzeroberfläche:[!DNL Platform]
