...
Die folgende Dokumentation enthält Informationen zum Verbinden von [!DNL Apache Hive] über [!DNL Azure HDInsights] mit [!DNL Platform] mithilfe von APIs oder der Benutzeroberfläche:

## Verbinden von [!DNL Apache Hive] auf [!DNL Azure HDInsights] mit [!DNL Platform] mithilfe von APIs
...
## Verbinden von [!DNL Apache Hive] auf [!DNL Azure HDInsights] mit [!DNL Platform] über die Benutzeroberfläche
