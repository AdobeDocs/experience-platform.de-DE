...
Die folgende Dokumentation enthält Informationen zur Verbindung [!DNL Apache Hive] on [!DNL Azure HDInsights] nach [!DNL Platform] Verwendung von APIs oder der Benutzeroberfläche:
...
- [Erstellen einer Apache Hive-Quellverbindung mit Azure HDInsights in der Benutzeroberfläche](../../tutorials/ui/create/databases/hive.md)
