...
Die folgende Dokumentation enthält Informationen zur Verbindung [!DNL Snowflake] zur Plattform mithilfe von APIs oder der Benutzeroberfläche:

## Verbinden [!DNL Snowflake] zur Plattform mithilfe von APIs
...
## Verbinden [!DNL Snowflake] zur Plattform mithilfe der Benutzeroberfläche
