...
Die nachstehende Dokumentation enthält Informationen zum Herstellen einer Verbindung [!DNL PostgreSQL] mit [!DNL Platform] APIs oder der Benutzeroberfläche:

## Verbindung [!DNL PostgreSQL] mit [!DNL Platform] APIs

- [Erstellen eines PostgreSQL-Connectors mit der Flow Service API](../../tutorials/api/create/databases/postgres.md)
...
## Verbindung [!DNL PostgreSQL] mit der [!DNL Platform] Benutzeroberfläche

- [Erstellen eines Quell-Connectors für PostgreSQL über die Benutzeroberfläche](../../tutorials/ui/create/databases/postgres.md)
