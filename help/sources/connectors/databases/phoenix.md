...
Die nachstehende Dokumentation enthält Informationen dazu, wie [!DNL Phoenix] mithilfe von APIs oder der Benutzeroberfläche mit [!DNL Platform] verbunden wird:
