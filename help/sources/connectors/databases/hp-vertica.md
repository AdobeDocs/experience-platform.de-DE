...
## Verbinden von [!DNL HP Vertica] mit [!DNL Experience Platform] mithilfe von APIs
...
## Verbinden von [!DNL HP Vertica] mit [!DNL Experience Platform] über die Benutzeroberfläche

- [Erstellen einer HP Vertica-Quellverbindung über die Benutzeroberfläche](../../tutorials/ui/create/databases/hp-vertica.md)
