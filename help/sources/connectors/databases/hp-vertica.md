---
keywords: Experience Platform;Home;beliebte Themen;HP Vertica;hp Vertikal
solution: Experience Platform
title: HP Vertica Source Connector - Übersicht
topic: overview
description: Erfahren Sie, wie Sie HP Vertica mit APIs oder der Benutzeroberfläche mit Adobe Experience Platform verbinden.
...
>[!NOTE]
>
>Der [!DNL HP Vertica]-Anschluss befindet sich in der Betaversion. Weitere Informationen zur Verwendung von Beta-gekennzeichneten Connectors finden Sie unter [Sources overview](../../home.md#terms-and-conditions).
...
Es werden verschiedene Arten von Drittanbieter-Datenbanken unterstützt, einschließlich relationaler Datenbanken, NoSQL-Datenbanken oder Data Warehouse. Die Unterstützung für Datenbankanbieter umfasst [!DNL HP Vertica].
...
Die nachstehende Dokumentation enthält Informationen dazu, wie [!DNL HP Vertica] mithilfe von APIs oder der Benutzeroberfläche mit [!DNL Platform] verbunden wird:

## Verbinden Sie [!DNL HP Vertica] mit [!DNL Platform] mithilfe von APIs

- [Erstellen einer HP Vertica-Quellverbindung mit der Flow Service API](../../tutorials/api/create/databases/hp-vertica.md)
...
## Verbinden Sie [!DNL HP Vertica] mit [!DNL Platform] mithilfe der Benutzeroberfläche
