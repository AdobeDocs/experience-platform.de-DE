...
[!DNL Experience Platform] unterstützt die Aufnahme von Daten aus einer Drittanbieterdatenbank. [!DNL Experience Platform] können eine Verbindung zu verschiedenen Datenbanktypen herstellen, z. B. relationale Datenbanken, NoSQL oder Data Warehouses. Der Support für Datenbankanbieter umfasst [!DNL Apache Cassandra].

Die folgende Dokumentation enthält Informationen zum Verbinden von [!DNL Apache Cassandra] mit [!DNL Experience Platform] mithilfe von APIs:

## Verbinden von [!DNL Apache Cassandra] mit [!DNL Experience Platform] mithilfe von APIs
