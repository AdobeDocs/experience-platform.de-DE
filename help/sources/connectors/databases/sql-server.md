...
Die folgende Dokumentation enthält Informationen zur Verbindung [!DNL Microsoft] SQL Server auf [!DNL Platform] Verwendung von APIs oder der Benutzeroberfläche:

## Verbinden [!DNL Microsoft] SQL Server auf [!DNL Platform] Verwenden von APIs
...
## Verbinden [!DNL Microsoft] SQL Server auf [!DNL Platform] über die Benutzeroberfläche
