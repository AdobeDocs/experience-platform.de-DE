...
>[!NOTE]
>
>* Um einen Datenfluss zu erstellen, müssen Sie bereits über eine gültige Basis-Verbindungs-ID mit einer Kunden-Erfolgsquelle verfügen. Wenn Sie nicht über diese ID verfügen, finden Sie in der [Quellenübersicht](../../../home.md#customer-success) eine Liste der Kundenerfolgsquellen, mit denen Sie eine Basisverbindung erstellen können.
