...
type: Tutorial
description: In diesem Tutorial werden die Schritte zum Abrufen von Daten aus einem CRM-System eines Drittanbieters und zum Einbringen dieser Daten in Experience Platform mithilfe von Quell-Connectoren und APIs beschrieben.
...
In diesem Tutorial werden die Schritte zum Abrufen von Daten aus einer CRM-Quelle und zum Übertragen dieser Daten in Experience Platform mithilfe von [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/) beschrieben.

>[!NOTE]
>
>* Um einen Datenfluss zu erstellen, müssen Sie bereits über eine gültige Basisverbindungs-ID mit einer CRM-Quelle verfügen. Wenn Sie diese ID nicht haben, finden Sie in der [Quellen - Übersicht](../../../home.md#customer-relationship-management) eine Liste der CRM-Quellen, mit denen Sie eine Basisverbindung erstellen können.
...
Ein Datenfluss ist für die Erfassung von Daten aus Quellen und deren Aufnahme in Experience Platform verantwortlich. Um einen Datenfluss zu erstellen, müssen Sie zunächst die Datenflussspezifikationen abrufen, die für die Erfassung von CRM-Daten gelten.
...
In diesem Tutorial haben Sie einen Quell-Connector erstellt, um Daten aus einem CRM-System nach Plan zu erfassen. Eingehende Daten können jetzt von nachgelagerten Experience Platform-Services wie [!DNL Real-Time Customer Profile] und [!DNL Data Science Workspace] verwendet werden. Weiterführende Informationen finden Sie in folgenden Dokumenten:
