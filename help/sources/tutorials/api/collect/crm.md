...
topic: overview
description: In diesem Lernprogramm werden die Schritte zum Abrufen von Daten aus einem Drittanbieter-CRM und zum Integrieren in die Plattform über Quellschnittstellen und die Flow Service API beschrieben.
