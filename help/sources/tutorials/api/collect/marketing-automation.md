...
In diesem Tutorial werden die Schritte zum Abrufen von Daten aus einer Marketing-Automatisierungsquelle und zum Übertragen dieser Daten in Experience Platform mithilfe von [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/) beschrieben.

>[!NOTE]
>
>* Um einen Datenfluss zu erstellen, müssen Sie bereits über eine gültige Basisverbindungs-ID mit einer Marketing-Automatisierungsquelle verfügen. Wenn Sie diese ID nicht haben, finden Sie in der [Quellen - Übersicht](../../../home.md#marketing-automation) eine Liste der Marketing-Automatisierungsquellen, mit denen Sie eine Basisverbindung erstellen können.
...
Ein Datenfluss ist für die Erfassung von Daten aus Quellen und deren Aufnahme in Experience Platform verantwortlich. Um einen Datenfluss zu erstellen, müssen Sie zunächst die Datenflussspezifikationen abrufen, die für die Erfassung von Daten zur Marketing-Automatisierung zuständig sind.
...
In diesem Tutorial haben Sie einen Quell-Connector erstellt, um entsprechend einem Zeitplan Daten aus einem Marketing-Automatisierungssystem zu erfassen. Eingehende Daten können jetzt von nachgelagerten Experience Platform-Services wie [!DNL Real-Time Customer Profile] und [!DNL Data Science Workspace] verwendet werden. Weiterführende Informationen finden Sie in folgenden Dokumenten:
