...
type: Tutorial
description: In diesem Tutorial werden die Schritte zum Abrufen von Daten aus einem Protokollprogramm und deren Aufnahme in Experience Platform mithilfe von Quell-Connectoren und APIs beschrieben.
...
In diesem Tutorial werden die Schritte zum Abrufen von Daten aus einer Protokollquelle und zum Übertragen dieser Daten in Experience Platform mithilfe von [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/) beschrieben.
...
Ein Datenfluss ist für die Erfassung von Daten aus Quellen und deren Aufnahme in Experience Platform verantwortlich. Um einen Datenfluss zu erstellen, müssen Sie zunächst die Datenflussspezifikationen abrufen, die für die Datenerfassung aus Ihrem Protokollprogramm zuständig sind.
...
In diesem Tutorial haben Sie einen Quell-Connector erstellt, um Daten aus einem Protokollprogramm nach einem Plan zu erfassen. Eingehende Daten können jetzt von nachgelagerten Experience Platform-Services wie [!DNL Real-Time Customer Profile] und [!DNL Data Science Workspace] verwendet werden. Weiterführende Informationen finden Sie in folgenden Dokumenten:
