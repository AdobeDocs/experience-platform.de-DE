...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie benötigen, um mit der [!DNL Flow Service] API eine erfolgreiche Verbindung zu einem SFTP-Server herzustellen.
