...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie benötigen, um eine erfolgreiche Verbindung mit SQL Server mithilfe der [!DNL Flow Service] API herzustellen.
