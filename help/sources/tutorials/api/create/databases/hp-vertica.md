...
# Erstellen eines HP [!DNL Vertica]-Connectors mit der [!DNL Flow Service]-API
...
In diesem Lernprogramm haben Sie eine HP [!DNL Vertica]-Verbindung mit der API [!DNL Flow Service] erstellt und den eindeutigen ID-Wert der Verbindung erhalten. Sie können diese ID im nächsten Lernprogramm verwenden, um zu erfahren, wie Sie Datenbanken mithilfe der Flow Service API[ untersuchen.](../../explore/database-nosql.md)
