...
# Erstellen Sie einen [!DNL Google BigQuery]-Connector mit der [!DNL Flow Service]-API
...
Damit [!DNL Flow Service] eine Verbindung mit BigQuery herstellen kann, müssen Sie die folgenden Verbindungseigenschaften angeben:
