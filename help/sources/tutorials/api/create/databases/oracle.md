...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie benötigen, um eine Verbindung mit [!DNL Oracle] der [!DNL Flow Service] API herstellen zu können.
...
Um eine [!DNL Oracle] Verbindung zu erstellen, muss die eindeutige Verbindungs-ID als Teil der POST-Anforderung angegeben werden. Die Verbindungs-ID für [!DNL Oracle] lautet `d6b52d86-f0f8-475f-89d4-ce54c8527328`.
