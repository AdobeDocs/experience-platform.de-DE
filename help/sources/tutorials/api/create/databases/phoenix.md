...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie benötigen, um eine Verbindung mit [!DNL Phoenix] der [!DNL Flow Service] API herstellen zu können.
...
Um eine [!DNL Phoenix] Verbindung zu erstellen, muss die eindeutige Verbindungs-ID als Teil der POST-Anforderung angegeben werden. Die Verbindungs-ID für [!DNL Phoenix] lautet `102706fb-a5cd-42ee-afe0-bc42f017ff43`.
