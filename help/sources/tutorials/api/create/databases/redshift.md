...
# Erstellen Sie einen [!DNL Amazon Redshift]-Connector mit der [!DNL Flow Service]-API
...
In diesem Lernprogramm haben Sie eine [!DNL Redshift]-Verbindung mit der [!DNL Flow Service]-API erstellt und den eindeutigen ID-Wert der Verbindung erhalten. Sie können diese Verbindungs-ID im nächsten Lernprogramm verwenden, um zu erfahren, wie Sie mit der Flow Service API[Datenbanken oder NoSQL-Systeme untersuchen.](../../explore/database-nosql.md)
