...
topic: overview
type: Tutorial
description: In diesem Lernprogramm wird die Flow Service API verwendet, um Sie durch die Schritte zu führen, die notwendig sind, um Azurblase Synapse Analytics (im Folgenden "Synapse" genannt) mit der Experience Platform zu verbinden.
...
>[!NOTE]
>
>Der Azurblase Synapse Analytics Connector befindet sich in der Betaphase. Weitere Informationen zur Verwendung von Beta-gekennzeichneten Connectors finden Sie in der Übersicht [zu den](../../../../home.md#terms-and-conditions) Quellen.
