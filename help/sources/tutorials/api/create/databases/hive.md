...
In diesem Tutorial haben Sie eine [!DNL Apache Hive] on [!DNL Azure HDInsights] Basisverbindung mit [!DNL Flow Service] API. Sie können diese Basis-Verbindungs-ID in den folgenden Tutorials verwenden:
