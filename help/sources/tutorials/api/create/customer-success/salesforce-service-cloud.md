...
topic: overview
type: Tutorial
description: Dieses Lernprogramm verwendet die Flow Service API, um Sie durch die Schritte zur Verbindung der Experience Platform mit der Salesforce Service Cloud (nachfolgend "SSC" genannt) zu führen.
...
# Erstellen Sie einen [!DNL Salesforce Service Cloud]-Connector mit der [!DNL Flow Service]-API
...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie benötigen, um mit der API [!DNL Flow Service] erfolgreich eine Verbindung zu SSC herzustellen.
...
In diesem Lernprogramm haben Sie eine SSC-Verbindung mit der API [!DNL Flow Service] erstellt und den eindeutigen ID-Wert der Verbindung erhalten. Sie können diese Verbindungs-ID im nächsten Lernprogramm verwenden, um zu erfahren, wie Sie mithilfe der Flow Service API[ Kundenerfolgssysteme untersuchen.](../../explore/customer-success.md)
