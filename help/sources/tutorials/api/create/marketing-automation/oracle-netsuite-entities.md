---
title: Erstellen einer Quellverbindung und eines Datenflusses für das Oracle von NetSuite-Entitäten mithilfe der Flow Service-API
description: Erfahren Sie, wie Sie eine Quellverbindung und einen Datenfluss erstellen, um Oracle NetSuite-Kontakte und -Kundendaten mithilfe der Flow Service-API auf Experience Platform zu übertragen.
hide: true
hidefromtoc: true
badge: Beta
...
## Verbinden von [!DNL Oracle NetSuite Entities] mit Platform mithilfe der [!DNL Flow Service]-API

Im Folgenden werden die Schritte beschrieben, die Sie ausführen müssen, um Ihre [!DNL Oracle NetSuite Entities] zu authentifizieren, eine Quellverbindung zu erstellen und einen Datenfluss zu erstellen, um Ihre Kunden- und Kontaktdaten auf Experience Platform zu bringen.
...
Der letzte Schritt, um Daten von [!DNL Oracle NetSuite Entities] an Platform zu übertragen, besteht darin, einen Datenfluss zu erstellen. Bislang haben Sie die folgenden erforderlichen Werte vorbereitet:
