...
In diesem Tutorial haben Sie eine [!DNL Salesforce Marketing Cloud] Basisverbindung mit [!DNL Flow Service] API. Sie können diese Basis-Verbindungs-ID in den folgenden Tutorials verwenden:
