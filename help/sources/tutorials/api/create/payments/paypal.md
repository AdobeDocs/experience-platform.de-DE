...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie benötigen, um eine Verbindung mit [!DNL PayPal] der [!DNL Flow Service] API herstellen zu können.
...
| Kundengeheimnis | Das mit Ihrer [!DNL PayPal] Anwendung verknüpfte Clientgeheimnis. |
...
Um eine [!DNL PayPal] Verbindung zu erstellen, muss die eindeutige Verbindungs-ID als Teil der POST-Anforderung angegeben werden. Die Verbindungs-ID für [!DNL PayPal] lautet `221c7626-58f6-4eec-8ee2-042b0226f03b`.
