...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie kennen müssen, damit Sie mit der [!DNL Flow Service] API eine Verbindung zu einer Datenbank eines Drittanbieters herstellen können.
...
Mithilfe der Verbindungs-ID für Ihre Datenbank können Sie Ihre Datentabellen durch GET-Anforderungen untersuchen. Verwenden Sie den folgenden Aufruf, um den Pfad der Tabelle zu finden, die Sie überprüfen oder in die Sie eingehen möchten [!DNL Platform].
...
In diesem Tutorial haben Sie Ihre Datenbank erforscht, den Pfad der Tabelle gefunden, in die Sie eingehen möchten, [!DNL Platform]und Informationen zu ihrer Struktur erhalten. Sie können diese Informationen im nächsten Lernprogramm verwenden, um Daten aus Ihrer Datenbank zu [erfassen und in die Platform](../collect/database-nosql.md)zu bringen.