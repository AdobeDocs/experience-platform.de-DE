...
Eine erfolgreiche Antwort ist eine Reihe von Tabellen von zu Ihrem Marketing-Automatisierungssystem. Suchen Sie die Tabelle, die Sie in [!DNL Platform] einbinden möchten, und notieren Sie sich deren `path`-Eigenschaft, da Sie sie im nächsten Schritt bereitstellen müssen, um ihre Struktur zu überprüfen.
...
In diesem Tutorial haben Sie Ihr Marketing-Automatisierungssystem durchsucht, den Pfad der Tabelle gefunden, die Sie in [!DNL Platform] einführen möchten, und Informationen über die Struktur erhalten. Sie können diese Informationen im nächsten Tutorial zu [Datenerfassung aus Ihrem Marketing-Automatisierungssystem verwenden und in Platform](../collect/marketing-automation.md) übertragen.
