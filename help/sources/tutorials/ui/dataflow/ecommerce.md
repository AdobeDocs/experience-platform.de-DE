...
Darüber hinaus erfordert dieses Lernprogramm, dass Sie bereits ein **[!UICONTROL eCommerce]**-Konto erstellt haben. Eine Liste von Lernprogrammen zum Erstellen verschiedener **[!UICONTROL eCommerce]** Connectors in der Benutzeroberfläche finden Sie unter [Übersicht über die Quellschnittstellen](../../../home.md).

## Daten auswählen

Nachdem Sie Ihr **[!UICONTROL eCommerce]**-Konto erstellt haben, wird der Schritt **[!UICONTROL Daten auswählen]** angezeigt und bietet eine interaktive Oberfläche, in der Sie Ihre Dateihierarchie untersuchen können.
