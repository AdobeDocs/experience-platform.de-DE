...
title: Erstellen eines Datenflusses mit einer Customer Success Source in der Benutzeroberfläche
type: Tutorial
description: Ein Datenfluss ist eine geplante Aufgabe, mit der Daten aus einer Quelle abgerufen und in einen Platform-Datensatz aufgenommen werden. In diesem Tutorial erfahren Sie, wie Sie mithilfe der Platform-Benutzeroberfläche einen Datenfluss für eine Customer-Success-Quelle erstellen.
...
# Erstellen eines Datenflusses mithilfe einer Customer-Success-Quelle in der Benutzeroberfläche

Ein Datenfluss ist eine geplante Aufgabe, mit der Daten aus einer Quelle abgerufen und in einen Datensatz in Adobe Experience Platform aufgenommen werden. In diesem Tutorial erfahren Sie, wie Sie mithilfe der Platform-Benutzeroberfläche einen Datenfluss für eine Customer-Success-Quelle erstellen.

>[!NOTE]
>
>* Um einen Datenfluss zu erstellen, müssen Sie bereits über ein authentifiziertes Konto mit einer Customer-Success-Quelle verfügen. Eine Liste der Tutorials zum Erstellen verschiedener Customer Success-Quellkonten in der Benutzeroberfläche finden Sie in der [Quellen - Übersicht](../../../home.md#customer-success).
...
Nach der Erstellung Ihres Customer Success-Quellkontos wird der Schritt **[!UICONTROL Daten hinzufügen]** angezeigt, der Ihnen eine Oberfläche bietet, um die Tabellenhierarchie Ihres Customer Success-Quellkontos zu untersuchen.
...
In diesem Tutorial haben Sie erfolgreich einen Datenfluss erstellt, um Daten aus Ihrer Customer-Success-Quelle in Platform zu übertragen. Eingehende Daten können jetzt von nachgelagerten [!DNL Platform]-Services verwendet werden, wie [!DNL Real-Time Customer Profile] und [!DNL Data Science Workspace]. Weiterführende Informationen finden Sie in folgenden Dokumenten:
