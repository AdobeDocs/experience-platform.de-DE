...
title: Konfigurieren eines Datenflusses für eine Customer Success Source-Verbindung in der Benutzeroberfläche
topic-legacy: overview
type: Tutorial
description: Ein Datenfluss ist eine geplante Aufgabe, die Daten aus einer Quelle abruft und in einen [!DNL Platform] Datensatz erfasst. In diesem Tutorial werden Schritte zum Konfigurieren eines neuen Datenflusses mit Ihrem Kundenerfolgskonto beschrieben.
...
Ein Datenfluss ist eine geplante Aufgabe, die Daten aus einer Quelle abruft und in einen [!DNL Platform] -Datensatz erfasst. In diesem Tutorial werden Schritte zum Konfigurieren eines neuen Datenflusses mit Ihrem Kundenerfolgskonto beschrieben.
...
Darüber hinaus setzt dieses Tutorial voraus, dass Sie bereits ein Kundenerfolgskonto erstellt haben. Eine Liste von Tutorials zum Erstellen verschiedener Customer Success Connectors in der Benutzeroberfläche finden Sie in der [Übersicht über Quell-Connectoren](../../../home.md).

## Daten auswählen

Nachdem Sie Ihren Customer Success Connector erstellt haben, wird der Schritt **[!UICONTROL Daten auswählen]** angezeigt und bietet eine interaktive Oberfläche, über die Sie Ihre Dateihierarchie untersuchen können.
...
- **[!UICONTROL Zuordnungsdetails]**: Zeigt, in welchen Datensatz die Quelldaten aufgenommen werden, einschließlich des Schemas, dem der Datensatz entspricht.
- **[!UICONTROL Planungsdetails]**: Zeigt den aktiven Zeitraum, die Häufigkeit und das Intervall des Aufnahmezeitplans an.
...
![Überprüfung](../../../images/tutorials/dataflow/customer-success/review.png)
...
In diesem Tutorial haben Sie erfolgreich einen Datenfluss erstellt, um Daten aus einer Kundenerfolgsquelle einzubringen und Einblicke in die Überwachung von Datensätzen zu erhalten. Eingehende Daten können jetzt von nachgelagerten [!DNL Platform]-Diensten wie [!DNL Real-time Customer Profile] und [!DNL Data Science Workspace] verwendet werden. Weitere Informationen finden Sie in den folgenden Dokumenten:
...
Wählen Sie im Bildschirm **[!UICONTROL Authentication]** den Namen des Kontos aus, das mit dem Datenfluss verknüpft ist, den Sie deaktivieren möchten.
