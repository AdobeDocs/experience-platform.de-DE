...
title: Erstellen eines Datenflusses mithilfe einer Datenbankquelle in der Benutzeroberfläche
type: Tutorial
...
>[!NOTE]
>
>Um einen Datenfluss zu erstellen, müssen Sie bereits über ein authentifiziertes Konto mit einer Datenbankquelle verfügen. Eine Liste der Tutorials zum Erstellen verschiedener Datenbankquellenkonten in der Benutzeroberfläche finden Sie im [Quellen - Übersicht](../../../home.md#database).
...
Nachdem Sie Ihr Datenbankquellenkonto erstellt haben, wird die **[!UICONTROL Daten hinzufügen]** angezeigt. Dieser Schritt bietet eine Oberfläche, über die Sie die Tabellenhierarchie Ihres Datenbankquellenkontos durchsuchen können.
