---
keywords: Experience Platform; Homepage; beliebte Themen; Datenbankanschluss
solution: Experience Platform
title: Erstellen eines Datenflusses mithilfe eines Datenbank-Source in der Benutzeroberfläche
type: Tutorial
description: Ein Datenfluss ist eine geplante Aufgabe, die Daten aus einer Quelle abruft und in einen Platform-Datensatz aufnimmt. In diesem Tutorial erfahren Sie, wie Sie mithilfe der Platform-Benutzeroberfläche einen Datenfluss für eine Datenbankquelle erstellen.
...
Ein Datenfluss ist eine geplante Aufgabe, die Daten aus einer Quelle abruft und in einen Datensatz in Adobe Experience Platform aufnimmt. In diesem Tutorial erfahren Sie, wie Sie mithilfe der Platform-Benutzeroberfläche einen Datenfluss für eine Datenbankquelle erstellen.

>[!NOTE]
>
>* Um einen Datenfluss zu erstellen, müssen Sie bereits über ein authentifiziertes Konto mit einer Datenbankquelle verfügen. Eine Liste der Tutorials zum Erstellen verschiedener Datenbankquellenkonten in der Benutzeroberfläche finden Sie in der [Quellenübersicht](../../../home.md#database).
>
...
Nachdem Sie Ihr Datenbankquellenkonto erstellt haben, wird der Schritt **[!UICONTROL Daten hinzufügen]** angezeigt, der Ihnen eine Oberfläche bietet, über die Sie die Tabellenhierarchie Ihres Datenbankquellenkontos durchsuchen können.
...
In diesem Tutorial haben Sie erfolgreich einen Datenfluss erstellt, um Daten aus Ihrer Datenbank-Quelle an Platform zu übertragen. Eingehende Daten können jetzt von nachgelagerten [!DNL Platform]-Services verwendet werden, wie [!DNL Real-Time Customer Profile] und [!DNL Data Science Workspace]. Weiterführende Informationen finden Sie in folgenden Dokumenten:
