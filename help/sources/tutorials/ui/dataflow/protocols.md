---
keywords: Experience Platform;Home;beliebte Themen;Protokollanschluss
...
Darüber hinaus erfordert dieses Lernprogramm, dass Sie bereits ein Protokollkonto erstellt haben. Eine Liste von Übungen zum Erstellen verschiedener Protokollschnittstellen in der Benutzeroberfläche finden Sie im [Übersicht über die Quellschnittstellen](../../../home.md).
...
Der Schritt **[!UICONTROL Datenfelddetails]** wird angezeigt, mit dem Sie einen Namen eingeben und eine kurze Beschreibung zu Ihrem neuen Datenpfad bereitstellen können.
