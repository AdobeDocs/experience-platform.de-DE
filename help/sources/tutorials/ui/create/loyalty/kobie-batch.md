---
title: Aufnehmen von Batch-Daten aus Kobie in Experience Platform über die Benutzeroberfläche
description: Erfahren Sie, wie Sie Batch-Daten von Kobie über die Benutzeroberfläche in Adobe Experience Platform aufnehmen.
badge: Beta
hide: true
hidefromtoc: true
...
# Aufnehmen von Batch-Daten aus [!DNL Kobie] in Experience Platform über die Benutzeroberfläche

Lesen Sie dieses Tutorial, um zu erfahren, wie Sie mithilfe des Arbeitsbereichs „Quellen“ in der Benutzeroberfläche Batch-Daten aus Ihrem [!DNL Kobie]-Konto in Adobe Experience Platform aufnehmen.
...
Um Daten aus [!DNL Kobie] aufzunehmen, wählen Sie die Karte **[!UICONTROL Kobie Batch Source Connector]** unter *[!UICONTROL Loyalty]* und dann **[!UICONTROL Add data]** aus.
...
Um ein neues Konto für Ihre [!DNL Kobie] zu erstellen, wählen Sie **[!UICONTROL New account]** aus und geben Sie einen Namen und eine optionale Beschreibung für Ihr Konto an. Geben Sie als Nächstes Ihre [!DNL Kobie] Domain und Ihre [!UICONTROL Kobie Management API Key] an. Wenn Sie fertig sind, wählen Sie **[!UICONTROL Connect to source]** aus und warten Sie einige Augenblicke, bis Ihre Verbindung hergestellt ist.



### Vorhandenes Konto verwenden

Um ein vorhandenes Konto zu verwenden, wählen Sie **[!UICONTROL Existing account]** aus und wählen Sie das [!DNL Kobie] Konto, das Sie verwenden möchten, über die Kontoschnittstelle aus.
