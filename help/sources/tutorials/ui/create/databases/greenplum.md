...
topic: overview
type: Tutorial
description: In diesem Lernprogramm werden Schritte zum Erstellen eines GreenPlum-Quell-Connectors mithilfe der Plattform-Benutzeroberfläche beschrieben.
...
Mit diesem Tutorial haben Sie eine Verbindung zu Ihrem [!DNL GreenPlum] Konto hergestellt. Sie können jetzt mit dem nächsten Lernprogramm fortfahren und einen Datendurchlauf [konfigurieren, um Daten in dieses Lernprogramm [!DNL Platform]](../../dataflow/databases.md)einzubringen.