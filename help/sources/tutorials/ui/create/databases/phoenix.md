...
Source Connectors in Adobe Experience Platform bieten die Möglichkeit, Daten aus externen Quellen planmäßig zu erfassen. In diesem Lernprogramm werden Schritte zum Erstellen eines Phoenix-Quell-Connectors mithilfe der Plattform-Benutzeroberfläche beschrieben.
...
Um auf Ihr Phoenix-Konto auf der Plattform zugreifen zu können, müssen Sie die folgenden Werte angeben:
...
Nachdem Sie die erforderlichen Anmeldeinformationen gesammelt haben, können Sie die folgenden Schritte ausführen, um ein neues Phoenix-Konto für die Verbindung mit der Plattform zu erstellen.
...
Mit diesem Tutorial haben Sie eine Verbindung zu Ihrem Phoenix-Konto hergestellt. Sie können jetzt mit dem nächsten Lernprogramm fortfahren und einen Datendurchlauf [konfigurieren, um Daten in Plattform](../../dataflow/databases.md)zu übertragen.