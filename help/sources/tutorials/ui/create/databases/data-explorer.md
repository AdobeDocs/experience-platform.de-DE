...
topic: overview
type: Tutorial
description: In diesem Lernprogramm werden Schritte zum Erstellen eines Azurblauen Data Explorers (im Folgenden "Data Explorer")-Quellconnectors mithilfe der Plattform-Benutzeroberfläche beschrieben.
...
Mit diesem Tutorial haben Sie eine Verbindung zu Ihrem [!DNL Data Explorer] Konto hergestellt. Sie können jetzt mit dem nächsten Lernprogramm fortfahren und einen Datendurchlauf [konfigurieren, um Daten in dieses Lernprogramm [!DNL Platform]](../../dataflow/databases.md)einzubringen.