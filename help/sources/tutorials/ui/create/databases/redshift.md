---
title: Erstellen einer Amazon Redshift Source-Verbindung in der Benutzeroberfläche
...
# Verbinden Sie Ihr [!DNL Amazon Redshift]-Konto über den Arbeitsbereich &quot;Quellen&quot;.
...
In diesem Tutorial erfahren Sie, wie Sie Ihr [!DNL Amazon Redshift] -Konto (nachfolgend als &quot;[!DNL Redshift]&quot; bezeichnet) über die Benutzeroberfläche mit Adobe Experience Platform verbinden.
...
Um auf Ihr [!DNL Redshift] -Konto auf dem Experience Platform zuzugreifen, müssen Sie die folgenden Werte angeben:

| **Credential** | **Beschreibung** |
| -------------- | --------------- |
| Server | Der mit Ihrem [!DNL Redshift]-Konto verknüpfte Server. |
| Port | Der TCP-Port, den ein [!DNL Redshift] -Server verwendet, um auf Clientverbindungen zu warten. |
| Benutzername | Der Benutzername, der Ihrem [!DNL Redshift] -Konto zugeordnet ist. |
| Kennwort | Das Ihrem [!DNL Redshift]-Konto zugeordnete Kennwort. |
| Datenbank | Die [!DNL Redshift]-Datenbank, auf die Sie zugreifen. |

Weitere Informationen zu den ersten Schritten finden Sie in [diesem [!DNL Redshift] Dokument](https://docs.aws.amazon.com/redshift/latest/gsg/getting-started.html).

Nachdem Sie die erforderlichen Anmeldedaten gesammelt haben, können Sie die folgenden Schritte ausführen, um Ihr [!DNL Redshift]-Konto mit Experience Platform zu verknüpfen.
...
Die Seite **[!UICONTROL Verbindung zu Amazon Redshift herstellen]** wird angezeigt. Auf dieser Seite können Sie entweder neue oder vorhandene Anmeldedaten verwenden.
...
Mithilfe dieses Tutorials haben Sie eine Verbindung zu Ihrem [!DNL Redshift]-Konto hergestellt. Sie können jetzt mit dem nächsten Tutorial fortfahren und einen Datenfluss [konfigurieren, um Daten in Experience Platform](../../dataflow/databases.md) zu importieren.
