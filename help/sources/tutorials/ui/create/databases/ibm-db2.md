...
Die folgenden Abschnitte enthalten zusätzliche Informationen, die Sie benötigen, um eine erfolgreiche Verbindung mit DB2 mithilfe der [!DNL Flow Service] API herzustellen.
