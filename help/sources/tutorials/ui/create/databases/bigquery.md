...
Quellschnittstellen in Adobe Experience Platform bieten die Möglichkeit, extern beschaffte Daten planmäßig zu erfassen. In diesem Lernprogramm werden Schritte zum Erstellen eines Google Big-Abfragen-Quellconnectors (im Folgenden &quot;GBQ&quot;) mithilfe der Platform-Benutzeroberfläche beschrieben.
...
Um auf Ihr GBQ-Konto bei Platform zugreifen zu können, müssen Sie die folgenden Werte angeben:
...
Nachdem Sie die erforderlichen Anmeldeinformationen gesammelt haben, können Sie die folgenden Schritte ausführen, um eine neue eingehende Basisverbindung zu erstellen, um Ihr GBQ-Konto mit der Platform zu verknüpfen.
