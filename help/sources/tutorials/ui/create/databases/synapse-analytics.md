...
# Erstellen eines [!DNL Azure Synapse Analytics] Quellconnectors in der Benutzeroberfläche
...
Mit diesem Tutorial haben Sie eine Basisverbindung zu Ihrem [!DNL Synapse] Konto aufgebaut. Sie können jetzt mit dem nächsten Lernprogramm fortfahren und einen Datendurchlauf [konfigurieren, um Daten in die Platform](../../dataflow/databases.md)zu bringen.