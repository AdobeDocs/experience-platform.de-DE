...
Um [!DNL PostgreSQL] zu verwenden, wählen Sie die Quellkarte **[!UICONTROL PostgreSQL DB]** unter *[!UICONTROL Datenbanken]* und dann **[!UICONTROL Einrichten]**.
...
![Der Quellkatalog mit der ausgewählten PostgreSQL-Quellkarte.](../../../../images/tutorials/create/postgresql/catalog.png)
...
![Die vorhandene Kontoschnittstelle des Quell-Workflows.](../../../../images/tutorials/create/postgresql/existing.png)
...
![Die neue Kontoschnittstelle im Quell-Workflow mit einem Kontonamen und einer optionalen Beschreibung.](../../../../images/tutorials/create/postgresql/new.png)
