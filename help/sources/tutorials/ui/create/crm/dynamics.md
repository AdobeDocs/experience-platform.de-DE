...
Wenn Sie neue Anmeldeinformationen verwenden, wählen Sie **[!UICONTROL Neues Konto]**. Geben Sie im angezeigten Formular einen Namen und eine optionale Beschreibung für Ihre neue [!DNL Dynamics] -Konto.
