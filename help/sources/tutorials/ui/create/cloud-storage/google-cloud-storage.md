...
Um auf Ihre [!DNL Google Cloud Storage] Daten in Experience Platform zugreifen zu können, müssen Sie die folgenden Werte angeben:

| Anmeldedaten | Beschreibung |
| ---------- | ----------- |
| Zugriffsschlüssel-ID | Eine 61-stellige alphanumerische Zeichenfolge, die zur Authentifizierung Ihres [!DNL Google Cloud Storage]-Kontos bei Experience Platform verwendet wird. |
| Geheimer Zugriffsschlüssel | Eine mit Base-64 verschlüsselte Zeichenfolge mit 40 Zeichen, die zum Authentifizieren Ihres [!DNL Google Cloud Storage] bei Experience Platform verwendet wird. |
...
Nachdem Sie die erforderlichen Anmeldeinformationen zusammen haben, können Sie die folgenden Schritte ausführen, um Ihr [!DNL Google Cloud Storage]-Konto mit Experience Platform zu verknüpfen.
...
![Der Bildschirm der Experience Platform-Benutzeroberfläche mit der Seite „Quellkatalog“.](../../../../images/tutorials/create/google-cloud-storage/catalog.png)
...
![Der Bildschirm der Experience Platform-Benutzeroberfläche mit der bestehenden Kontoseite für eine Google Cloud-Speicherquelle](../../../../images/tutorials/create/google-cloud-storage/existing.png)
...
![Der Bildschirm der Experience Platform-Benutzeroberfläche mit der neuen Kontoseite für eine Google Cloud-Speicherquelle.](../../../../images/tutorials/create/google-cloud-storage/new.png)


## Nächste Schritte

Mithilfe dieses Tutorials haben Sie eine Verbindung zu Ihrem [!DNL Google Cloud Storage]-Konto hergestellt. Sie können jetzt mit dem nächsten Tutorial fortfahren und [einen Datenfluss konfigurieren, um Daten aus Ihrem Cloud-Speicher in Experience Platform zu übertragen](../../dataflow/batch/cloud-storage.md).
