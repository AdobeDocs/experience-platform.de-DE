...
Wählen Sie **[!UICONTROL Report suite]** aus und verwenden Sie dann die *[!UICONTROL Analytics source add data]*, um durch die Liste zu navigieren und die Analytics-Report Suite zu identifizieren, die Sie in Experience Platform aufnehmen möchten. Alternativ können Sie nach einer bestimmten Report Suite suchen. Wählen Sie **[!UICONTROL Next]** aus, um fortzufahren.
...
>title="Herunterladen einer Vorlage"
>abstract="Laden Sie die CSV-Vorlage herunter, um die Zuordnung offline durchzuführen."
>additional-url="https://experienceleague.adobe.com/de/docs/experience-platform/data-prep/ui/mapping#import-mapping" text="Zuordnung importieren"
