...
Quellschnittstellen in Adobe Experience Platform bieten die Möglichkeit, extern beschaffte Daten planmäßig zu erfassen. In diesem Lernprogramm werden die Schritte zum Erstellen eines ServiceNow-Quell-Connectors mithilfe der Benutzeroberfläche &quot;Platform&quot;beschrieben.
...
Um auf Ihr ServiceNow-Konto bei Platform zugreifen zu können, müssen Sie die folgenden Werte angeben:
...
Nachdem Sie die erforderlichen Anmeldeinformationen gesammelt haben, führen Sie die folgenden Schritte aus, um ein neues ServiceNow-Konto für die Verbindung mit der Platform zu erstellen.
...
Mit diesem Tutorial haben Sie eine Verbindung zu Ihrem ServiceNow-Konto hergestellt. Sie können jetzt mit dem nächsten Lernprogramm fortfahren und einen Datendurchlauf [konfigurieren, um Daten in die Platform](../../dataflow/customer-success.md)zu bringen.
