...
Mit diesem Tutorial haben Sie eine Verbindung zu Ihrem [!DNL ServiceNow] Konto hergestellt. Sie können jetzt mit dem nächsten Lernprogramm fortfahren und einen Datendurchlauf [konfigurieren, um Daten in dieses Lernprogramm [!DNL Platform]](../../dataflow/customer-success.md)einzubringen.
