...
Weitere Anleitungen zu Ihrem für die [!DNL Zendesk] erforderlichen [!DNL Zendesk Search API] finden Sie im Abschnitt [Beschränkungen](#limits) unten.
...
Wählen Sie unter der *Customer Success* die Option **[!UICONTROL Zendesk]** und dann **[!UICONTROL Add data]** aus.

![Katalog](../../../../images/tutorials/create/zendesk/catalog.png)

Die Seite **[!UICONTROL Connect Zendesk account]** wird angezeigt. Auf dieser Seite können Sie entweder neue oder vorhandene Anmeldedaten verwenden.

### Vorhandenes Konto

Um ein vorhandenes Konto zu verwenden, wählen Sie das *Zendesk*-Konto, mit dem Sie einen neuen Datenfluss erstellen möchten, und klicken Sie dann auf **[!UICONTROL Next]** , um fortzufahren.
...
Nachdem Ihre Quelle authentifiziert wurde, wird die Seite in eine interaktive Schemastruktur aktualisiert, in der Sie die Hierarchie Ihrer Daten untersuchen und überprüfen können. Wählen Sie **[!UICONTROL Next]** aus, um fortzufahren.
...
Wählen Sie in der Benutzeroberfläche von Experience Platform in der linken Navigationsleiste die Option **[!UICONTROL Datasets]** , um auf den [!UICONTROL Datasets]-Arbeitsbereich zuzugreifen. Der [!UICONTROL Dataset Activity] zeigt die Details der Ausführungen an.
