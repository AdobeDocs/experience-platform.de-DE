...
Auf der Seite &quot; **[!UICONTROL Konten]** &quot;können Sie eine Liste der vorhandenen Datenflüsse oder Zielgruppen-Datensätze, die mit dem Konto verknüpft sind, auf das Sie zugegriffen haben, Ansicht haben. Wählen Sie das sekundäre Steuerelement aus, um weitere Optionen für den ausgewählten Datenfluss aufzurufen. Die folgenden Optionen werden weiter beschrieben:
...
Das Sortierfeld wird angezeigt. Wählen Sie im Bildlaufmenü die Quelle aus, auf die Sie zugreifen möchten, und wählen Sie dann in der Liste auf der rechten Seite den Datendurchlauf aus. Sie können auch das sekundäre Steuerelement auswählen, um weitere Optionen für den ausgewählten Datendurchlauf anzuzeigen.
