...
>[!NOTE]
>
>Source-Aufnahme-Datenflüsse, die 30 Tage lang kontinuierlich fehlschlagen, werden automatisch deaktiviert. Verwenden Sie [Monitoring-Dashboard](/help/dataflows/ui/monitor-sources.md), um Ihren Datenfluss zu überprüfen, zu ermitteln, warum er fehlgeschlagen ist (z. B. Anmeldedaten, Berechtigungen oder Schema- oder Zuordnungsänderungen), die erforderlichen Aktualisierungen anzuwenden und den Datenfluss nach der Auflösung erneut zu aktivieren.
...
Die folgenden Quellen sind nur für [Adobe Real-Time Customer Data Platform Ultimate](https://helpx.adobe.com/de/legal/product-descriptions/real-time-customer-data-platform-b2c-edition-prime-and-ultimate-packages.html) oder Kunden verfügbar, die die eigenständige Advanced Enterprise Source Connectors SKU lizenziert haben.
