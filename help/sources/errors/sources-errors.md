...
| `1014-400` | Ungültige Anfrage – unzulässiges Argument | Die Anfrage konnte nicht verarbeitet werden. {detailedMessage} |

## Framework-Fehler

| Fehler-Code | Titel | Detaillierte Nachricht |
| --- | --- | --- |
| `1100-400` | Ungültige Anfrage | Die Anfrage konnte nicht verarbeitet werden. {detailedMessage} |
...
| `1102-404` | Ressource nicht gefunden | Die angefragte Ressource wurde nicht gefunden. {detailedMessage} |
...
| `1202-400` | Ungültige Anfrage | Die publicKeyId fehlt in den Transformationen {transformations} Flusses. Bitte die publicKeyId in der Anfrage angeben und erneut versuchen. |
| `1203-400` | Ungültige Anfrage | Der Verschlüsselungsschlüssel existiert nicht für keyID={keyID} in den Transformationen {transformations} Flusses. Bitte die angegebene keyID überprüfen und erneut versuchen. |
...
| Fehler-Code | Titel | Detaillierte Nachricht |
| --- | --- | --- |
| `1300-400` | Ungültige Anfrage | Die Patch-Verbindungsanforderung wird für {connectorType} Connector nicht unterstützt. Bitte die angegebene Anfrage überprüfen und erneut versuchen. |
...
| `1302-400` | Ungültige Anfrage | Der angegebene Authentifizierungstyp {authType} wird für Connector {connectorType} nicht unterstützt. Bitte einen gültigen Authentifizierungstyp für den angegebenen Connector angeben. |
...
| `1304-400` | Ungültige Anfrage | Das erforderliche Feld {field} ist nicht angegeben. Bitte das {field} angeben und erneut versuchen. |
...
| `1309-400` | Ungültige Anfrage | Die bereitgestellte Verschlüsselungstransformation ist ungültig, da {requiredParam} in den Parametern fehlt. Bitte {requiredParam} angeben und erneut versuchen. |
...
| `1315-400` | Ungültige Anfrage | Der angegebene {path} muss auf ein Array von Datensätzen verweisen. Bitte sicherstellen, dass der angegebene Pfad auf das Array von Einträgen verweist, und erneut versuchen. |
...
| `1319-400` | Ungültige Anfrage | Die {param} sollte Teil der übergeordneten Sammlung sein. Bitte {param} in der übergeordneten Sammlung angeben und erneut versuchen. |
| `1320-400` | Ungültige Anfrage | {idType} darf weder null noch leer sein. Bitte einen gültigen {idType} angeben und erneut versuchen. |
| `1321-400` | Ungültige Anfrage | Die Länge des {idType} sollte 1 sein, die angegebene Größe ist {size}. Bitte eine gültige Größe angeben und erneut versuchen. |
...
| `1323-400` | Ungültige Anfrage | Der {entity} darf in der Quellverbindung nicht null oder leer sein: {sourceConnection}. Bitte einen gültigen {entity} angeben und erneut versuchen. |
...
| `1329-400` | Ungültige Anfrage | Der Parameter: {param} darf in der angegebenen Anfrage nicht null oder leer sein. Bitte einen gültigen {param} angeben und erneut versuchen. |
| `1330-400` | Ungültige Anfrage | Für Tabelle {tableName} wurden keine Spalten gefunden. Bitte einen gültigen Tabellennamen angeben und erneut versuchen. |
...
| `1333-400` | Fehlerhafte Anfrage | flowRunAction={flowRunAction} wird für eine Quelle mit Spezifikations-ID {specId} nicht unterstützt. Bitte eine gültige Flussausführungsaktion angeben und erneut versuchen. |
| `1334-400` | Ungültige Anfrage | Der Abfrageparameter {param} darf nicht leer sein. Bitte einen gültigen {param} angeben und erneut versuchen. |
...
| `1337-400` | Ungültige Anfrage | Der {QueryParam} darf für objectType={objectType} nicht leer sein. Bitte einen gültigen {QueryParam} angeben und erneut versuchen. |
| `1338-400` | Ungültige Anfrage | Die {connectionType}-Verbindungs-ID darf in flowRequest nicht null sein. Bitte in flowRequest eine gültige {connectionType}-Verbindungs-ID angeben. |
...
| `1340-400` | Ungültige Anfrage | Fehler beim Analysieren von {time}. Bitte das in der Anfrage angegebene Zeitformat überprüfen und erneut versuchen. |
...
| `1343-400` | Ungültige Anfrage | In den Segmenten :entityReferencesdls&#39; und :partitionSpecdls&#39; in odi.json&#39; fehlen Definitionen. Bitte die entsprechenden Definitionen in „odi.json“ eingeben und erneut versuchen. |
...
| `1346-400` | Ungültige Anfrage | Die in „dls“ in „odi.json:fileFormat angegebene Definition für &quot;@type“ ist ungültig. Bitte die entsprechenden Definitionen in „odi.json“ eingeben und erneut versuchen. |
| `1347-400` | Ungültige Anfrage | Die dls:csvDelimiters-Definition in „odi.json“ wird nicht unterstützt. Die unterstützten csvDelimiters sind: [, ]. Bitte die entsprechenden Definitionen in „odi.json“ eingeben und erneut versuchen. |
| `1348-400` | Ungültige Anfrage | Beim Deserialisieren von „dls“ ist :entityReferences Fehler aufgetreten. Bitte überprüfen, ob die Daten ein gültiges Format aufweisen, und erneut versuchen. |
...
| `1353-400` | Ungültige Anfrage | Der Filter an der Quelle wird für {connectorType} Connector noch nicht unterstützt. Bitte die unterstützten Connectoren in der Dokumentation: https://experienceleague.adobe.com/docs/experience-platform/sources/api-tutorials/filter.html?lang=de überprüfen. |
...
| `1359-400` | Ungültige Anfrage | Der Parameter {param} fehlt in der Anfrage. Bitte einen gültigen {param} angeben und erneut versuchen. |
...
| `1365-400` | Ungültige Anfrage | Der in Ops angegebene Pfad {path} ungültig. Bitte einen gültigen {path} angeben und erneut versuchen. |
...
| `1371-400` | Ungültige Anfrage | Die Erkennung von Dateieigenschaften wird für {connectorType} Connector nicht unterstützt. Bitte die Dateieigenschaften manuell angeben. |
...
| `1377-400` | Ungültige Anfrage | Der angegebene Wertparameter ist null und kann nicht mit dem {operator} verglichen werden. Bitte einen gültigen Wertparameter angeben und erneut versuchen. |
| `1378-400` | Ungültige Anfrage | Bei der Validierung der {column} der Eingabespalte für den Filter an der Quelle ist ein Fehler aufgetreten. Der Spaltenname muss eine gültige Spalte in der Tabelle sein. Bitte einen gültigen Spaltennamen angeben und erneut versuchen. |
| `1379-400` | Ungültige Anfrage | Bei der Validierung des {value} für den Filter an der Quelle ist ein Fehler aufgetreten. Der Spalten-DataType an der Quelle lautet {columnDataType}, und der DataType [Zeichenfolge] des Werts stimmt nicht damit überein. Bitte einen gültigen {value} angeben und erneut versuchen. |
| `1380-400` | Ungültige Anfrage | Workflow-Ausführung konnte nicht erstellt werden. Fehlermeldung: {message} |
| `1381-400` | Ungültige Anfrage | WindowEndTime={endTime} darf nicht vor WindowStartTime={startTime} liegen. Bitte eine gültige Endzeit angeben und erneut versuchen. |
...
| `1385-400` | Ungültige Anfrage | Der bereitgestellte Wert für connectorType={connectorType} wird für das Erstellen von Flussausführungen nicht unterstützt. Bitte einen gültigen Wert für connectorType angeben und erneut versuchen. |
...
| `1387-400` | Ungültige Anfrage | Die flowRunId={flowRunId} befindet sich für das erneute Auslösen in einem ungültigen Status {state}. Bitte nach einiger Zeit erneut versuchen und den Support kontaktieren, falls das Problem weiterhin besteht. |
...
| `1391-400` | Ungültige Anfrage | SchemaMetaData in sourceConnection konnte für ID={sourceConnectionId} nicht analysiert werden. Bitte die schemaMetaData in der Anfrage überprüfen und erneut versuchen. |
| `1392-400` | Ungültige Anfrage | Fehler beim Analysieren von Transformationen in der Flussanfrage für flowId={flowId}. Bitte die Transformationen in Ihrer Anfrage überprüfen und erneut versuchen. |
| `1393-400` | Ungültige Anfrage | Der angegebene {parameter} ist null oder leer. Bitte einen gültigen {parameter} angeben und erneut versuchen. |
| `1394-400` | Ungültige Anfrage | Der Mindestwert für einen {parameter} ist eins. Bitte einen gültigen {parameter} angeben und erneut versuchen. |
...
| Fehler-Code | Titel | Detaillierte Nachricht |
| --- | --- | --- |
| `1600-400` | Ungültige Anfrage | Die Anfrage konnte nicht verarbeitet werden. {detailedMessage} |
...
| `1602-404` | Ressource nicht gefunden | Die angefragte Ressource wurde nicht gefunden. {detailedMessage} |
...
| `1605-401` | Nicht autorisiert | Der Benutzer ist nicht autorisiert. {detailedMessage} |
| `1606-403` | Verboten | Der angeforderte Vorgang ist verboten. {detailedMessage} |
| `1607-412` | Vorbedingung fehlgeschlagen | Die durch die Kopfzeilen If-Unmodified-Since oder If-None-Match definierte Bedingung ist nicht erfüllt. {detailedMessage} |
...
| `1706-400` | Ungültige Anfrage | Die Konfiguration der zulässigen Aktivierungen ist für Landing Zone {landingZoneType} nicht korrekt konfiguriert. Bitte erneut versuchen und den Support kontaktieren, wenn das Problem weiterhin besteht. |
...
| `1708-400` | Ungültige Anfrage | Die Container-Konfiguration darf in landingZoneType={landingZoneType} nicht null sein. Bitte sicherstellen, dass die Container-Konfiguration nicht null ist, und erneut versuchen. |
| `1709-400` | Ungültige Anfrage | Die SAS-Details dürfen für {tokenConfig} in Landing Zone-Typ {landingZoneType} nicht null sein. Bitte in der Konfiguration ein gültiges SAS angeben und erneut versuchen. |
...
| `1711-400` | Ungültige Anfrage | Die SAS-Details wurden für die angegebene Data Landing Zone vom Typ &quot;{landingZoneUseCase}&quot; nicht gefunden. Bitte überprüfen, ob SAS-Details für den angegebenen Landing Zone-Typ angegeben wurden. |
...
| `1713-400` | Ungültige Anfrage | Der {OperationType} ist für die angegebene {tokenType} nicht zulässig. Bitte die Anfrage überprüfen und erneut versuchen. |
| `1714-400` | Ungültige Anfrage | Die ClientId={clientId} darf diesen Vorgang nicht ausführen. Bitte die Anfrage mit Berechtigungen überprüfen und erneut versuchen. |
