...
topic: tutorial
description: 'Dieses Dokument enthält eine Anleitung zum Arbeiten mit den Geschäftsentitäten von Decisioning Service mithilfe von Adobe Experience Platform-APIs. '
