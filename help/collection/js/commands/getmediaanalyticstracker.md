...
| Methodenname | Beschreibung | Syntax |
|---|---|---|
...
## Abrufen von Media Analytics Tracker mithilfe der Tag-Erweiterung „Web SDK&quot;

Die Web SDK-Tag-Erweiterung, die diesem Befehl entspricht, ist die [**[!UICONTROL Get Media Analytics tracker]**](/help/tags/extensions/client/web-sdk/actions/get-media-analytics-tracker.md).
