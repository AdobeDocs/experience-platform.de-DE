...
| `"The user has not given permission to send push notifications."` | Benutzer hat keine Benachrichtigungsberechtigung erteilt (`Notification.permission === "granted"`) |
...
Die Web SDK-Tag-Erweiterung, die diesem Feld entspricht, verwendet die [[!UICONTROL Send Push Subscription]](/help/tags/extensions/client/web-sdk/actions/send-push-subscription.md) Aktion innerhalb einer Tag-Regel.
