...
- [Datenstrom-Überschreibungen](/help/datastreams/overrides.md) werden jetzt beim Starten von Mediensitzungen unterstützt.
...
- Fehlerkorrektur - Beim Rendern von Standardinhaltelementen über [`applyPropositions`](commands/applypropositions.md) tritt jetzt kein Fehler mehr auf.
- Ein CSS-Fehler in Aktionen zum Verschieben und Ändern der Größe von Adobe Target wurde behoben.
- Der `machineLearning` Schlüssel wurde aus [`sendEvent`](commands/sendevent/overview.md) Antworten entfernt.
...
- Es wurde Unterstützung für [Streaming Media Collection](commands/configure/streamingmedia.md) hinzugefügt.
...
- Unterstützung für [Überschreibungen der Datenstrom-ID pro Befehl](/help/datastreams/overrides.md) hinzugefügt.
...
- Unterstützung für [`onBeforeLinkClickSend`](commands/configure/onbeforelinkclicksend.md) Link-Klick-Rückruf hinzugefügt.
...
- Es wurde ein Problem behoben, bei dem Eigenschaften von [Client-Hinweisen für Benutzeragenten- und -agentinnen](../use-cases/client-hints.md) auf einen falschen Typ eingestellt werden konnten.
...
- Unterstützung für seitenweise vollständige Migration hinzugefügt. Das Adobe Target-Profil wird jetzt beibehalten, wenn Besuchende zwischen at.js- und Web SDK-Seiten wechseln.
- Es wurde konfigurierbare Unterstützung für [hohe Entropie bei Client-Hinweisen für Benutzeragenten](../use-cases/client-hints.md) hinzugefügt.
- Es wurde Unterstützung für den [`applyResponse`](commands/applyresponse.md)-Befehl hinzugefügt. Dies ermöglicht die hybride Personalisierung über die [Edge Network-API](https://developer.adobe.com/data-collection-apis/docs/api/).
...
- Der Befehl [`getIdentity`](commands/getidentity.md) gibt jetzt die ID der Edge-Region zusammen mit der Identität zurück.
