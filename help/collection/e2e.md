...
Wählen Sie in der Benutzeroberfläche **[!UICONTROL Schemas]** im linken Navigationsbereich aus. Von hier aus können Sie eine Liste der zuvor erstellten Schemata sehen, die zu Ihrer Organisation gehören. Um fortzufahren, wählen Sie **[!UICONTROL Schema erstellen]** und dann **[!UICONTROL XDM ExperienceEvent]** aus dem Dropdown-Menü.
...
Wählen **[!UICONTROL Datenströme]** im linken Navigationsbereich aus. Von hier aus können Sie einen vorhandenen Datenstrom aus der Liste auswählen, um ihn zu bearbeiten, oder Sie können eine neue Konfiguration erstellen, indem Sie **[!UICONTROL Neuer Datenstrom]** auswählen.
