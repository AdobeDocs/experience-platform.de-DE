...
description: Sie können bestimmte Ressourcen in der Schema Registry-API nachschlagen, indem Sie eine GET anfordern, die die $id (URL-kodierter URI) der Ressource im Anforderungspfad enthält.
