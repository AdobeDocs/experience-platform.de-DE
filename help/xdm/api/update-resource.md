...
description: 'Sie können Ressourcen im Mandanten-Container mit einer PATCH-Anfrage ändern oder aktualisieren. Die Schema Registry unterstützt alle standardmäßigen JSON-Patch-Vorgänge, einschließlich Hinzufügen, Entfernen und Ersetzen. '
