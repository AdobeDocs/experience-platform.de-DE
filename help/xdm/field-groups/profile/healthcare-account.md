...
![Feldgruppenstruktur](../../images/field-groups/healthcare-account/account.png)
...
| [!UICONTROL Rechnungsstatus] | `billingStatus` | [[!UICONTROL Codeable Concept]](../../data-types/healthcare/codeable-concept.md) | Dadurch wird der Lebenszyklus des Kontos während des Abrechnungsprozesses verfolgt. Er gibt an, wie Transaktionen behandelt werden, wenn sie dem Konto zugeordnet werden. |
...
| [!UICONTROL Währung] | `currency` | [[!UICONTROL Codeable Concept]](../../data-types/healthcare/codeable-concept.md) | Die Standardwährung für das Konto. |
...
| [!UICONTROL ID] | `identifier` | Array von [[!UICONTROL Bezeichner]](../../data-types/healthcare/identifier.md) | Eine eindeutige Kennung, mit der auf das Konto verwiesen wird. Sie kann für den menschlichen Gebrauch bestimmt sein (z. B. Kreditkartennummer). |
| [!UICONTROL Inhaber] | `owner` | [[!UICONTROL Referenz]](../../data-types/healthcare/reference.md) | Gibt die Servicebranche, das Krankenhaus, die Abteilung usw. an. mit Verantwortung für die Kontoverwaltung. |
...
| [!UICONTROL Dienstzeitraum] | `servicePeriod` | [[!UICONTROL Zeitraum]](../../data-types/healthcare/period.md) | Der Datumsbereich der mit diesem Konto verknüpften Dienste. |
...
![Deckungsstruktur](../../images/field-groups/healthcare-account/coverage.png)
