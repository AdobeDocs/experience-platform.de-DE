...
| `b2b.blockedCause` | Zeichenfolge | Wenn die Person gesperrt ist, gibt diese Eigenschaft den Grund dafür an. |
...
| `b2b.marketingSuspendedCause` | Zeichenfolge | Wenn das Marketing für die Person ausgesetzt wird, gibt diese Eigenschaft den Grund dafür an. |
...
| `b2b.personType` | Zeichenfolge | Der Typ der B2B-Person. |
