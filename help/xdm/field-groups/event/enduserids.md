...
# Schemafeldgruppe [!UICONTROL End User ID Details]

>[!NOTE]
>
>Die Namen mehrerer Schemafeldgruppen wurden geändert. Weitere Informationen finden Sie im Dokument zu den [Namensaktualisierungen für Feldgruppen](../name-updates.md).

[!UICONTROL End User ID Details] ist eine Standardschemafeldgruppe für die [[!DNL XDM ExperienceEvent] class](../../classes/experienceevent.md), mit der die Identitätsinformationen einer Person in mehreren Adobe-Programmen beschrieben werden. Die Feldergruppe stellt ein `endUserIDs`-Objekt auf der Stammebene bereit, das selbst ein schreibgeschütztes `_experience` enthält, dessen Werte bei der Datenaufnahme automatisch aktualisiert werden.
...
| `adcloud` | [Identität](../../data-types/identity.md) | Endbenutzer-IDs für Adobe Advertising. |
