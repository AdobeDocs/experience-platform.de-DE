...
title: Commerce-Detailschema-Feldgruppe
...
[!UICONTROL Commerce Details] ist eine Standardschemafeldgruppe für die [[!DNL XDM ExperienceEvent] Klasse](../../classes/experienceevent.md), die zur Beschreibung von Commerce-Daten wie Produktinformationen (SKU, Name, Menge) und Standardvorgängen zum Warenkorb (Bestellung, Checkout, Abbruch) verwendet wird.
