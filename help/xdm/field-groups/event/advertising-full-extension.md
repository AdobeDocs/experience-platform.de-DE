...
| `trackingIdentities` | Zeichenfolge | Die EF-ID oder Tracking-Identitätsdetails für ein Ereignis. Eine Liste der möglichen Formate finden Sie unter [EF ID Formats](https://experienceleague.adobe.com/de/docs/advertising/integrations/customer-journey-analytics/ids#ef-id-formats). |
