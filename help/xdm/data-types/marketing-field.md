...
# Datentyp [!UICONTROL Generisches Marketing-Präferenzfeld]

[!UICONTROL Generisches Feld für Marketing-Voreinstellungen] ist ein standardmäßiger XDM-Datentyp, der die Auswahl eines Kunden für eine bestimmte Marketing-Voreinstellung beschreibt.
...
>
>Wenn Sie eine `subscriptions` -Zuordnung für ein bestimmtes Feld mit Marketing-Voreinstellungen benötigen, müssen Sie stattdessen das [Marketing-Feld mit dem Abonnementdatentyp](./marketing-field-subscriptions.md) verwenden.
