...
# Datentyp [!UICONTROL Interne Site-Suche]
...
| --- | --- | --- |
| `autoCompleteClicked` | [!UICONTROL Boolean] | Gibt an, ob ein Besucher einen vorgeschlagenen oder automatisch ausgefüllten Suchwert zur Ausführung der Suche verwendet hat. |
...
| `nullInstances` | [!UICONTROL Integer] | Die Häufigkeit, mit der die interne Site-Suche durchgeführt wurde und Nullergebnisse angezeigt wurden. |
...
| `radiusDistance` | [!UICONTROL Integer] | In Kombination mit `radiusType` gibt den ausgewählten Abstand des Suchradius an. |
| `radiusType` | [!UICONTROL Integer] | Der ausgewählte Entfernungstyp von `radiusDistance`, entweder Meilen oder Kilometer. |
| `refinementInstances` | [!UICONTROL Integer] | Die Häufigkeit, mit der die interne Site-Suche optimiert wurde. |
...
| `sortOrder` | [!UICONTROL String] | In Kombination mit `sortType` gibt die Sortierreihenfolge der Suchergebnisse an (aufsteigend oder absteigend). |
| `term` | [!UICONTROL String] | Der vom Besucher eingegebene interne Site-Suchbegriff. |

{style="table-layout:auto"}

Weitere Informationen zum Datentyp finden Sie im [öffentlichen XDM-Repository](https://github.com/adobe/xdm/blob/master/docs/reference/datatypes/internal-site-search.schema.json).
