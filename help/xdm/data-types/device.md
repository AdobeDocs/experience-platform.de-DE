...
| `typeIDService` | Zeichenfolge | Der Namespace des Dienstes, der zur Identifizierung des Gerätetyps verwendet wird. Siehe [Anhang](#typeIDService) für Details zu akzeptierten Werten. |
