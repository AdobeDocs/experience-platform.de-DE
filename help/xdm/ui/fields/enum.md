...
**[!UICONTROL Enums]** beschränken die Werte, die für ein Zeichenfolgenfeld aufgenommen werden können, auf einen vordefinierten Satz. Wenn Sie versuchen, Daten in ein Aufzählungsfeld aufzunehmen, und der Wert mit keinem der in der Konfiguration definierten übereinstimmt, wird die Aufnahme verweigert.
...
In diesem Dokument wird beschrieben, wie Sie Aufzählungen und empfohlene Werte im Arbeitsbereich der [!UICONTROL Schemas]-Benutzeroberfläche definieren. Sehen Sie sich das folgende Video an, um einen schnellen Überblick über Auflistungen und empfohlene Werte zu erhalten, einschließlich ihrer Konfiguration in der Benutzeroberfläche und ihrer Auswirkungen auf nachgelagerte Bereiche:

>[!VIDEO](https://video.tv.adobe.com/v/3409501/?quality=12&learn=on)

## Aufzählung definieren {#enum}

Wählen Sie **[!UICONTROL Enums and Suggested Values]** und dann **[!UICONTROL Enums]** aus. Es werden zusätzliche Steuerelemente angezeigt, mit denen Sie die Werteeinschränkungen für die Aufzählung angeben können. Um eine Einschränkung hinzuzufügen, wählen Sie **[!UICONTROL Add row]** aus.

![Bild mit der in der Benutzeroberfläche ausgewählten Option „Aufzählungen“](../../images/ui/fields/enum/enum-add-row.png)

Unter der Spalte **[!UICONTROL Value]** müssen Sie den genauen Wert angeben, auf den Sie das Feld beschränken möchten. Optional können Sie auch eine benutzerfreundliche **[!UICONTROL Display Name]** für die Einschränkung angeben, die sich darauf auswirkt, wie der Wert in der Segmentierung dargestellt wird.

Verwenden Sie **[!UICONTROL Add row]** weiterhin, um der Aufzählung die gewünschten Einschränkungen und optionalen Beschriftungen hinzuzufügen, oder wählen Sie das Löschsymbol (![Bild des Löschsymbols](/help/images/icons/remove-circle.png)) neben einer zuvor hinzugefügten Zeile aus, um sie zu entfernen. Wenn Sie fertig sind, wählen Sie **[!UICONTROL Apply]** aus, um die Änderungen auf das Schema anzuwenden.
...
Wählen Sie **[!UICONTROL Enums and Suggested Values]** und dann **[!UICONTROL Suggested Values]** aus, damit zusätzliche Steuerelemente angezeigt werden. Wählen Sie hier **[!UICONTROL Add row]** , um mit dem Hinzufügen vorgeschlagener Werte zu beginnen.
...
Geben Sie in der Spalte **[!UICONTROL Display Name]** einen benutzerfreundlichen Namen für den Wert ein, wie er in der Segmentierungs-Benutzeroberfläche angezeigt werden soll. Um weitere vorgeschlagene Werte hinzuzufügen, wählen Sie erneut **[!UICONTROL Add row]** und wiederholen Sie den Vorgang nach Bedarf. Um eine zuvor hinzugefügte Zeile zu entfernen, klicken Sie ![das Löschsymbol](/help/images/icons/remove-circle.png) neben der betreffenden Zeile.
...
Um neue vorgeschlagene Werte für ein Standardfeld hinzuzufügen, wählen Sie **[!UICONTROL Add row]** aus. Um einen vorgeschlagenen Wert zu entfernen, der zuvor von Ihrer Organisation hinzugefügt wurde, wählen Sie ![das Löschsymbol](/help/images/icons/remove-circle.png) neben der betreffenden Zeile aus.
