...
| `media.bufferStart` | Der `media.bufferStart` Ereignistyp wird bei Beginn der Pufferung gesendet. Es gibt keinen bestimmten `bufferResume` Ereignistyp. Die Pufferung wird als fortgesetzt betrachtet, wenn nach einem `bufferStart` Ereignis ein `play` Ereignis gesendet wird. |
