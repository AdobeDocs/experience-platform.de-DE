...
| `timestamp` | Der Zeitpunkt, zu dem das Ereignis oder die Beobachtung erfolgte. |
...
* [[!UICONTROL Details zur ExperienceEvent-Umgebung]](../mixins/event/environment-details.md)
