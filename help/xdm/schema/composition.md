...
Beispielsweise könnte ein Schema, das Käufe in einem Einzelhandelsgeschäft beschreibt, wie folgt lauten:[!UICONTROL Store-Transaktionen]&quot;. Das Schema implementiert die [!DNL XDM ExperienceEvent] mit der Standardklasse kombiniert [!UICONTROL Commerce] Feldergruppe und eine benutzerdefinierte [!UICONTROL Produktinformationen] Feldergruppe.
