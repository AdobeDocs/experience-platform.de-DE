...
Im Folgenden finden Sie eine Liste der Dokumentation für Erweiterungen für die Server-seitige Ereignisweiterleitung . Eine Liste der verfügbaren Client-seitigen Erweiterungen finden Sie stattdessen unter [Tag Extensions-Referenz](../client/overview.md).
...
* [[!DNL Tiktok] Web-Ereignis-API](./tiktok/overview.md)
