...
In diesem Handbuch erfahren Sie, wie Sie die [!DNL Nextdoor] Conversion API-Erweiterung in Ihren Ereignisweiterleitungsregeln ([) installieren, konfigurieren und &#x200B;](https://experienceleague.adobe.com/de/docs/experience-platform/tags/ui/rules).
