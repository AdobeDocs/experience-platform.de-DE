...
Wenn Sie ein variables Datenelement auswählen, das ein Datenobjekt anstelle eines XDM-Objekts verwendet, hängen die verfügbaren Felder von den Produkten ab, die beim Konfigurieren des Datenelements ausgewählt wurden. Wenn Sie beispielsweise ein Datenobjekt erstellen, das Adobe Analytics-Felder enthält, liefert die Auswahl des Datenelements „Variable“ in dieser Benutzeroberfläche Felder, die Sie Adobe Analytics-spezifisch ausfüllen können.
