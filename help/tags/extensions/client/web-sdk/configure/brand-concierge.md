...
>abstract="Konfigurationseinstellungen bei Verwendung von Brand Concierge für Ihre Präsenz."
...
Ein Kontrollkästchen, das Brand Concierge-Sitzungen über Seiten hinweg speichert und ein Sitzungs-Cookie verwendet. Standardmäßig ist diese Option deaktiviert. Anleitungen zum Festlegen dieses Werts finden Sie unter [`conversation`](/help/collection/js/commands/configure/conversation.md) in der Dokumentation zur JavaScript-Bibliothek .
