---
title: Konfigurationseinstellungen für die SDK-Instanz
...
# Konfigurationseinstellungen für die SDK-Instanz {#sdk-instance}

>[!CONTEXTUALHELP]
>id="platform_tags_websdk_sdkinstance"
>title="SDK-Instanzen"
>abstract="Legt den Namen der SDK-Instanz, die IMS-Organisation, zu der sie gehört, und die Edge-Domain fest."
...
Adobe empfiehlt in den meisten Fällen die Verwendung einer Erstanbieter-Domain. Anweisungen zum Einrichten einer für die Datenerfassung geeigneten Erstanbieterdomäne finden [&#128279;](https://experienceleague.adobe.com/en/docs/core-services/interface/data-collection/adobe-managed-cert) im Adobe-verwalteten Zertifikatprogramm . Anleitungen zum Festlegen dieses Werts finden Sie auch in der JavaScript-Bibliotheksdokumentation unter [`edgeDomain`](/help/collection/js/commands/configure/edgedomain.md) .
