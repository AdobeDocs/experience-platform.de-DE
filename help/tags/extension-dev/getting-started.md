...
Dies kann beispielsweise dann zurückgegeben werden, wenn der Benutzerbrowser Chrome ist, wenn er eine iPad verwendet oder wenn sich der Benutzer in einer bestimmten Domain befindet.
...
* Exchange-URL (nur Web und Edge): Wenn eine Erweiterung im öffentlichen Katalog von Adobe veröffentlicht wird, geben Sie die Auflistungs-URL hier an.
