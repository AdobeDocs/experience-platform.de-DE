...
* Wenn ein Benutzer einen Eintrag vom Typ „Regel“ oder „Datenelement“ löscht und dieser Eintrag sich auf der letzten Seite einer mehrseitigen Liste befindet, wird der Benutzer nun zur richtigen Seite in der Liste zurückgeleitet.
...
* Eigenschaftskopie: Sie können jetzt eine Kopie einer Eigenschaft und ihres gesamten Inhalts erstellen. Wählen Sie auf der Seite mit der Eigenschaftenliste einfach eine Eigenschaft aus und klicken Sie in der Symbolleiste auf **[!UICONTROL Copy]**.
...
* Der Bildschirm „Bibliothek bearbeiten“ verfügt jetzt über eine Schaltfläche zum [!UICONTROL Remove All Resources].
* Die Größe des Klickziels wurde erhöht, um einzelne Ressourcen aus einer Bibliothek zu entfernen.

### Fehlerkorrekturen

* Es wurde ein Fehler in [!DNL Safari] behoben, bei dem die [!UICONTROL Add Resource]-Schaltflächen auf der Seite „Bibliothek bearbeiten“ an der falschen Stelle angezeigt wurden.
...
* Die [!UICONTROL Add Resource]-Schaltflächen auf der Seite „Bibliothek bearbeiten“ sind jetzt beim Bildlauf nach oben und unten schwebend, damit sie immer sichtbar sind.
...
* Auf Akamai gespeicherte Builds verwenden eine neue Ordnerstruktur. Einbettungs-Codes werden nicht geändert. Dadurch werden viele Probleme mit Builds an Akamai vermittelt.
