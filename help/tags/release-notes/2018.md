...
* Bedingungen und Ausnahmen wurden im Regel-Builder kombiniert, da die Reihenfolge wichtig ist. Dies spiegelt ihre Behandlung innerhalb des Systems und zur Laufzeit genauer wider. Um eine Ausnahme vorzunehmen, klicken Sie unter „Bedingungen“ auf den Button **[!UICONTROL Add]** unter [!UICONTROL Conditions] und wählen Sie **[!UICONTROL Exception]** in der Auswahl [!UICONTROL Logic Type] aus.
...
Einbettungs-Codes wurden von der Detailseite „Umgebung“ in ein Installationsanweisungsmodal verschoben. Dieses Modal wird automatisch angezeigt, nachdem Sie eine neue Umgebung erstellt haben, und ist über die Listenansicht „Umgebungen“ zugänglich.
...
#### Umgebungsseiten zeigen standardmäßig asynchrone Einbettungs-Codes an

Auf Umgebungsseiten werden von nun an standardmäßig asynchrone Einbettungs-Codes angezeigt. Der Wechsel zwischen synchron und asynchron funktioniert genau wie zuvor.
...
* Asynchrone Umschaltung in Umgebungen.
  ...
  Beim Abrufen des Einbettungs-Codes für eine Umgebung können Sie jetzt einen Umschalter betätigen, um den Einbettungs-Code abzurufen, wenn die Bibliothek asynchron geladen werden soll.
