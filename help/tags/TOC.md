...
* Erweiterungen {#extensions}
   ...
   * Tag-Erweiterungen (Client-seitig) {#client}
      ...
      * Adobe Analytics {#analytics}
         * [Übersicht](./extensions/client/analytics/overview.md)
      ...
      * Adobe Target v2 {#target-v2}
         * [Übersicht](./extensions/client/target-v2/overview.md)
      ...
      * Google-Datenschicht {#google-data-layer}
         * [Übersicht](./extensions/client/google-data-layer/overview.md)
   ...
   * Erweiterungen für die Ereignisweiterleitung (Server-seitig) {#server}
      ...
      * [!DNL Algolia] {#algolia}
         * [Übersicht](./extensions/server/algolia/overview.md)
      * [!DNL Amazon] {#amazon}
         * [Übersicht](./extensions/server/amazon/overview.md)
      * [!DNL AWS] {#aws}
      ...
      * [!DNL LinkedIn Conversions API] {#linkedin}
         * [Übersicht](./extensions/server/linkedin/overview.md)
      * [!DNL Mailchimp] Edge {#mailchimp}
         * [Übersicht](./extensions/server/mailchimp/overview.md)
      ...
      * [!DNL Nextdoor] {#nextdoor}
         * [Übersicht](./extensions/server/nextdoor/overview.md)
      * [Pega Customer Decision Hub](https://exchange.adobe.com/apps/ec/107597)
      * [!DNL Pinterest] {#pinterest}
         * [Übersicht](./extensions/server/pinterest/overview.md)
      * [!DNL Reddit] {#reddit}
         * [Übersicht](./extensions/server/reddit/overview.md)
      * [!DNL Snapchat] {#snap}
         * [Übersicht](./extensions/server/snap/overview.md)
