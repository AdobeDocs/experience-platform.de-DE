...
* Erste Schritte {#get-started}
   ...
   * [Handbücher zur Implementierung](./quick-start/implementation-guides.md)
* Handbücher zur Benutzeroberfläche {#ui}
   * [Überblick](./ui/managing-resources/overview.md)
   * Erweiterungen {#extensions}
      * [Überblick](./ui/managing-resources/extensions/overview.md)
...
* Client-seitige Informationen {#client-side}
   * [Überblick](./ui/client-side/overview.md)
...
* Administration {#admin}
   * [Überblick](./ui/administration/overview.md)
...
* Erweiterungen {#extensions}
   ...
   * Tag-Erweiterungen (Client-seitig) {#client}
      * [Überblick](./extensions/client/overview.md)
      ...
      * Adobe Analytics {#analytics}
         ...
         * [Versionshinweise](./extensions/client/analytics/release-notes.md)
      ...
      * Adobe Analytics-Produktzeichenfolge {#product-string}
         * [Überblick](./extensions/client/product-string/overview.md)
      ...
      * Adobe Client-Datenschicht {#client-data-layer}
         * [Überblick](./extensions/client/client-data-layer/overview.md)
      ...
      * Adobe Experience Platform Web SDK {#web-sdk}
         ...
         * Konfigurieren {#configure}
            ...
            * [Identität](extensions/client/web-sdk/configure/identity.md)
         ...
         * Aktionstypen {#actions}
            * [Überblick](extensions/client/web-sdk/actions/actions-overview.md)
            * [Vorschläge anwenden](extensions/client/web-sdk/actions/apply-propositions.md)
            * [Antwort anwenden](extensions/client/web-sdk/actions/apply-response.md)
            * [Regelsätze auswerten](extensions/client/web-sdk/actions/evaluate-rulesets.md)
            * [Media Analytics-Tracker abrufen](extensions/client/web-sdk/actions/get-media-analytics-tracker.md)
            * [Mit Identität umleiten](extensions/client/web-sdk/actions/redirect-with-identity.md)
            * [Ereignis-Zusammenführungskennung zurücksetzen](extensions/client/web-sdk/actions/reset-event-merge-id.md)
            * [Ereignis senden](extensions/client/web-sdk/actions/send-event.md)
            * [Medienereignis senden](extensions/client/web-sdk/actions/send-media-event.md)
            * [Push-Abonnement senden](extensions/client/web-sdk/actions/send-push-subscription.md)
            * [Einverständnis festlegen](extensions/client/web-sdk/actions/set-consent.md)
            * [Variable aktualisieren](extensions/client/web-sdk/actions/update-variable.md)
      ...
      * Adobe Target {#target}
         * [Überblick](./extensions/client/target/overview.md)
         * [Versionshinweise](./extensions/client/target/release-notes.md)
      ...
      * [!DNL Algolia] Insights {#algolia-insights}
         * [Übersicht](./extensions/client/algolia/overview.md)
      ...
      * Video-Tracking [!DNL BrightCove] {#brightcove}
         * [Überblick](./extensions/client/brightcove/overview.md)
      ...
      * Common Analytics Plugins {#plugins}
         * [Überblick](./extensions/client/plugins/overview.md)
      ...
      * Kern {#core}
         * [Überblick](./extensions/client/core/overview.md)
      ...
      * Google-Datenschicht {#google-data-layer}
         * [Überblick](./extensions/client/google-data-layer/overview.md)
         * [Versionshinweise](./extensions/client/google-data-layer/release-notes.md)
      ...
      * [!DNL Marketo Munchkin] {#marketo}
         * [Überblick](./extensions/client/marketo/overview.md)
      ...
      * [!DNL Meta Pixel] {#meta}
         * [Überblick](./extensions/client/meta/overview.md)
      ...
      * [!DNL Snap Pixel] {#snap-pixel}
         * [Überblick](./extensions/client/snap-pixel/overview.md)
      ...
      * Video-Tracking [!DNL YouTube] {#youtube}
         * [Überblick](./extensions/client/youtube/overview.md)
   ...
   * Erweiterungen für die Ereignisweiterleitung (Server-seitig) {#server}
      ...
      * [!DNL Adform] {#adform}
         * [Überblick](./extensions/server/adform/overview.md)
      * [!DNL Algolia] {#algolia}
         * [Überblick](./extensions/server/algolia/overview.md)
      * [!DNL Amazon] {#amazon}
         * [Überblick](./extensions/server/amazon/overview.md)
      * [!DNL AWS] {#aws}
         * [Überblick](./extensions/server/aws/overview.md)
      * [!DNL Braze] {#braze}
         * [Überblick](./extensions/server/braze/overview.md)
      ...
      * Google Cloud Platform {#google-cloud-platform}
         * [Überblick](./extensions/server/google-cloud-platform/overview.md)
      * [!DNL LinkedIn Conversions API] {#linkedin}
         * [Überblick](./extensions/server/linkedin/overview.md)
      * [!DNL Mailchimp] Edge {#mailchimp}
         * [Überblick](./extensions/server/mailchimp/overview.md)
      * [!DNL Meta Conversions API] {#meta}
         * [Überblick](./extensions/server/meta/overview.md)
      * [!DNL Microsoft Azure] {#azure}
         * [Überblick](./extensions/server/azure/overview.md)
      * [!DNL Mixpanel] {#mixpanel}
         * [Überblick](./extensions/server/mixpanel/overview.md)
      * [!DNL Nextdoor] {#nextdoor}
         * [Überblick](./extensions/server/nextdoor/overview.md)
      * [Pega Customer Decision Hub](https://exchange.adobe.com/apps/ec/107597)
      * [!DNL Pinterest] {#pinterest}
         * [Überblick](./extensions/server/pinterest/overview.md)
      * [!DNL Reddit] {#reddit}
         * [Überblick](./extensions/server/reddit/overview.md)
      * [!DNL Snapchat] {#snap}
         * [Überblick](./extensions/server/snap/overview.md)
      * [!DNL Snowflake] {#snowflake}
         * [Überblick](./extensions/server/snowflake/overview.md)
      * [!DNL Splunk] {#splunk}
         * [Überblick](./extensions/server/splunk/overview.md)
      * [!DNL Twitter] {#twitter}
         * [Überblick](./extensions/server/twitter/overview.md)
      * [!DNL Tiktok] Web-Ereignis-API {#tiktok}
         * [Überblick](./extensions/server/tiktok/overview.md)
      * [!DNL The Trade Desk] {#thetradedesk}
         * [Überblick](./extensions/server/tradedesk/overview.md)
...
* Entwicklung von Erweiterungen {#extension-dev}
   * [Überblick](./extension-dev/overview.md)
