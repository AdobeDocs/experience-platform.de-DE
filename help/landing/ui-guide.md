...
Das nächste Element auf der rechten Seite der oberen Navigation ist die **Anwendungsschalter** durch ![Anwendungsschalter](./images/user-guide/app-switcher-icon.png) Symbol. Wenn Sie dieses Symbol auswählen, können Sie zwischen Adobe-Anwendungen, auf die Ihr Unternehmen Zugriff hat, wie Experience Platform, Analytics, Assets und anderen wechseln.
...
Das letzte Element auf der oberen Navigationsleiste ist die **Benutzereinstellungen** durch ![Benutzereinstellungen/Benutzerprofil](images/user-guide/profile-icon.png) Symbol. Wählen Sie dieses Symbol aus, um Ihre Voreinstellungen zu bearbeiten oder sich abzumelden.
