...
Viele CMPs bieten vordefinierte Hooks, die auf Einverständnisänderungsereignisse warten. Wenn diese Ereignisse eintreten, können Sie den Befehl [`setConsent`](/help/collection/js/commands/setconsent.md) verwenden, um die Einverständnisdaten dieses Kunden zu aktualisieren.
