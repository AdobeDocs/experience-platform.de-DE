...
* [Adobe Experience Platform Web SDK](/help/collection/js/js-overview.md): Eine Client-seitige JavaScript-Bibliothek, mit der Sie verschiedene Experience Platform-Services in Ihre kundenorientierte Website integrieren können.
   * [SDK-Einverständnisbefehle](/help/collection/js/commands/setconsent.md): Ein Überblick über den Anwendungsfall der einverständnisbezogenen SDK-Befehle, die in diesem Handbuch gezeigt werden.
...
>[!NOTE]
>
>Weitere Informationen zur Struktur der oben genannten XDM-Einverständnisfelder finden Sie im Handbuch zum [[!UICONTROL Consents and Preferences] Datentyp &#x200B;](/help/xdm/data-types/consents.md).
...
In der Anleitung [Zuordnen einer CSV-Datei zu XDM](../../../../ingestion/tutorials/map-csv/overview.md) erfahren Sie, wie Sie Ihre Datenfelder in XDM konvertieren und in Experience Platform aufnehmen können. Stellen Sie bei der Auswahl der [!UICONTROL Destination] für die Zuordnung sicher, dass Sie die Option **[!UICONTROL Use existing dataset]** auswählen und den [!DNL Profile]-aktivierten Einverständnisdatensatz auswählen, den Sie zuvor erstellt haben.
