---
title: Einrichten und Konfigurieren von kundenverwalteten Schlüsseln mithilfe der Platform-Benutzeroberfläche
...
In diesem Dokument wird der Prozess zum Aktivieren der Funktion für kundenverwaltete Schlüssel (CMK) in Platform mithilfe der Benutzeroberfläche beschrieben. Anweisungen zum Abschließen dieses Prozesses mithilfe der API finden Sie im [API CMK-Setup-Dokument](./api-set-up.md).
...
Wählen Sie das Kopiersymbol (![Das Kopiersymbol.](/help/images/icons/copy.png)) durch die [!UICONTROL Anwendungsauthentifizierungs-URL].
...
Durch Ausführung der oben genannten Schritte haben Sie CMK für Ihre Organisation erfolgreich aktiviert. Daten, die in primäre Datenspeicher aufgenommen werden, werden jetzt mit dem oder den Schlüssel(n) in Ihrem [!DNL Azure]-Schlüsseltresor ver- und entschlüsselt.
