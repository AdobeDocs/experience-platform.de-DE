...
* Experience Platform-Benutzeroberfläche {#platform-ui}
...
* Verwaltung, Datenschutz und Sicherheit {#governance-privacy-security}
   ...
   * Audit-Protokolle {#audit-logs}
      * [Überblick](./governance-privacy-security/audit-logs/overview.md)
   ...
   * Kundenseitig verwaltete Schlüssel {#customer-managed-keys}
      ...
      * Azure {#azure}
         ...
         * [Konfigurieren von Warnhinweisen und IP-Zulassungsliste für Azure CMK](./governance-privacy-security/customer-managed-keys/azure/alerts-and-ip-access.md)
