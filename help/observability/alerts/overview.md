...
| Verlauf von Warnhinweisen anzeigen* | Ermöglicht die Anzeige eines Verlaufs der empfangenen Warnhinweise in der Registerkarte [!UICONTROL Alerts] . |
| Verwalten von Warnhinweisen* | Ermöglicht die Aktivierung und Deaktivierung von Warnhinweisregeln über die Registerkarte [!UICONTROL Alerts] . |
| Auflösen von Warnhinweisen* | Ermöglicht die Auflösung von ausgelösten Warnhinweisen über die Registerkarte [!UICONTROL Alerts] . |

{style="table-layout:auto"}

**Um auf die Registerkarte [!UICONTROL Alerts] zugreifen zu können, muss Ihnen auch die Berechtigung Warnhinweise anzeigen in Kombination mit einer der anderen Berechtigungen gewährt worden sein.*
