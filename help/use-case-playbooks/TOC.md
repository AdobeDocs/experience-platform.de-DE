---
audience: user
user-guide-title: Adobe Experience Platform – Playbooks für Anwendungsfälle
breadcrumb-title: Adobe Experience Platform – Playbooks für Anwendungsfälle
...
# Adobe Experience Platform – Playbooks für Anwendungsfälle {#use-case-playbooks}

* Playbooks {#playbooks}
   * [Übersicht](/help/use-case-playbooks/playbooks/overview.md)
   * [Anwendungsfälle für Kundenerlebnisse nutzen, um Geschäftsziele zu erreichen](/help/use-case-playbooks/playbooks/business-use-case-framework.md)
   ...
   * [Eigenes Playbook erstellen](/help/use-case-playbooks/playbooks/author.md)
