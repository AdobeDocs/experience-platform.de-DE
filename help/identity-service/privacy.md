...
>[!NOTE]
>
>In diesem Handbuch wird nur beschrieben, wie Sie Datenschutzanfragen an den Identitätsdatenspeicher in Experience Platform stellen. Wenn Sie auch Datenschutzanfragen für den Platform Data Lake oder [!DNL Real-Time Customer Profile] planen, lesen Sie zusätzlich zu diesem Tutorial das Handbuch zur Verarbeitung von Datenschutzanfragen im Data Lake [ und das Handbuch zur Verarbeitung von Datenschutzanfragen für Profil](../profile/privacy.md).](../catalog/privacy.md)[
>
