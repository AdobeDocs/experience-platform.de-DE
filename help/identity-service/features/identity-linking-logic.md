...
| Ein Endbenutzer meldet sich mit Google Chrome und dann mit Firefox an. | Die CRM-ID ist mit zwei verschiedenen ECIDs verknüpft. | Eine Person (CRM-ID) ist zwei Webbrowsern zugeordnet (**Hinweis**: Jeder Browser verfügt über eine eigene ECID). |
...
* `t=2`, denselben Desktop-Computer verwendet, angemeldet (CRM ID:31260XYZ) und dann nach Schuhen gesucht.
...
* `t=4`, denselben Laptop-Computer verwendet, angemeldet (CRM-ID: 31260XYZ) und dann den Kaufverlauf angezeigt.
...
Bei `timestamp=4` verwendet ein Kunde dasselbe Tablet, meldet sich bei seinem Konto an (CRM ID:31260XYZ) und zeigt seinen Kaufverlauf an. Dieses Ereignis verknüpft ihre CRM-ID:31260XYZ mit der Cookie-ID, die der anonymen Browsing-Aktivität zugewiesen wurde, ECID:44675 und verknüpft ECID:44675 mit dem Identitätsdiagramm des Kunden.
