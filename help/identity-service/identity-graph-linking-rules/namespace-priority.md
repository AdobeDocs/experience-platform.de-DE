...
* Weitere Informationen finden Sie in den [Architekturdiagrammen für Adobe Experience Platform &#x200B;](https://experienceleague.adobe.com/de/docs/blueprints-learn/architecture/architecture-overview/platform-applications#detailed-architecture-diagram) Anwendungen und auf den [Vergleichsseiten &#x200B;](/help/landing/edge-and-hub-comparison.md) Edge Network und Hub .
