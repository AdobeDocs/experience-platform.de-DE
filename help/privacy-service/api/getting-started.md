...
Der Bildschirm _[!UICONTROL API]_ konfigurieren wird angezeigt. Wählen Sie die Option zum **[!UICONTROL Generieren eines Schlüsselpaars]** aus und klicken Sie dann unten rechts auf **[!UICONTROL Generate keypair]** .
...
Um einen neuen zu generieren, öffnen Sie `{ACCESS_TOKEN}`den zuvor heruntergeladenen privaten Schlüssel und fügen Sie den Inhalt in das Textfeld neben _[!UICONTROL Zugriffstoken]_ erstellen ein, bevor Sie auf Token **[!UICONTROL generieren]** klicken.
