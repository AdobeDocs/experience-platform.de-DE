...
* Funktionsweise von Zielen {#how-destinations-work}
   ...
   * [Zielgruppen-Lebenszyklus in Streaming-Zielen](./how-destinations-work/audience-lifecycle-streaming-destinations.md)
* API-Tutorials {#api}
...
* Zielkatalog {#catalog}
   ...
   * Adobe-Ziele{#adobe}
      ...
      * [Marketo Engage-Verbindung](./catalog/adobe/marketo-engage-connection.md)
   ...
   * Werbeziele{#advertising}
      ...
      * {hide-from-toc}[(Beta) FreeWheel-Verbindung](./catalog/advertising/freewheel.md)
      ...
      * [Index Exchange-Verbindung](./catalog/advertising/index-exchange.md)
      * [Verbindung abgleichen](./catalog/advertising/kevel.md)
