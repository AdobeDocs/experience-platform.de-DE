...
* Wählen Sie eine Kennung (z. B.: `Email_LC_SHA256`) als Quellidentität aus, die ein Profil in Adobe Experience Platform und [!DNL TikTok Ads Manager] eindeutig identifiziert.
