...
Adobe Livefyre ist eine soziale Erweiterung in [!DNL Adobe Experience Platform]. Weitere Informationen zu Adobe Livefyre finden Sie im [Livefyre-Implementierungshandbuch](https://experienceleague.adobe.com/docs/livefyre/implementation/home.html).
