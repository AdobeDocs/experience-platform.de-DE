...
>title="HTTP-Endpunkt"
>abstract="Die URL des HTTP-Endpunkts, an den Sie die Profildaten senden möchten. Dies ist Ihr Datenempfangsendpunkt und unterstützt mTLS, falls konfiguriert (nicht verfügbar mit OAuth 2-Kennwort- oder Client-Anmeldedaten-Authentifizierung)."
