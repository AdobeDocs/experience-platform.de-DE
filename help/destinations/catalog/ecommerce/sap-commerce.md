...
Damit Sie besser verstehen können, wie und wann Sie das [!DNL SAP Commerce]-Ziel verwenden sollten, finden Sie hier ein Anwendungsbeispiel, das für [!DNL Adobe Experience Platform] Kunden mit diesem Ziel geeignet ist.
...
Beachten Sie die folgenden Voraussetzungen für den Export von Daten aus Experience Platform in Ihr [!DNL SAP Commerce]:
...
* Der [!DNL SAP Commerce]-Dienstschlüssel bietet über Experience Platform Zugriff auf die [!DNL SAP Subscription Billing]-API. Informationen zum Erstellen eines Dienstschlüssels finden Sie [!DNL SAP Commerce] [&#x200B; Erstellen eines Dienstschlüssels mit Client](https://help.sap.com/docs/CLOUD_TO_CASH_OD/1216e7b79c984675b0a6f0005e351c74/87c11a0f5dc3494eaf3baa355925c030.html#create-a-service-key-with-client-id-and-client-secret)ID und Client-Geheimnis . [!DNL SAP Commerce] erfordert Folgendes:
   * Client-ID
   * Client-Geheimnis
...
Um die benutzerdefinierten Verweise zu erstellen, melden Sie sich bei Ihrem [!DNL SAP Subscription Billing]-Konto an und navigieren Sie zur Seite **[Stammdaten und Konfiguration]** > **[Benutzerdefinierte Verweise]**. Wählen Sie als Nächstes **[!UICONTROL Create]** aus, um für jede in Experience Platform ausgewählte Zielgruppe eine neue Referenz hinzuzufügen. Sie benötigen diese Referenzfeldnamen im nachfolgenden Schritt [Planen des Zielgruppenexports und Beispiel](#schedule-segment-export-example).
...
#### `customerNumberSAP` Identität zuordnen {#map-customer-number-sap}
...
#### Dem ausgewählten Kundentyp `mandatory` Attribute zuordnen {#map-mandatory-attributes}
...
#### Zuordnen zusätzlicher Attribute {#mapping-additional-attributes}
...
Wechseln Sie zum [!DNL SAP Subscription Billing] Konto und navigieren Sie dann zur Seite **[!UICONTROL Contacts]** , um den Status der Zielgruppe zu überprüfen. Die Liste kann so konfiguriert werden, dass Spalten für die benutzerdefinierten Verweise und die entsprechenden Zielgruppenstatus angezeigt werden.
