...
Blättern Sie unter **[!UICONTROL Ziele]** > **[!UICONTROL Katalog]** zur Kategorie **[!UICONTROL Mobile Interaktion]** . Wählen Sie **[!DNL Airship Tags]** und dann **[!UICONTROL Konfigurieren]**.
...
![Verbindung zu Airship-Tags](../../assets/catalog/mobile-engagement/airship-tags/select-source-identity.png)![Verbinden mit der Zuordnung von Airship-Tags](../../assets/catalog/mobile-engagement/airship-tags/select-target-identity.png)![Kanälen](../../assets/catalog/mobile-engagement/airship-tags/mapping-option.png)
