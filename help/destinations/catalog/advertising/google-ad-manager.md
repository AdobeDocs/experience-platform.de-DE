...
* **[!UICONTROL Segment-ID an Segmentname anhängen]**: Wählen Sie diese Option, damit der Segmentname in Google Ad Manager die Segment-ID aus Experience Platform wie folgt enthält: `Segment Name (Segment ID)`.
