...
>[!IMPORTANT]
>
>Wenn Sie Ihr erstes Ziel mit [!DNL Google Ads] und nicht aktiviert haben, [ID-Synchronisierungsfunktion](https://experienceleague.adobe.com/docs/id-service/using/id-service-api/methods/idsync.html?lang=de) Wenden Sie sich in der Vergangenheit (mit Audience Manager oder anderen Anwendungen) an Adobe Consulting oder die Kundenunterstützung, um ID-Synchronisierungen zu aktivieren. Wenn Sie zuvor schon Google-Integrationen in Audience Manager eingerichtet hatten, werden die von Ihnen eingerichteten ID-Synchronisierungen auf Platform übertragen.
...
>[!IMPORTANT]
>
> [!DNL Google] hat neue [!DNL Google Ads]-Cookie-Integrationen mit Drittanbietern abgeschafft. Um die Schritte der Zulassungsliste im nächsten Abschnitt durchzuführen, müssen Sie über eine vorhandene Integration mit [!DNL Google Ads]. Daher ist der empfohlene Ansatz für die Verwendung von [!DNL Google Ads] das Einrichten einer [!DNL Google Customer Match]-Integration. Weitere Informationen zum Erstellen eines [!DNL Google Customer Match] Integration, lesen Sie das Tutorial zum Erstellen einer [[!DNL Google Customer Match]](./google-customer-match.md) Verbindung herzustellen.

### Zulassungsauflistung {#allow-listing}

>[!NOTE]
>
>Die Zulassungsauflistung ist obligatorisch, bevor Sie Ihr erstes [!DNL Google Ads]-Ziel in Platform einrichten. Vergewissern Sie sich, dass der unten beschriebene Genehmigungsprozess durch [!DNL Google] vor dem Erstellen eines Ziels.
...
Vor der Erstellung [!DNL Google Ads] Ziel in Platform müssen Sie [!DNL Google] für Adobe auf die Liste der zugelassenen Datenanbieter gesetzt und Ihr Konto zur Zulassungsliste hinzugefügt werden soll. Kontaktieren Sie [!DNL Google] und machen Sie folgende Angaben:
...
[!DNL Google] hat neue [!DNL Google Ads]-Cookie-Integrationen mit Drittanbietern abgeschafft. Um die [Zulassungsliste](#allow-listing) Schritte, müssen Sie über eine vorhandene Integration mit [!DNL Google Ads].
