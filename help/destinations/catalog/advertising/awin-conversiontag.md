...
Das Konversions-Tag ist die Deklaration des JavaScript-Objekts AWIN.Tracking.Sale , das auf der Bestätigungsseite ausgeführt wird, um das Mastertag anzuweisen, dass eine Konvertierung stattgefunden hat. Anschließend führt er die erforderlichen Tracking-Anfragen aus.
...
Um diese Erweiterung verwenden zu können, benötigen Sie Zugriff auf Tags in Platform. Tags werden Adobe Experience Cloud-Kunden als integrierte Mehrwertfunktion angeboten. Wenden Sie sich an Ihren Organisationsadministrator, um Zugriff auf Datenerfassungsfunktionen in der Benutzeroberfläche zu erhalten und ihn aufzufordern, Ihnen die Berechtigung **[!UICONTROL manage_properties]** zu erteilen, damit Sie Erweiterungen installieren können.
