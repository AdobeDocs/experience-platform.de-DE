...
title: Bing Ads Universal Event Tracking (UET)-Erweiterung
description: Die Bing Ads Universal Event Tracking (UET)-Erweiterung ist ein Werbeziel in Adobe Experience Platform. Weitere Informationen zur Funktionalität der Erweiterung finden Sie auf der Seite der Erweiterung auf Adobe Exchange.
...
[!DNL Bing Ads Universal Event Tracking] (UET) für  [!DNL Experience Platform Launch] ist eine nützliche Methode, um zu verfolgen, was passiert, nachdem jemand auf Ihre Suchanzeige geklickt hat. Wenn Sie mit einem einzelnen UET-Tag aufzeichnen, was Kunden auf Ihrer Website tun, können Sie diese Daten nutzen, um Konversionen zu verfolgen oder Zielgruppen mithilfe von Remarketing-Listen anzusprechen.

[!DNL Bing Ads Universal Event Tracking] (UET) ist eine Werbeerweiterung in Adobe Experience Platform. Weitere Informationen zur Funktionalität der Erweiterung finden Sie auf der Seite der Erweiterung auf [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
...
So installieren Sie die Erweiterung [!DNL Bing Ads Universal Event Tracking] (UET):
...
Informationen zu den Konfigurationsoptionen für Erweiterungen und zur Installationsunterstützung finden Sie auf der Seite [Bing Ads Universal Event Tracking (UET) auf Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
