...
Die [!DNL MasterTag] ist eine JavaScript-Bibliothek, die alle für die Awin-Tracking-Lösung erforderlichen Funktionen enthält und bedingungslos an jede Seite der Site angehängt werden sollte, einschließlich der Bestätigungsseite, jedoch ohne Seiten, die Zahlungsinformationen anzeigen oder verarbeiten.
