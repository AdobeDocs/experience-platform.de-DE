...
>[!AVAILABILITY]
>
>Die Funktion zum Aktivieren von Account-Zielgruppen für das Bombora ABM Audiences-Ziel ist für Unternehmen verfügbar, die die [Business-to-Business](/help/rtcdp/overview.md#rtcdp-b2b)- und [Business-to-Person](/help/rtcdp/overview.md#rtcdp-b2p)-Editionen von [!DNL Real-Time Customer Data Platform] erwerben.
...
Damit Sie besser verstehen können, wie und wann Sie das Bombora-Ziel verwenden sollten, finden Sie hier einige Beispielanwendungsfälle, die [!DNL Adobe Experience Platform] Kunden mit diesem Ziel bewältigen können.
