...
Verwenden Sie diesen Ziel-Connector, um Profildaten an [!DNL The Trade Desk] zu senden. Dieser Connector sendet Daten an den [!DNL The Trade Desk] Erstanbieter-Endpunkt. Die Integration zwischen [!DNL Adobe Experience Platform] und [!DNL The Trade Desk] unterstützt nicht den Export von Daten an den [!DNL The Trade Desk] Drittanbieter-Endpunkt.
...
Im Folgenden finden Sie die von [!DNL The Trade Desk] Ziel unterstützten Identitäten. Verwenden Sie diese Identitäten, um Zielgruppen für die [!DNL The Trade Desk] zu aktivieren.
