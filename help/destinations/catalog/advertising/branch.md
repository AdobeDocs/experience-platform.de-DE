...
Branch ist eine Werbeerweiterung in [!DNL Adobe Experience Platform]. Weitere Informationen zur Erweiterungsfunktionalität finden Sie auf der [Funktionsseite](https://branch.io/features/) der Branch-Website.
