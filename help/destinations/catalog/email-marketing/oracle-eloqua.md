...
Um Zielgruppendaten an [!DNL Oracle Eloqua] zu senden, müssen Sie zunächst in [ ](#connect-destination)das Ziel verbinden[!DNL Adobe Experience Platform] und dann [einen Datenimport einrichten](#import-data-into-eloqua) von Ihrem Speicherort in [!DNL Oracle Eloqua].
