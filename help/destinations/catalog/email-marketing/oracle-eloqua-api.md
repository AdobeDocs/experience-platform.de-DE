...
Dieses [!DNL Adobe Experience Platform] [Ziel](/help/destinations/home.md) nutzt den [Aktualisieren eines Kontakts](https://docs.oracle.com/en/cloud/saas/marketing/eloqua-rest-api/op-api-rest-1.0-data-contact-id-put.html) -Vorgang der [!DNL Oracle Eloqua] REST-API, mit dem Sie **Identitäten** einer Zielgruppe in [!DNL Oracle Eloqua] aktualisieren können.
