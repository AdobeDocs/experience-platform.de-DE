...
[!DNL Quantum Metric's] Die Integration mit Adobe Launch erleichtert die codellose Implementierung von  [!DNL Quantum Metric's] Datenerfassungs-Tags. Darüber hinaus bietet diese Erweiterung die Möglichkeit, Launch-Datenelemente zu erfassen, die nützliche Informationen aus der [!DNL Quantum Metric]-API enthalten.
...
Weitere Informationen zu den Konfigurationsoptionen für Erweiterungen und zur Installationsunterstützung finden Sie auf der [Quantum Metric-Seite in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
