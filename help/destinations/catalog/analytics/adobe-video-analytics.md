...
Informationen zu den Konfigurationsoptionen für Erweiterungen finden Sie auf der Seite [Adobe Medien Analytics for Audio and Video-Erweiterung](../../../tags/extensions/web/media-analytics/overview.md) in der Tag-Dokumentation.
