...
Um Zielgruppen an andere Adobe-Lösungen zu senden, verwenden Sie die Direktverbindungen von [!DNL Real-Time CDP] zu [Adobe Target](../personalization/adobe-target-connection.md), [Adobe Advertising](../advertising/adobe-advertising-cloud-connection.md), [Adobe Campaign &#x200B;](../email-marketing/adobe-campaign.md) [Marketo Engage](../adobe/marketo-engage.md).
