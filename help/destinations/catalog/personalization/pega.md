...
Verwenden Sie das [!DNL Pega Customer Decision Hub] Echtzeit-Zielgruppenziel in [!DNL Adobe Experience Platform], um Profilattribute und Zielgruppenzugehörigkeitsdaten zur Entscheidungsfindung für die nächste beste Aktion an [!DNL Pega Customer Decision Hub] zu senden.
...
|---|---|
| *CustomerID* | Allgemeine Benutzerkennung, die ein Profil in [!DNL Pega Customer Decision Hub] und [!DNL Adobe Experience Platform] eindeutig identifiziert |
...
* Wählen Sie eine Kennung (z. B.: Kunden-ID) als Quellidentität aus, die ein Profil in [!DNL Adobe Experience Platform] und [!DNL Pega Customer Decision Hub] eindeutig identifiziert.
