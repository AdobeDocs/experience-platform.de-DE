...
>additional-url="https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream.html" text="Erfahren Sie, wie Sie einen Datenstrom konfigurieren"
