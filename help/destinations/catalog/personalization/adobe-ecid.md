...
[!DNL Experience Cloud] Der ID-Dienst ist eine Personalisierungserweiterung in Adobe Experience Platform. Weitere Informationen zur Erweiterungsfunktion finden Sie auf der Seite [Experience Cloud-ID-Dienst-Erweiterung](../../../tags/extensions/web/id-service/overview.md) in der [!DNL Experience Platform Launch] -Dokumentation.
...
Weitere Informationen zu den Konfigurationsoptionen für Erweiterungen und zur Installationsunterstützung finden Sie auf der Seite [Experience Cloud-ID-Dienst-Erweiterung](../../../tags/extensions/web/id-service/overview.md) in der [!DNL Experience Launch] -Dokumentation.
