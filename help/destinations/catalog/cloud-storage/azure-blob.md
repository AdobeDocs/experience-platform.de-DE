...
## Herstellen einer Verbindung zu Ihrem [!UICONTROL Azure Blob] über API oder Benutzeroberfläche {#connect-api-or-ui}
...
* **[!UICONTROL Connection string]**: Die Verbindungszeichenfolge ist für den Zugriff auf Daten in Ihrem Blob-Speicher erforderlich. Das [!DNL Blob]-Verbindungszeichenfolgenmuster beginnt mit: `DefaultEndpointsProtocol=https;AccountName={ACCOUNT_NAME};AccountKey={ACCOUNT_KEY}`.
