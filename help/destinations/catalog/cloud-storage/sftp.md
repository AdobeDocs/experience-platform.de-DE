...
Stellen Sie mit Ihrem SFTP-Server eine aktive ausgehende Verbindung her, um durch Trennzeichen getrennte Datendateien regelmäßig aus [!DNL Adobe Experience Platform] zu exportieren.
...
Die ordnungsgemäße Konfiguration der Verbindungsbeschränkungen Ihres SFTP-Servers verhindert fehlgeschlagene Exporte und stellt eine zuverlässige Datenbereitstellung von [!DNL Adobe Experience Platform] sicher.
...
Siehe den Artikel [IP-Adresse](ip-address-allow-list.md) , wenn Sie einer Zulassungsliste Adobe-IPs hinzufügen müssen.
