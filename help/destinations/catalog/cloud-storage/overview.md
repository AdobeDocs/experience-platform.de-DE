...
* **Datensatzexport**. Verwenden Sie diese Funktion, um ganze Datensätze in Cloud-Speicher-Ziele zu exportieren. [Weitere Informationen](/help/destinations/ui/export-datasets.md) über die Funktion.
