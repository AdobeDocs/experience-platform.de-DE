...
>[!IMPORTANT]
>
>Dieser Ziel-Connector befindet sich in der Beta-Phase und steht nur Kunden von Real-Time CDP Ultimate zur Verfügung. Die Funktionalität und Dokumentation können sich ändern.
...
Experience Platform bietet zwei Typen von Snowflake-Zielen: [Snowflake-Streaming](/help/destinations/catalog/cloud-storage/snowflake.md) und [Snowflake-Batch](snowflake-batch.md).
...
|  | Wählen Sie [Snowflake Batch](snowflake-batch.md) wenn Sie benötigen | Wählen Sie [Snowflake-Streaming](/help/destinations/catalog/cloud-storage/snowflake.md), wenn Sie Folgendes benötigen |
|--------|-------------------|----------------------|
...
Weitere Informationen zum Freigeben von Streaming-Daten finden Sie in der Dokumentation zu [Snowflake Streaming](../cloud-storage/snowflake.md)Verbindungen.
...
Um sich beim Ziel zu authentifizieren, wählen **[!UICONTROL Mit Ziel verbinden]** und geben Sie einen Kontonamen und optional eine Kontobeschreibung an.
...
### Mehrere Zusammenführungsrichtlinien

Zielgruppen mit mehreren Zusammenführungsrichtlinien werden in einem einzelnen Datenfluss nicht unterstützt. Verschiedene Zusammenführungsrichtlinien erzeugen unterschiedliche Momentaufnahmen. In der Praxis werden Daten, die sich auf eine Audience beziehen, durch die Daten der anderen Audience überschrieben, anstatt dass die Daten beider wie erwartet exportiert werden.
