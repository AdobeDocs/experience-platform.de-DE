...
description: Verwenden Sie das Ziel „Kontaktaufnahme“, um Ihre Kontodaten zu exportieren und in „Kontaktaufnahme“ für Ihre Geschäftsanforderungen zu aktivieren.
...
Dieses [!DNL Adobe Experience Platform] [Ziel](/help/destinations/home.md) nutzt die [Outreach Update Resource API](https://api.outreach.io/api/v2/docs#update-an-existing-resource), um Identitäten innerhalb einer Audience zu aktualisieren, die Interessenten in [!DNL Outreach] entspricht.
...
Als Marketing-Experte können Sie Ihren Interessenten personalisierte Erlebnisse auf der Grundlage von Attributen aus ihren [!DNL Adobe Experience Platform] bereitstellen. Sie können Zielgruppen aus Ihren Offline-Daten erstellen und diese Zielgruppen an [!DNL Outreach] senden, damit sie in den Feeds der potenziellen Kunden angezeigt werden, sobald Zielgruppen und Profile in [!DNL Adobe Experience Platform] aktualisiert werden.
...
|---------|----------|---------|
| Exporttyp | **[!UICONTROL Profile-based]** | <ul><li> Sie exportieren alle Mitglieder eines Segments zusammen mit den gewünschten Schemafeldern *(z. B.: E-Mail-Adresse, Telefonnummer, Nachname)*, entsprechend Ihrer Feldzuordnung.</li><li> Jeder Segmentstatus in [!DNL Outreach] wird mit dem entsprechenden Zielgruppenstatus von Experience Platform aktualisiert, basierend auf dem [!UICONTROL Mapping ID] Wert, der im Schritt [Zielgruppen-Planung](#schedule-segment-export-example) angegeben wurde.</li></ul> |
...
Suchen Sie in **[!UICONTROL Destinations]** > **[!UICONTROL Catalog]** nach [!DNL Outreach]. Alternativ können Sie es unter der CRM -Kategorie finden.
...
* **[!UICONTROL Username]**: E-Mail zu Ihrem [!DNL Outreach].
* **[!UICONTROL Password]**: Ihr [!DNL Outreach]-Passwort.
...
1. Wählen Sie im Fenster [!UICONTROL Select source field] die Kategorie **[!UICONTROL Select identity namespace]** aus und fügen Sie die gewünschten Zuordnungen hinzu.
...
1. Wählen Sie im [!UICONTROL Select target field] den Typ des Zielfelds aus, dem Sie Ihr Quellfeld zuordnen möchten.
   ...
   * **[!UICONTROL Select custom attributes]**: Wählen Sie diese Option aus, um Ihr Quellfeld einem benutzerdefinierten Attribut zuzuordnen, das Sie im [!UICONTROL Attribute name] definieren. Eine [[!DNL Outreach]  Liste der unterstützten Attribute finden &#x200B;](https://api.outreach.io/api/v2/docs#prospect) in der Dokumentation zum Interessenten .
...
* Wählen Sie dazu jedes Segment aus und geben Sie dann den entsprechenden numerischen Wert, der dem Feld *Benutzerdefiniertes Feld `N` Beschriftung* von [!DNL Outreach] im **[!UICONTROL Mapping ID]** Feld entspricht, ein.
  ...
  > * Weitere Informationen finden [[!DNL Outreach]  in der &#x200B;](https://api.outreach.io/api/v2/docs#prospect) für Interessenten.
...
1. Gehen Sie zur [!DNL Outreach]-Website, navigieren Sie dann zur Seite [!DNL Apps] > [!DNL Contacts] und überprüfen Sie, ob die Profile aus der Audience hinzugefügt wurden. Sie können sehen, dass jeder Zielgruppenstatus in [!DNL Outreach] mit dem entsprechenden Zielgruppenstatus von Experience Platform aktualisiert wurde, basierend auf dem [!UICONTROL Mapping ID] Wert, der im Schritt [Zielgruppen-Planung](#schedule-segment-export-example) angegeben wurde.
...
Um diesen Fehler zu beheben, überprüfen Sie, ob die [!UICONTROL Mapping ID], die Sie in Experience Platform für Ihre [!DNL Outreach]-Zielgruppe angegeben haben, in [!DNL Outreach] vorhanden und gültig ist.
