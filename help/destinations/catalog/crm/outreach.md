...
Vor der Aktivierung der Daten für [!DNL Outreach] Ziel, müssen Sie über eine [schema](/help/xdm/schema/composition.md), [Datensatz](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/create-datasets-and-ingest-data.html?lang=en)und [Segmente](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/create-segments.html?lang=en) erstellt in [!DNL Experience Platform].
...
Beachten Sie die folgenden Voraussetzungen in [!DNL Outreach], um Daten von Platform in Ihre [!DNL Outreach] Konto:
...
Beachten Sie die folgenden Elemente, bevor Sie sich bei der [!DNL Outreach] CRM-Ziel:

| Anmeldedaten | Beschreibung |
|---|---|
| E-Mail | Ihre [!DNL Outreach] Konto-E-Mail |
| Passwort | Ihre [!DNL Outreach] Passwort des Kontos |
...
[!DNL Outreach] unterstützt die Aktualisierung von Identitäten, die in der folgenden Tabelle beschrieben werden. Weitere Informationen [identities](/help/identity-service/namespaces.md).

| Zielgruppenidentität | Beschreibung | Zu beachten |
|---|---|---|
| `OutreachId` | <ul><li>[!DNL Outreach] identifier. Dies ist ein numerischer Wert, der dem Prospektprofil entspricht.</li><li>Die ID muss mit der ID innerhalb der [!DNL Outreach] URL für den zu aktualisierenden Interessenten.</li><li>Siehe Abschnitt [[!DNL Outreach] Dokumentation](https://api.outreach.io/api/v2/docs#update-an-existing-resource) für weitere Informationen.</li></ul> | Obligatorisch |
...
Within **[!UICONTROL Ziele]** > **[!UICONTROL Katalog]** Suchen nach [!DNL Outreach]. Alternativ können Sie sie unter der Kategorie CRM finden.
...
Wenn die angegebenen Details gültig sind, zeigt die Benutzeroberfläche eine **Verbunden** Status mit einem grünen Häkchen. Sie können dann mit dem nächsten Schritt fortfahren.
...
So senden Sie Ihre Zielgruppendaten ordnungsgemäß von Adobe Experience Platform an [!DNL Outreach] Ziel, müssen Sie den Schritt zur Feldzuordnung durchlaufen. Die Zuordnung besteht darin, eine Verknüpfung zwischen den Schemafeldern Ihres Experience-Datenmodell (XDM) in Ihrem Platform-Konto und den entsprechenden Entsprechungen vom Ziel zu erstellen. So ordnen Sie Ihre XDM-Felder korrekt der [!DNL Outreach] Führen Sie die folgenden Schritte aus:
...
1. Im [!UICONTROL Zielgruppenfeld auswählen] wählen Sie den Typ des Zielfelds aus, dem Sie Ihr Quellfeld zuordnen möchten.
   ...
   * Fügen Sie die folgende Zuordnung zwischen Ihrem XDM-Profilschema und Ihrem [!DNL Outreach] instance: |XDM-Profilschema|[!DNL Outreach] Instanz| Erforderlich| |—|—|—| |`Oid`|`OutreachId`| Ja |

   * **[!UICONTROL Benutzerdefinierte Attribute auswählen]**: Wählen Sie diese Option aus, um Ihr Quellfeld einem benutzerdefinierten Attribut zuzuordnen, das Sie in der Variablen [!UICONTROL Attributname] -Feld. Siehe [[!DNL Outreach] Interessentendokumentation](https://api.outreach.io/api/v2/docs#prospect) für eine umfassende Liste der unterstützten Attribute.
   ...
   * Nachfolgend finden Sie ein Beispiel für die Verwendung dieser Zuordnungen:
      ![Screenshot der Platform-Benutzeroberfläche mit Target-Zuordnungen.](../../assets/catalog/crm/outreach/mappings.png)
...
1. Auswählen **[!UICONTROL Ziele]** > **[!UICONTROL Durchsuchen]** um zur Liste der Ziele zu navigieren.
   ![Screenshot der Platform-Benutzeroberfläche mit den Browse-Zielen.](../../assets/catalog/crm/outreach/browse-destinations.png)
