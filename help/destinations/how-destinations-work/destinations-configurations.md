...
* Auf der ersten Ebene sind bestimmte Einstellungen im Zusammenhang mit dem Verhalten beim Profilexport und den Konfigurationseinstellungen allen Zielen, die zu einem Zieltyp gehören, gemein. Diese Einstellungen beziehen sich darauf, welche Trigger einen Zielexport durchführen und was in einem Export enthalten ist und von Zielentwicklerinnen und -entwicklern oder [!DNL Real-Time CDP] nicht bearbeitet werden kann.
...
* Auf dritter Ebene gibt es Konfigurationseinstellungen, die [!DNL Real-Time CDP] Benutzer in den Aktivierungs-Workflows festlegen können.
...
Was in den Zielexporten enthalten ist, variiert geringfügig zwischen den Zieltypen. Erfahren Sie mehr über [allgemeine Exportverhaltensmuster nach Zieltyp](/help/destinations/how-destinations-work/profile-export-behavior.md). Diese Einstellungen können nicht von Zielentwicklerinnen und -entwicklern oder [!DNL Real-Time CDP] bearbeitet werden.
