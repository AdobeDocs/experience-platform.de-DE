...
Wählen Sie in [!DNL Adobe Experience Platform] in der linken Navigationsleiste die Option **[!UICONTROL Destinations]** aus, um auf den [!UICONTROL Destinations]-Arbeitsbereich zuzugreifen.
...
|---------|----------|
| [!UICONTROL Set up] | Erstellen Sie eine Verbindung zum Ziel. |
| [!UICONTROL Activate] | Nachdem Sie eine Verbindung zum Ziel hergestellt haben, aktivieren Sie Zielgruppen oder exportieren Sie Datensätze zu diesem Ziel. |
| [!UICONTROL Activate audiences] | Nachdem Sie eine Verbindung zum Ziel hergestellt haben, aktivieren Sie Zielgruppen für dieses Ziel. |
| [!UICONTROL Export datasets] | Nachdem Sie eine Verbindung zum Ziel hergestellt haben, exportieren Sie Datensätze zu diesem Ziel. |
...
Wählen Sie eine Zielzeile aus, um in der rechten Leiste weitere Informationen zum Ziel anzuzeigen, z. B. Ziel-ID, Beschreibung, Anzahl der aktivierten Zielgruppen usw.

![Auf Zielzeile klicken](../assets/ui/workspace/click-destination-row.png)

Wählen Sie den Zielnamen aus, um Informationen über die für dieses Ziel aktivierten Zielgruppen anzuzeigen. Wählen Sie **[!UICONTROL Edit destination]** aus[ um die Zieleinstellungen zu ](/help/destinations/ui/edit-destination.md) oder **[!UICONTROL Activate audiences]**, um dem Datenfluss neue Zielgruppen hinzuzufügen.
...
* Entfernen Sie einzelne Filter, indem Sie auf jedes Filter-Tag das Symbol `X` klicken
...
Auf der Registerkarte **[!UICONTROL Accounts]** werden Details zu den Verbindungen angezeigt, die Sie mit verschiedenen Zielen hergestellt haben. Sie können auf dieser Registerkarte vorhandene Kontodetails aktualisieren oder löschen. In der folgenden Tabelle finden Sie alle für jedes Zielkonto verfügbaren Informationen.
...
Auf der Registerkarte **[!UICONTROL System View]** wird eine grafische Darstellung der Aktivierungsflüsse angezeigt, die Sie im [!DNL Adobe Experience Platform] eingerichtet haben.

![Data-flows1](../assets/ui/workspace/system-view-dataflows.png)

Wählen Sie eines der Ziele aus, die auf der Seite angezeigt werden, und wählen Sie **[!UICONTROL View dataflows]** aus, um Informationen über alle Verbindungen anzuzeigen, die Sie für die einzelnen Ziele eingerichtet haben.
