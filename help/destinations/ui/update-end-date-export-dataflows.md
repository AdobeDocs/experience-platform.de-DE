...
## Verwenden der Benutzeroberfläche zum Aktualisieren des Enddatums {#use-ui}
...
### Ermitteln der Datenflüsse, die aktualisiert werden müssen {#find-dataflows}
...
### Enddatum der Datenflüsse aktualisieren {#update-end-date}
...
### Ermitteln der Datenflüsse, die aktualisiert werden müssen {#find-dataflows-api}

### Enddatum der Datenflüsse aktualisieren {#update-end-date-api}
