...
# Exportieren von Arrays, Zuordnungen und Objekten aus [!DNL Real-Time CDP] {#export-arrays-cloud-storage}
...
| Dateibasierte E-Mail-Marketing-Ziele ([!DNL Adobe Campaign], Oracle Eloqua, Oracle Responsys, Salesforce Marketing Cloud) | Nein |
