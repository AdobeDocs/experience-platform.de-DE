...
Nachdem Sie [Ihre Ziele](connect-destination.md) konfiguriert haben, können Sie Zielgruppensegmente auf mehrere Arten aktivieren:
...
### Aktivieren Sie Zielgruppen über die Seite [!UICONTROL Durchsuchen] .
...
1. Suchen Sie die Zielverbindung, die Sie zum Aktivieren Ihrer Segmente verwenden möchten, wählen Sie die drei Punkte in der Spalte [!UICONTROL Name] aus und wählen Sie dann **[!UICONTROL Segmente aktivieren]** aus.
...
Sie können Segmente für Ziele über die Segmentdetailseite aktivieren. Weitere Informationen finden Sie unter [Segmentdetails](../../segmentation/ui/overview.md#segment-details) .
