...
[!DNL Adobe Experience Platform] verwendet das [Echtzeit-Kundenprofil](../../profile/home.md) als zentrale Datenquelle für alle Profildaten. Für den schnellen Datenabruf in Echtzeit werden [Edge-Profile](../../profile/edge-profiles.md) verwendet, bei denen es sich um einfache Profile handelt, die über die gesamte [Edge Network verteilt ](../../collection/home.md). Dies ermöglicht Anwendungsfälle für die schnelle Personalisierung in Echtzeit.
