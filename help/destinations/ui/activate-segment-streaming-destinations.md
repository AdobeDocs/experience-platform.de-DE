...
In diesem Artikel wird der Workflow erläutert, der zum Aktivieren von Zielgruppen in [!DNL Adobe Experience Platform] Streaming-Zielen erforderlich ist.
...
1. Verwenden Sie auf der Seite &quot;**[!UICONTROL Select source field]**&quot; die **[!UICONTROL Select attributes]** oder die **[!UICONTROL Select identity namespace]**, um zwischen den beiden Kategorien verfügbarer Quellfelder zu wechseln. Wählen Sie aus den verfügbaren [!DNL XDM] Profilattributen und Identity-Namespaces die Namen aus, die Sie dem Ziel zuordnen möchten, und wählen Sie dann **[!UICONTROL Select]** aus.
   ...
   ![Quellfeldseite auswählen, die den Umschalter für Anzeigenamen anzeigt.](../assets/ui/activate-segment-streaming-destinations/show-display-names.gif)
...
>abstract="Aktivieren Sie diese Option, wenn Sie ungehashte Quellfelder verwenden, damit diese bei der Aktivierung automatisch gehasht [!DNL Adobe Experience Platform]."
