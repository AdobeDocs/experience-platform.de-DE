...
Die nachstehende Payload enthält eine allgemeine SFTP-Konfiguration mit vordefinierter Standardkonfiguration [CSV-Dateiformatierung](../../functionality/destination-server/file-formatting.md) Konfigurationsparameter, die Benutzer in der Experience Platform-Benutzeroberfläche definieren können.
