...
Die nachstehende Payload enthält eine allgemeine SFTP-Konfiguration mit vordefinierten, standardmäßigen Konfigurationsparametern für die CSV-Dateiformatierung ](../../functionality/destination-server/file-formatting.md), die Benutzer in der Experience Platform-Benutzeroberfläche definieren können.[
...
Durch Lesen dieses Artikels wissen Sie jetzt, wie Sie ein benutzerdefiniertes SFTP-Ziel mithilfe von Destination SDK erstellen können. Anschließend kann Ihr Team den [Aktivierungs-Workflow für dateibasierte Ziele](../../../ui/activate-batch-profile-destinations.md) verwenden, um Daten an das Ziel zu exportieren.
