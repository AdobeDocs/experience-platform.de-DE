...
# Konfigurieren eines [!DNL Data Landing Zone (DLZ)] -Ziels mit benutzerdefinierten Dateiformatierungsoptionen und einer benutzerdefinierten Dateinamenkonfiguration
...
Auf dieser Seite werden alle für [!DNL Data Landing Zone] -Ziele verfügbaren Konfigurationsoptionen angezeigt. Sie können die in den folgenden Schritten angezeigten Konfigurationen bearbeiten oder bestimmte Teile der Konfigurationen nach Bedarf löschen.
...
Die nachstehende Payload enthält eine generische [!DNL Data Landing Zone] -Konfiguration mit benutzerdefinierten Konfigurationsparametern für die [CSV-Dateiformatierung](../../functionality/destination-server/file-formatting.md), die Benutzer in der Experience Platform-Benutzeroberfläche definieren können.
