...
Die nachstehende Payload enthält eine generische [!DNL Data Landing Zone] Konfiguration mit benutzerdefinierter [CSV-Dateiformatierung](../../functionality/destination-server/file-formatting.md) Konfigurationsparameter festlegen, die Benutzer in der Experience Platform-Benutzeroberfläche definieren können.
...
![Bildschirmaufzeichnung mit der Zielkatalogseite mit der ausgewählten Zielkarte.](../../assets/guides/batch/dlz-destination-card.gif)
