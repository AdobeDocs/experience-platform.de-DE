...
1. Sie erstellen den Inhalt Ihrer Zielseite basierend auf dem [Dokumentation-Self-Service-Vorlage](./self-service-template.md). **[Download](../assets/docs-framework/yourdestination-template.zip)** die Vorlage und entpacken sie, um die `.md` Dateivorlage.
