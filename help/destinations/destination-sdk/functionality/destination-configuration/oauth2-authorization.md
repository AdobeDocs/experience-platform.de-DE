...
| `authorizationUrl` | Zeichenfolge | Die URL Ihres Autorisierungs-Servers, über die Sie den Benutzer zu Ihrer Anwendung weiterleiten. |
...
## OAUth 2 mit Passwortgewährung {#oauth2-password-grant}
...
## OAuth 2 mit Gewährung von Client-Anmeldedaten {#oauth2-client-credentials-grant}
