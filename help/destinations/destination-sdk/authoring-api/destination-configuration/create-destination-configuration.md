...
| `identityNamespaces.externalId.acceptsCustomNamespaces` | Boolesch | Gibt an, ob Kundinnen und Kunden Identitäten, die zu [benutzerdefinierten Namespaces](/help/identity-service/features/namespaces.md#manage-namespaces) gehören, der Identität zuordnen können, die Sie konfigurieren. |
