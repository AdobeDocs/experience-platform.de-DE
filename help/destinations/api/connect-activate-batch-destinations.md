...
* [[!DNL Segmentation Service]](../../segmentation/api/overview.md): [!DNL Adobe Experience Platform Segmentation Service] erstellt Zielgruppen in [!DNL Adobe Experience Platform] aus Ihren [!DNL Real-Time Customer Profile].
...
>[!NOTE]
>
>Die Anmeldedaten `accessId`, `secretKey` für [!DNL Amazon S3]-Verbindungen und `accessId`, `secretKey` für [!DNL Amazon S3]-Verbindungen zu [!DNL Adobe Campaign] sind identisch.
...
| `params.includeFileManifest` | *Optional*. Legen Sie die Einstellung auf `true` fest, um die Generierung von Manifestdateien für Ihr Ziel zu aktivieren. Wenn diese Option aktiviert ist, wird eine Manifestdatei zusammen mit Ihren exportierten Datendateien erstellt, die Metadaten zu den exportierten Dateien bereitstellt. Anzeigen einer [Beispielmanifestdatei](/help/destinations/assets/common/manifest-d0420d72-756c-4159-9e7f-7d3e2f8b501e-0ac8f3c0-29bd-40aa-82c1-f1b7e0657b19.json). |
...
Sie können auch das Dateibenennungsformat der exportierten Dateien bestimmen und festlegen, welche Attribute als [Deduplizierungsschlüssel](../ui/activate-batch-profile-destinations.md#mandatory-attributes) oder [obligatorische Attribute](../ui/activate-batch-profile-destinations.md#mandatory-attributes) verwendet werden sollen. In diesem Schritt können Sie auch den Zeitplan für das Senden von Daten an das Ziel festlegen.
...
>[!TIP]
>
> Unter [Aktualisieren von Komponenten einer Zielgruppe in einem Datenfluss](/help/destinations/api/update-destination-dataflows.md#update-segment) erfahren Sie, wie Sie verschiedene Komponenten (Dateinamenvorlage, Exportzeit usw.) exportierter Zielgruppen aktualisieren.
